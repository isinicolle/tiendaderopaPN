...
namespace GeneXus.Programs {
   public class wwproveedores : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwproveedores( )
      {
      ...
      public wwproveedores( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV11NOMBREPROVEEDOR = GetPar( "NOMBREPROVEEDOR");
               AV12Update = GetPar( "Update");
               AV13Delete = GetPar( "Delete");
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11NOMBREPROVEEDOR, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513128", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwproveedores.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vNOMBREPROVEEDOR", AV11NOMBREPROVEEDOR);
         /* Send saved values. */
      ...
      {
         return formatLink("wwproveedores.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWProveedores" ;
      }
      ...
      protected void WB0K0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Proveedores", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWProveedores.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavNombreproveedor_Internalname, "NOMBREPROVEEDOR", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Multiple line edit */
            ...
            ClassString = "FilterSearchAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavNombreproveedor_Internalname, AV11NOMBREPROVEEDOR, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", 0, 1, edtavNombreproveedor_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "NOMBREPROVEEDOR", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWProveedores.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Nombreproveedor Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMBREPROVEEDOR"), AV11NOMBREPROVEEDOR) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0K2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavNombreproveedor_Internalname;
      ...
      protected void RF0K2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            lV11NOMBREPROVEEDOR = StringUtil.Concat( StringUtil.RTrim( AV11NOMBREPROVEEDOR), "%", "");
            /* Using cursor H000K2 */
            pr_default.execute(0, new Object[] {lV11NOMBREPROVEEDOR, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A49DIRECCIONPROVEEDOR = H000K2_A49DIRECCIONPROVEEDOR[0];
               A48CORREOPROVEEDOR = H000K2_A48CORREOPROVEEDOR[0];
               A47TELEFONOPROVEEDOR = H000K2_A47TELEFONOPROVEEDOR[0];
               A46NOMBREPROVEEDOR = H000K2_A46NOMBREPROVEEDOR[0];
               A10IDPROVEEDOR = H000K2_A10IDPROVEEDOR[0];
               E140K2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDPROVEEDOR"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A10IDPROVEEDOR), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11NOMBREPROVEEDOR = StringUtil.Concat( StringUtil.RTrim( AV11NOMBREPROVEEDOR), "%", "");
         /* Using cursor H000K3 */
         pr_default.execute(1, new Object[] {lV11NOMBREPROVEEDOR});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11NOMBREPROVEEDOR = GridState.FilterValues("Nombreproveedor");
            AssignAttri("", false, "AV11NOMBREPROVEEDOR", AV11NOMBREPROVEEDOR);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("NOMBREPROVEEDOR", AV11NOMBREPROVEEDOR);
      }
      ...
      protected void STRUP0K0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11NOMBREPROVEEDOR = cgiGet( edtavNombreproveedor_Internalname);
            AssignAttri("", false, "AV11NOMBREPROVEEDOR", AV11NOMBREPROVEEDOR);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Proveedores";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513155", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwproveedores.js", "?2021112620513155", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtTELEFONOPROVEEDOR_Internalname = "TELEFONOPROVEEDOR_"+sGXsfl_25_idx;
         edtCORREOPROVEEDOR_Internalname = "CORREOPROVEEDOR_"+sGXsfl_25_idx;
         edtDIRECCIONPROVEEDOR_Internalname = "DIRECCIONPROVEEDOR_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtTELEFONOPROVEEDOR_Internalname = "TELEFONOPROVEEDOR_"+sGXsfl_25_fel_idx;
         edtCORREOPROVEEDOR_Internalname = "CORREOPROVEEDOR_"+sGXsfl_25_fel_idx;
         edtDIRECCIONPROVEEDOR_Internalname = "DIRECCIONPROVEEDOR_"+sGXsfl_25_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBREPROVEEDOR',fld:'vNOMBREPROVEEDOR',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140K2',iparms:[{av:'A10IDPROVEEDOR',fld:'IDPROVEEDOR',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E110K2',iparms:[{av:'A10IDPROVEEDOR',fld:'IDPROVEEDOR',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBREPROVEEDOR',fld:'vNOMBREPROVEEDOR',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBREPROVEEDOR',fld:'vNOMBREPROVEEDOR',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBREPROVEEDOR',fld:'vNOMBREPROVEEDOR',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBREPROVEEDOR',fld:'vNOMBREPROVEEDOR',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         lV11NOMBREPROVEEDOR = "";
         H000K2_A49DIRECCIONPROVEEDOR = new string[] {""} ;
         H000K2_A48CORREOPROVEEDOR = new string[] {""} ;
         H000K2_A47TELEFONOPROVEEDOR = new string[] {""} ;
         H000K2_A46NOMBREPROVEEDOR = new string[] {""} ;
         H000K2_A10IDPROVEEDOR = new long[1] ;
         ...
         ROClassString = "";
         gxphoneLink = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwproveedores__default(),
            new Object[][] {
                new Object[] {
               H000K2_A49DIRECCIONPROVEEDOR, H000K2_A48CORREOPROVEEDOR, H000K2_A47TELEFONOPROVEEDOR, H000K2_A46NOMBREPROVEEDOR, H000K2_A10IDPROVEEDOR
               }
               , new Object[] {
      ...
      private string[] H000K2_A49DIRECCIONPROVEEDOR ;
      private string[] H000K2_A48CORREOPROVEEDOR ;
      private string[] H000K2_A47TELEFONOPROVEEDOR ;
      private string[] H000K2_A46NOMBREPROVEEDOR ;
      private long[] H000K2_A10IDPROVEEDOR ;
   ...
   public class wwproveedores__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000K2( IGxContext context ,
                                             string AV11NOMBREPROVEEDOR ,
                                             string A46NOMBREPROVEEDOR )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [DIRECCIONPROVEEDOR], [CORREOPROVEEDOR], [TELEFONOPROVEEDOR], [NOMBREPROVEEDOR], [IDPROVEEDOR]";
         sFromString = " FROM [Proveedores]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11NOMBREPROVEEDOR)) )
         {
            AddWhere(sWhereString, "([NOMBREPROVEEDOR] like @lV11NOMBREPROVEEDOR)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [NOMBREPROVEEDOR]";
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11NOMBREPROVEEDOR",GXType.NVarChar,255,0) ,
