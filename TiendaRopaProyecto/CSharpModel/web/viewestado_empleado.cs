...
namespace GeneXus.Programs {
   public class viewestado_empleado : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewestado_empleado( )
      {
      ...
      public viewestado_empleado( IGxContext context )
      {
      ...
      public void execute( long aP0_IDESTADOEMPLEADO ,
                           string aP1_TabCode )
      {
         this.AV12IDESTADOEMPLEADO = aP0_IDESTADOEMPLEADO;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IDESTADOEMPLEADO = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12IDESTADOEMPLEADO", StringUtil.LTrimStr( (decimal)(AV12IDESTADOEMPLEADO), 12, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDESTADOEMPLEADO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDESTADOEMPLEADO), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513178", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewestado_empleado.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDESTADOEMPLEADO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDESTADOEMPLEADO","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewEstado_empleado");
         forbiddenHiddens.Add("DESCRIPCIONESTADOEMPLEADO", StringUtil.RTrim( context.localUtil.Format( A22DESCRIPCIONESTADOEMPLEADO, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewestado_empleado:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vIDESTADOEMPLEADO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IDESTADOEMPLEADO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDESTADOEMPLEADO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDESTADOEMPLEADO), "ZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewestado_empleado.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDESTADOEMPLEADO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDESTADOEMPLEADO","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewEstado_empleado" ;
      }
      ...
      protected void WB0O0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Estado_empleado Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewEstado_empleado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Estado_empleadoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewEstado_empleado.htm");
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDESCRIPCIONESTADOEMPLEADO_Internalname, A22DESCRIPCIONESTADOEMPLEADO, "", "", 0, 1, edtDESCRIPCIONESTADOEMPLEADO_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "Nombre", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_ViewEstado_empleado.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewEstado_empleado.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblEmpleados_title_Internalname, "Empleados", "", "", lblEmpleados_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewEstado_empleado.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0O2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Estado_empleado", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewEstado_empleado";
         context.Gx_err = 0;
      }
      ...
      protected void RF0O2( )
      {
         ...
         {
            /* Using cursor H000O2 */
            pr_default.execute(0, new Object[] {AV12IDESTADOEMPLEADO});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A3IDESTADOEMPLEADO = H000O2_A3IDESTADOEMPLEADO[0];
               A22DESCRIPCIONESTADOEMPLEADO = H000O2_A22DESCRIPCIONESTADOEMPLEADO[0];
      ...
      protected void STRUP0O0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IDESTADOEMPLEADO = (long)(context.localUtil.CToN( cgiGet( "vIDESTADOEMPLEADO"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewestado_empleado:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110O2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000O3 */
         pr_default.execute(1, new Object[] {AV12IDESTADOEMPLEADO});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A3IDESTADOEMPLEADO = H000O3_A3IDESTADOEMPLEADO[0];
            A22DESCRIPCIONESTADOEMPLEADO = H000O3_A22DESCRIPCIONESTADOEMPLEADO[0];
            AssignAttri("", false, "A22DESCRIPCIONESTADOEMPLEADO", A22DESCRIPCIONESTADOEMPLEADO);
            AV16GXLvl6 = 1;
            Form.Caption = A22DESCRIPCIONESTADOEMPLEADO;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwestado_empleado.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Estado_empleadoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "estado_empleadogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Estado_empleadoGeneral";
               WebComp_Generalwc_Component = "Estado_empleadoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(long)AV12IDESTADOEMPLEADO});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Empleados") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Empleadoswc_Component), StringUtil.Lower( "Estado_empleadoEmpleadosWC")) != 0 )
            {
               WebComp_Empleadoswc = getWebComponent(GetType(), "GeneXus.Programs", "estado_empleadoempleadoswc", new Object[] {context} );
               WebComp_Empleadoswc.ComponentInit();
               WebComp_Empleadoswc.Name = "Estado_empleadoEmpleadosWC";
               WebComp_Empleadoswc_Component = "Estado_empleadoEmpleadosWC";
            }
            if ( StringUtil.Len( WebComp_Empleadoswc_Component) != 0 )
            {
               WebComp_Empleadoswc.setjustcreated();
               WebComp_Empleadoswc.componentprepare(new Object[] {(string)"W0038",(string)"",(long)AV12IDESTADOEMPLEADO});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IDESTADOEMPLEADO = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12IDESTADOEMPLEADO", StringUtil.LTrimStr( (decimal)(AV12IDESTADOEMPLEADO), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDESTADOEMPLEADO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDESTADOEMPLEADO), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513195", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewestado_empleado.js", "?2021112620513195", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Estado_empleado";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12IDESTADOEMPLEADO',fld:'vIDESTADOEMPLEADO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A22DESCRIPCIONESTADOEMPLEADO',fld:'DESCRIPCIONESTADOEMPLEADO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000O2_A3IDESTADOEMPLEADO = new long[1] ;
         H000O2_A22DESCRIPCIONESTADOEMPLEADO = new string[] {""} ;
         hsh = "";
         H000O3_A3IDESTADOEMPLEADO = new long[1] ;
         H000O3_A22DESCRIPCIONESTADOEMPLEADO = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewestado_empleado__default(),
            new Object[][] {
                new Object[] {
               H000O2_A3IDESTADOEMPLEADO, H000O2_A22DESCRIPCIONESTADOEMPLEADO
               }
               , new Object[] {
               H000O3_A3IDESTADOEMPLEADO, H000O3_A22DESCRIPCIONESTADOEMPLEADO
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12IDESTADOEMPLEADO ;
      private long wcpOAV12IDESTADOEMPLEADO ;
      ...
      private long[] H000O2_A3IDESTADOEMPLEADO ;
      private string[] H000O2_A22DESCRIPCIONESTADOEMPLEADO ;
      private long[] H000O3_A3IDESTADOEMPLEADO ;
      private string[] H000O3_A22DESCRIPCIONESTADOEMPLEADO ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewestado_empleado__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12IDESTADOEMPLEADO",GXType.Decimal,12,0)
          };
          Object[] prmH000O3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000O2", "SELECT [IDESTADOEMPLEADO], [DESCRIPCIONESTADOEMPLEADO] FROM [Estado_empleado] WHERE [IDESTADOEMPLEADO] = @AV12IDESTADOEMPLEADO ORDER BY [IDESTADOEMPLEADO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000O3", "SELECT [IDESTADOEMPLEADO], [DESCRIPCIONESTADOEMPLEADO] FROM [Estado_empleado] WHERE [IDESTADOEMPLEADO] = @AV12IDESTADOEMPLEADO ORDER BY [IDESTADOEMPLEADO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000O3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
