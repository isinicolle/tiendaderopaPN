...
namespace GeneXus.Programs {
   public class viewmarca_producto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewmarca_producto( )
      {
      ...
      public viewmarca_producto( IGxContext context )
      {
      ...
      public void execute( long aP0_IDMARCAPRODUCTO ,
                           string aP1_TabCode )
      {
         this.AV12IDMARCAPRODUCTO = aP0_IDMARCAPRODUCTO;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IDMARCAPRODUCTO = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV12IDMARCAPRODUCTO), 12, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDMARCAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDMARCAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513219", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewmarca_producto.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDMARCAPRODUCTO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDMARCAPRODUCTO","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewMarca_producto");
         forbiddenHiddens.Add("DESCRIPCIONMARCAPRODUCTO", StringUtil.RTrim( context.localUtil.Format( A44DESCRIPCIONMARCAPRODUCTO, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewmarca_producto:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vIDMARCAPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IDMARCAPRODUCTO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDMARCAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDMARCAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewmarca_producto.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDMARCAPRODUCTO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDMARCAPRODUCTO","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewMarca_producto" ;
      }

      public override string GetPgmdesc( )
      {
         return "View Marca_producto" ;
      }
      ...
      protected void WB0T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Marca_producto Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewMarca_producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Marca_productoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewMarca_producto.htm");
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDESCRIPCIONMARCAPRODUCTO_Internalname, A44DESCRIPCIONMARCAPRODUCTO, "", "", 0, 1, edtDESCRIPCIONMARCAPRODUCTO_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "Nombre", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_ViewMarca_producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewMarca_producto.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblInventario_title_Internalname, "Inventario", "", "", lblInventario_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewMarca_producto.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Marca_producto", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewMarca_producto";
         context.Gx_err = 0;
      }
      ...
      protected void RF0T2( )
      {
         ...
         {
            /* Using cursor H000T2 */
            pr_default.execute(0, new Object[] {AV12IDMARCAPRODUCTO});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A8IDMARCAPRODUCTO = H000T2_A8IDMARCAPRODUCTO[0];
               A44DESCRIPCIONMARCAPRODUCTO = H000T2_A44DESCRIPCIONMARCAPRODUCTO[0];
      ...
      protected void STRUP0T0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IDMARCAPRODUCTO = (long)(context.localUtil.CToN( cgiGet( "vIDMARCAPRODUCTO"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewmarca_producto:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110T2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000T3 */
         pr_default.execute(1, new Object[] {AV12IDMARCAPRODUCTO});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A8IDMARCAPRODUCTO = H000T3_A8IDMARCAPRODUCTO[0];
            A44DESCRIPCIONMARCAPRODUCTO = H000T3_A44DESCRIPCIONMARCAPRODUCTO[0];
            AssignAttri("", false, "A44DESCRIPCIONMARCAPRODUCTO", A44DESCRIPCIONMARCAPRODUCTO);
            AV16GXLvl6 = 1;
            Form.Caption = A44DESCRIPCIONMARCAPRODUCTO;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwmarca_producto.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Marca_productoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "marca_productogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Marca_productoGeneral";
               WebComp_Generalwc_Component = "Marca_productoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(long)AV12IDMARCAPRODUCTO});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Inventario") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Inventariowc_Component), StringUtil.Lower( "Marca_productoInventarioWC")) != 0 )
            {
               WebComp_Inventariowc = getWebComponent(GetType(), "GeneXus.Programs", "marca_productoinventariowc", new Object[] {context} );
               WebComp_Inventariowc.ComponentInit();
               WebComp_Inventariowc.Name = "Marca_productoInventarioWC";
               WebComp_Inventariowc_Component = "Marca_productoInventarioWC";
            }
            if ( StringUtil.Len( WebComp_Inventariowc_Component) != 0 )
            {
               WebComp_Inventariowc.setjustcreated();
               WebComp_Inventariowc.componentprepare(new Object[] {(string)"W0038",(string)"",(long)AV12IDMARCAPRODUCTO});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IDMARCAPRODUCTO = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV12IDMARCAPRODUCTO), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDMARCAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDMARCAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513237", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewmarca_producto.js", "?2021112620513238", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Marca_producto";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12IDMARCAPRODUCTO',fld:'vIDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A44DESCRIPCIONMARCAPRODUCTO',fld:'DESCRIPCIONMARCAPRODUCTO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000T2_A8IDMARCAPRODUCTO = new long[1] ;
         H000T2_A44DESCRIPCIONMARCAPRODUCTO = new string[] {""} ;
         hsh = "";
         H000T3_A8IDMARCAPRODUCTO = new long[1] ;
         H000T3_A44DESCRIPCIONMARCAPRODUCTO = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewmarca_producto__default(),
            new Object[][] {
                new Object[] {
               H000T2_A8IDMARCAPRODUCTO, H000T2_A44DESCRIPCIONMARCAPRODUCTO
               }
               , new Object[] {
               H000T3_A8IDMARCAPRODUCTO, H000T3_A44DESCRIPCIONMARCAPRODUCTO
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12IDMARCAPRODUCTO ;
      private long wcpOAV12IDMARCAPRODUCTO ;
      ...
      private long[] H000T2_A8IDMARCAPRODUCTO ;
      private string[] H000T2_A44DESCRIPCIONMARCAPRODUCTO ;
      private long[] H000T3_A8IDMARCAPRODUCTO ;
      private string[] H000T3_A44DESCRIPCIONMARCAPRODUCTO ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewmarca_producto__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12IDMARCAPRODUCTO",GXType.Decimal,12,0)
          };
          Object[] prmH000T3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000T2", "SELECT [IDMARCAPRODUCTO], [DESCRIPCIONMARCAPRODUCTO] FROM [Marca_producto] WHERE [IDMARCAPRODUCTO] = @AV12IDMARCAPRODUCTO ORDER BY [IDMARCAPRODUCTO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000T3", "SELECT [IDMARCAPRODUCTO], [DESCRIPCIONMARCAPRODUCTO] FROM [Marca_producto] WHERE [IDMARCAPRODUCTO] = @AV12IDMARCAPRODUCTO ORDER BY [IDMARCAPRODUCTO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000T3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
