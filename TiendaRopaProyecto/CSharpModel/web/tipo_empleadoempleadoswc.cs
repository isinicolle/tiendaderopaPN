...
namespace GeneXus.Programs {
   public class tipo_empleadoempleadoswc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public tipo_empleadoempleadoswc( )
      {
      ...
      public tipo_empleadoempleadoswc( IGxContext context )
      {
      ...
      {
         this.AV6IDTIPOEMPLEADO = aP0_IDTIPOEMPLEADO;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IDTIPOEMPLEADO = (long)(NumberUtil.Val( GetPar( "IDTIPOEMPLEADO"), "."));
                  AssignAttri(sPrefix, false, "AV6IDTIPOEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDTIPOEMPLEADO), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6IDTIPOEMPLEADO});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6IDTIPOEMPLEADO, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "Tipo_empleadoEmpleadosWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Tipo_empleado Empleados WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620512597", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("tipo_empleadoempleadoswc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDTIPOEMPLEADO,12,0))}, new string[] {"IDTIPOEMPLEADO"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6IDTIPOEMPLEADO", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6IDTIPOEMPLEADO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vIDTIPOEMPLEADO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDTIPOEMPLEADO), 12, 0, ".", "")));
      ...
      {
         return "Tipo_empleadoEmpleadosWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Tipo_empleado Empleados WC" ;
      }
      ...
      protected void WB120( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "tipo_empleadoempleadoswc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Tipo_empleadoEmpleadosWC.htm");
      ...
      protected void START122( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Tipo_empleado Empleados WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF122( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H00122 */
            pr_default.execute(0, new Object[] {AV6IDTIPOEMPLEADO, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A2IDTIPOEMPLEADO = H00122_A2IDTIPOEMPLEADO[0];
               AssignAttri(sPrefix, false, "A2IDTIPOEMPLEADO", StringUtil.LTrimStr( (decimal)(A2IDTIPOEMPLEADO), 12, 0));
               A40000FOTOEMPLEADO_GXI = H00122_A40000FOTOEMPLEADO_GXI[0];
               AssignProp(sPrefix, false, edtFOTOEMPLEADO_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A52FOTOEMPLEADO)) ? A40000FOTOEMPLEADO_GXI : context.convertURL( context.PathToRelativeUrl( A52FOTOEMPLEADO))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtFOTOEMPLEADO_Internalname, "SrcSet", context.GetImageSrcSet( A52FOTOEMPLEADO), true);
               A22DESCRIPCIONESTADOEMPLEADO = H00122_A22DESCRIPCIONESTADOEMPLEADO[0];
               A3IDESTADOEMPLEADO = H00122_A3IDESTADOEMPLEADO[0];
               A28DIRECCIONEMPLEADO = H00122_A28DIRECCIONEMPLEADO[0];
               A27CORREOEMPLEADO = H00122_A27CORREOEMPLEADO[0];
               A29FECHACONTRATACIONEMPLEADO = H00122_A29FECHACONTRATACIONEMPLEADO[0];
               A26TELEFONOEMPLEADO = H00122_A26TELEFONOEMPLEADO[0];
               A25CONTRASENAEMPLEADO = H00122_A25CONTRASENAEMPLEADO[0];
               A24USUARIOEMPLEADO = H00122_A24USUARIOEMPLEADO[0];
               A23NOMBRECOMPLETOEMPLEADO = H00122_A23NOMBRECOMPLETOEMPLEADO[0];
               A1IDEMPLEADO = H00122_A1IDEMPLEADO[0];
               A52FOTOEMPLEADO = H00122_A52FOTOEMPLEADO[0];
               AssignProp(sPrefix, false, edtFOTOEMPLEADO_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A52FOTOEMPLEADO)) ? A40000FOTOEMPLEADO_GXI : context.convertURL( context.PathToRelativeUrl( A52FOTOEMPLEADO))), !bGXsfl_20_Refreshing);
               AssignProp(sPrefix, false, edtFOTOEMPLEADO_Internalname, "SrcSet", context.GetImageSrcSet( A52FOTOEMPLEADO), true);
               A22DESCRIPCIONESTADOEMPLEADO = H00122_A22DESCRIPCIONESTADOEMPLEADO[0];
               E13122 ();
      ...
      {
         /* Using cursor H00123 */
         pr_default.execute(1, new Object[] {AV6IDTIPOEMPLEADO});
      ...
      protected void STRUP120( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IDTIPOEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDTIPOEMPLEADO"), ".", ","));
      ...
      protected void E12122( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtIDTIPOEMPLEADO_Visible = 0;
         AssignProp(sPrefix, false, edtIDTIPOEMPLEADO_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIDTIPOEMPLEADO_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "IDTIPOEMPLEADO";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IDTIPOEMPLEADO), 12, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6IDTIPOEMPLEADO = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6IDTIPOEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDTIPOEMPLEADO), 12, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6IDTIPOEMPLEADO = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "tipo_empleadoempleadoswc", GetJustCreated( ));
         ...
         {
            AV6IDTIPOEMPLEADO = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6IDTIPOEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDTIPOEMPLEADO), 12, 0));
         }
         wcpOAV6IDTIPOEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDTIPOEMPLEADO"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6IDTIPOEMPLEADO != wcpOAV6IDTIPOEMPLEADO ) ) )
         {
            setjustcreated();
         }
         wcpOAV6IDTIPOEMPLEADO = AV6IDTIPOEMPLEADO;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6IDTIPOEMPLEADO = cgiGet( sPrefix+"AV6IDTIPOEMPLEADO_CTRL");
         if ( StringUtil.Len( sCtrlAV6IDTIPOEMPLEADO) > 0 )
         {
            AV6IDTIPOEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6IDTIPOEMPLEADO), ".", ","));
            AssignAttri(sPrefix, false, "AV6IDTIPOEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDTIPOEMPLEADO), 12, 0));
         }
         else
         {
            AV6IDTIPOEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6IDTIPOEMPLEADO_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDTIPOEMPLEADO_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDTIPOEMPLEADO), 12, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6IDTIPOEMPLEADO)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDTIPOEMPLEADO_CTRL", StringUtil.RTrim( sCtrlAV6IDTIPOEMPLEADO));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620512643", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("tipo_empleadoempleadoswc.js", "?2021112620512643", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtIDESTADOEMPLEADO_Internalname = sPrefix+"IDESTADOEMPLEADO_"+sGXsfl_20_idx;
         edtDESCRIPCIONESTADOEMPLEADO_Internalname = sPrefix+"DESCRIPCIONESTADOEMPLEADO_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtIDESTADOEMPLEADO_Internalname = sPrefix+"IDESTADOEMPLEADO_"+sGXsfl_20_fel_idx;
         edtDESCRIPCIONESTADOEMPLEADO_Internalname = sPrefix+"DESCRIPCIONESTADOEMPLEADO_"+sGXsfl_20_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDTIPOEMPLEADO',fld:'vIDTIPOEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E13122',iparms:[{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A3IDESTADOEMPLEADO',fld:'IDESTADOEMPLEADO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtNOMBRECOMPLETOEMPLEADO_Link',ctrl:'NOMBRECOMPLETOEMPLEADO',prop:'Link'},{av:'edtDESCRIPCIONESTADOEMPLEADO_Link',ctrl:'DESCRIPCIONESTADOEMPLEADO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11122',iparms:[{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDTIPOEMPLEADO',fld:'vIDTIPOEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDTIPOEMPLEADO',fld:'vIDTIPOEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDTIPOEMPLEADO',fld:'vIDTIPOEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDTIPOEMPLEADO',fld:'vIDTIPOEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00122_A2IDTIPOEMPLEADO = new long[1] ;
         H00122_A40000FOTOEMPLEADO_GXI = new string[] {""} ;
         H00122_A22DESCRIPCIONESTADOEMPLEADO = new string[] {""} ;
         H00122_A3IDESTADOEMPLEADO = new long[1] ;
         H00122_A28DIRECCIONEMPLEADO = new string[] {""} ;
         H00122_A27CORREOEMPLEADO = new string[] {""} ;
         H00122_A29FECHACONTRATACIONEMPLEADO = new DateTime[] {DateTime.MinValue} ;
         H00122_A26TELEFONOEMPLEADO = new string[] {""} ;
         H00122_A25CONTRASENAEMPLEADO = new string[] {""} ;
         H00122_A24USUARIOEMPLEADO = new string[] {""} ;
         H00122_A23NOMBRECOMPLETOEMPLEADO = new string[] {""} ;
         H00122_A1IDEMPLEADO = new long[1] ;
         H00122_A52FOTOEMPLEADO = new string[] {""} ;
         ...
         sCtrlAV6IDTIPOEMPLEADO = "";
         ROClassString = "";
         gxphoneLink = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.tipo_empleadoempleadoswc__default(),
            new Object[][] {
                new Object[] {
               H00122_A2IDTIPOEMPLEADO, H00122_A40000FOTOEMPLEADO_GXI, H00122_A22DESCRIPCIONESTADOEMPLEADO, H00122_A3IDESTADOEMPLEADO, H00122_A28DIRECCIONEMPLEADO, H00122_A27CORREOEMPLEADO, H00122_A29FECHACONTRATACIONEMPLEADO, H00122_A26TELEFONOEMPLEADO, H00122_A25CONTRASENAEMPLEADO, H00122_A24USUARIOEMPLEADO,
               H00122_A23NOMBRECOMPLETOEMPLEADO, H00122_A1IDEMPLEADO, H00122_A52FOTOEMPLEADO
               }
               , new Object[] {
      ...
      private int edtIDTIPOEMPLEADO_Visible ;
      private int subGrid_Islastpage ;
      private int GXPagingFrom2 ;
      private int GXPagingTo2 ;
      private int idxLst ;
      private int subGrid_Backcolor ;
      private long AV6IDTIPOEMPLEADO ;
      private long wcpOAV6IDTIPOEMPLEADO ;
      ...
      private string sCtrlAV6IDTIPOEMPLEADO ;
      ...
      private long[] H00122_A2IDTIPOEMPLEADO ;
      private string[] H00122_A40000FOTOEMPLEADO_GXI ;
      private string[] H00122_A22DESCRIPCIONESTADOEMPLEADO ;
      private long[] H00122_A3IDESTADOEMPLEADO ;
      private string[] H00122_A28DIRECCIONEMPLEADO ;
      private string[] H00122_A27CORREOEMPLEADO ;
      private DateTime[] H00122_A29FECHACONTRATACIONEMPLEADO ;
      private string[] H00122_A26TELEFONOEMPLEADO ;
      private string[] H00122_A25CONTRASENAEMPLEADO ;
      private string[] H00122_A24USUARIOEMPLEADO ;
      private string[] H00122_A23NOMBRECOMPLETOEMPLEADO ;
      private long[] H00122_A1IDEMPLEADO ;
      private string[] H00122_A52FOTOEMPLEADO ;
   ...
   public class tipo_empleadoempleadoswc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6IDTIPOEMPLEADO",GXType.Decimal,12,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H00122", "SELECT T1.[IDTIPOEMPLEADO], T1.[FOTOEMPLEADO_GXI], T2.[DESCRIPCIONESTADOEMPLEADO], T1.[IDESTADOEMPLEADO], T1.[DIRECCIONEMPLEADO], T1.[CORREOEMPLEADO], T1.[FECHACONTRATACIONEMPLEADO], T1.[TELEFONOEMPLEADO], T1.[CONTRASENAEMPLEADO], T1.[USUARIOEMPLEADO], T1.[NOMBRECOMPLETOEMPLEADO], T1.[IDEMPLEADO], T1.[FOTOEMPLEADO] FROM ([Empleados] T1 INNER JOIN [Estado_empleado] T2 ON T2.[IDESTADOEMPLEADO] = T1.[IDESTADOEMPLEADO]) WHERE T1.[IDTIPOEMPLEADO] = @AV6IDTIPOEMPLEADO ORDER BY T1.[IDTIPOEMPLEADO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00122,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H00123", "SELECT COUNT(*) FROM ([Empleados] T1 INNER JOIN [Estado_empleado] T2 ON T2.[IDESTADOEMPLEADO] = T1.[IDESTADOEMPLEADO]) WHERE T1.[IDTIPOEMPLEADO] = @AV6IDTIPOEMPLEADO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00123,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
