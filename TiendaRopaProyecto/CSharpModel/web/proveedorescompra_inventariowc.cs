...
namespace GeneXus.Programs {
   public class proveedorescompra_inventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public proveedorescompra_inventariowc( )
      {
      ...
      public proveedorescompra_inventariowc( IGxContext context )
      {
      ...
      {
         this.AV6IDPROVEEDOR = aP0_IDPROVEEDOR;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IDPROVEEDOR = (long)(NumberUtil.Val( GetPar( "IDPROVEEDOR"), "."));
                  AssignAttri(sPrefix, false, "AV6IDPROVEEDOR", StringUtil.LTrimStr( (decimal)(AV6IDPROVEEDOR), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6IDPROVEEDOR});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6IDPROVEEDOR, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "ProveedoresCompra_inventarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Proveedores Compra_inventario WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620512533", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("proveedorescompra_inventariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDPROVEEDOR,12,0))}, new string[] {"IDPROVEEDOR"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6IDPROVEEDOR", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6IDPROVEEDOR), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vIDPROVEEDOR", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDPROVEEDOR), 12, 0, ".", "")));
      ...
      {
         return "ProveedoresCompra_inventarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Proveedores Compra_inventario WC" ;
      }
      ...
      protected void WB1I0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "proveedorescompra_inventariowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ProveedoresCompra_inventarioWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtIDPROVEEDOR_Internalname, "IDPROVEEDOR", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtIDPROVEEDOR_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A10IDPROVEEDOR), 12, 0, ".", "")), ((edtIDPROVEEDOR_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A10IDPROVEEDOR), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A10IDPROVEEDOR), "ZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtIDPROVEEDOR_Jsonclick, 0, "Attribute", "", "", "", "", edtIDPROVEEDOR_Visible, edtIDPROVEEDOR_Enabled, 0, "number", "1", 12, "chr", 1, "row", 12, 0, 0, 0, 1, -1, 0, true, "Codigo", "right", false, "", "HLP_ProveedoresCompra_inventarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1I2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Proveedores Compra_inventario WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1I2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001I4 */
            pr_default.execute(0, new Object[] {AV6IDPROVEEDOR, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A10IDPROVEEDOR = H001I4_A10IDPROVEEDOR[0];
               AssignAttri(sPrefix, false, "A10IDPROVEEDOR", StringUtil.LTrimStr( (decimal)(A10IDPROVEEDOR), 12, 0));
               A23NOMBRECOMPLETOEMPLEADO = H001I4_A23NOMBRECOMPLETOEMPLEADO[0];
               A1IDEMPLEADO = H001I4_A1IDEMPLEADO[0];
               A51DESCRIPCIONCOMPRA = H001I4_A51DESCRIPCIONCOMPRA[0];
               A50FECHACOMPRA = H001I4_A50FECHACOMPRA[0];
               A11IDCOMPRA = H001I4_A11IDCOMPRA[0];
               A61TOTALCOMPRAPRODUCTO = H001I4_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H001I4_n61TOTALCOMPRAPRODUCTO[0];
               A23NOMBRECOMPLETOEMPLEADO = H001I4_A23NOMBRECOMPLETOEMPLEADO[0];
               A61TOTALCOMPRAPRODUCTO = H001I4_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H001I4_n61TOTALCOMPRAPRODUCTO[0];
               E131I2 ();
      ...
      {
         /* Using cursor H001I7 */
         pr_default.execute(1, new Object[] {AV6IDPROVEEDOR});
         GRID_nRecordCount = H001I7_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP1I0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IDPROVEEDOR = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDPROVEEDOR"), ".", ","));
      ...
      protected void E121I2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtIDPROVEEDOR_Visible = 0;
         AssignProp(sPrefix, false, edtIDPROVEEDOR_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIDPROVEEDOR_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "IDPROVEEDOR";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IDPROVEEDOR), 12, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6IDPROVEEDOR = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6IDPROVEEDOR", StringUtil.LTrimStr( (decimal)(AV6IDPROVEEDOR), 12, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6IDPROVEEDOR = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "proveedorescompra_inventariowc", GetJustCreated( ));
         ...
         {
            AV6IDPROVEEDOR = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6IDPROVEEDOR", StringUtil.LTrimStr( (decimal)(AV6IDPROVEEDOR), 12, 0));
         }
         wcpOAV6IDPROVEEDOR = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDPROVEEDOR"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6IDPROVEEDOR != wcpOAV6IDPROVEEDOR ) ) )
         {
            setjustcreated();
         }
         wcpOAV6IDPROVEEDOR = AV6IDPROVEEDOR;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6IDPROVEEDOR = cgiGet( sPrefix+"AV6IDPROVEEDOR_CTRL");
         if ( StringUtil.Len( sCtrlAV6IDPROVEEDOR) > 0 )
         {
            AV6IDPROVEEDOR = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6IDPROVEEDOR), ".", ","));
            AssignAttri(sPrefix, false, "AV6IDPROVEEDOR", StringUtil.LTrimStr( (decimal)(AV6IDPROVEEDOR), 12, 0));
         }
         else
         {
            AV6IDPROVEEDOR = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6IDPROVEEDOR_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDPROVEEDOR_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDPROVEEDOR), 12, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6IDPROVEEDOR)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDPROVEEDOR_CTRL", StringUtil.RTrim( sCtrlAV6IDPROVEEDOR));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620512572", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("proveedorescompra_inventariowc.js", "?2021112620512572", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDPROVEEDOR',fld:'vIDPROVEEDOR',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131I2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtFECHACOMPRA_Link',ctrl:'FECHACOMPRA',prop:'Link'},{av:'edtNOMBRECOMPLETOEMPLEADO_Link',ctrl:'NOMBRECOMPLETOEMPLEADO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111I2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDPROVEEDOR',fld:'vIDPROVEEDOR',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDPROVEEDOR',fld:'vIDPROVEEDOR',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDPROVEEDOR',fld:'vIDPROVEEDOR',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDPROVEEDOR',fld:'vIDPROVEEDOR',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001I4_A10IDPROVEEDOR = new long[1] ;
         H001I4_A23NOMBRECOMPLETOEMPLEADO = new string[] {""} ;
         H001I4_A1IDEMPLEADO = new long[1] ;
         H001I4_A51DESCRIPCIONCOMPRA = new string[] {""} ;
         H001I4_A50FECHACOMPRA = new DateTime[] {DateTime.MinValue} ;
         H001I4_A11IDCOMPRA = new long[1] ;
         H001I4_A61TOTALCOMPRAPRODUCTO = new decimal[1] ;
         H001I4_n61TOTALCOMPRAPRODUCTO = new bool[] {false} ;
         H001I7_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6IDPROVEEDOR = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.proveedorescompra_inventariowc__default(),
            new Object[][] {
                new Object[] {
               H001I4_A10IDPROVEEDOR, H001I4_A23NOMBRECOMPLETOEMPLEADO, H001I4_A1IDEMPLEADO, H001I4_A51DESCRIPCIONCOMPRA, H001I4_A50FECHACOMPRA, H001I4_A11IDCOMPRA, H001I4_A61TOTALCOMPRAPRODUCTO, H001I4_n61TOTALCOMPRAPRODUCTO
               }
               , new Object[] {
               H001I7_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ProveedoresCompra_inventarioWC";
      ...
      private int edtIDPROVEEDOR_Visible ;
      private int subGrid_Islastpage ;
      private int GXPagingFrom2 ;
      private int GXPagingTo2 ;
      private int idxLst ;
      private int subGrid_Backcolor ;
      private long AV6IDPROVEEDOR ;
      private long wcpOAV6IDPROVEEDOR ;
      ...
      private string sCtrlAV6IDPROVEEDOR ;
      ...
      private long[] H001I4_A10IDPROVEEDOR ;
      private string[] H001I4_A23NOMBRECOMPLETOEMPLEADO ;
      private long[] H001I4_A1IDEMPLEADO ;
      private string[] H001I4_A51DESCRIPCIONCOMPRA ;
      private DateTime[] H001I4_A50FECHACOMPRA ;
      private long[] H001I4_A11IDCOMPRA ;
      private decimal[] H001I4_A61TOTALCOMPRAPRODUCTO ;
      private bool[] H001I4_n61TOTALCOMPRAPRODUCTO ;
      private long[] H001I7_AGRID_nRecordCount ;
   ...
   public class proveedorescompra_inventariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH001I4;
          prmH001I4 = new Object[] {
          new ParDef("@AV6IDPROVEEDOR",GXType.Decimal,12,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          Object[] prmH001I7;
          prmH001I7 = new Object[] {
          new ParDef("@AV6IDPROVEEDOR",GXType.Decimal,12,0)
          };
          def= new CursorDef[] {
              new CursorDef("H001I4", "SELECT T1.[IDPROVEEDOR], T2.[NOMBRECOMPLETOEMPLEADO], T1.[IDEMPLEADO], T1.[DESCRIPCIONCOMPRA], T1.[FECHACOMPRA], T1.[IDCOMPRA], COALESCE( T3.[TOTALCOMPRAPRODUCTO], 0) AS TOTALCOMPRAPRODUCTO FROM (([Compra_inventario] T1 INNER JOIN [Empleados] T2 ON T2.[IDEMPLEADO] = T1.[IDEMPLEADO]) LEFT JOIN (SELECT SUM(COALESCE( T5.[SUBTOTALCOMPRAPRODUCTO], 0)) AS TOTALCOMPRAPRODUCTO, T4.[IDCOMPRA] FROM ([Compra_inventarioCompra_produc] T4 INNER JOIN (SELECT COALESCE( [GXC2], 0) AS SUBTOTALCOMPRAPRODUCTO, [IDPRODUCTO] FROM [Inventario] ) T5 ON T5.[IDPRODUCTO] = T4.[IDPRODUCTO]) GROUP BY T4.[IDCOMPRA] ) T3 ON T3.[IDCOMPRA] = T1.[IDCOMPRA]) WHERE T1.[IDPROVEEDOR] = @AV6IDPROVEEDOR ORDER BY T1.[IDPROVEEDOR]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I4,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001I7", "SELECT COUNT(*) FROM (([Compra_inventario] T1 INNER JOIN [Empleados] T2 ON T2.[IDEMPLEADO] = T1.[IDEMPLEADO]) LEFT JOIN (SELECT SUM(COALESCE( T5.[SUBTOTALCOMPRAPRODUCTO], 0)) AS TOTALCOMPRAPRODUCTO, T4.[IDCOMPRA] FROM ([Compra_inventarioCompra_produc] T4 INNER JOIN (SELECT COALESCE( [GXC2], 0) AS SUBTOTALCOMPRAPRODUCTO, [IDPRODUCTO] FROM [Inventario] ) T5 ON T5.[IDPRODUCTO] = T4.[IDPRODUCTO]) GROUP BY T4.[IDCOMPRA] ) T3 ON T3.[IDCOMPRA] = T1.[IDCOMPRA]) WHERE T1.[IDPROVEEDOR] = @AV6IDPROVEEDOR ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001I7,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
