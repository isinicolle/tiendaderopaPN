...
namespace GeneXus.Programs {
   public class proveedorescompra_inventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      ...
      protected void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113013582510", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
      ...
      protected void RF2S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A10IDPROVEEDOR = H002S5_A10IDPROVEEDOR[0];
               AssignAttri(sPrefix, false, "A10IDPROVEEDOR", StringUtil.LTrimStr( (decimal)(A10IDPROVEEDOR), 12, 0));
               A23NOMBRECOMPLETOEMPLEADO = H002S5_A23NOMBRECOMPLETOEMPLEADO[0];
               A1IDEMPLEADO = H002S5_A1IDEMPLEADO[0];
               A51DESCRIPCIONCOMPRA = H002S5_A51DESCRIPCIONCOMPRA[0];
               A50FECHACOMPRA = H002S5_A50FECHACOMPRA[0];
               A11IDCOMPRA = H002S5_A11IDCOMPRA[0];
               A61TOTALCOMPRAPRODUCTO = H002S5_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H002S5_n61TOTALCOMPRAPRODUCTO[0];
               A23NOMBRECOMPLETOEMPLEADO = H002S5_A23NOMBRECOMPLETOEMPLEADO[0];
               A61TOTALCOMPRAPRODUCTO = H002S5_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H002S5_n61TOTALCOMPRAPRODUCTO[0];
               E132S2 ();
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H002S9_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113013582557", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("proveedorescompra_inventariowc.js", "?2021113013582557", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E132S2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E112S2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002S5_A10IDPROVEEDOR = new long[1] ;
         H002S5_A23NOMBRECOMPLETOEMPLEADO = new string[] {""} ;
         H002S5_A1IDEMPLEADO = new long[1] ;
         H002S5_A51DESCRIPCIONCOMPRA = new string[] {""} ;
         H002S5_A50FECHACOMPRA = new DateTime[] {DateTime.MinValue} ;
         H002S5_A11IDCOMPRA = new long[1] ;
         H002S5_A61TOTALCOMPRAPRODUCTO = new decimal[1] ;
         H002S5_n61TOTALCOMPRAPRODUCTO = new bool[] {false} ;
         H002S9_AGRID_nRecordCount = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.proveedorescompra_inventariowc__default(),
            new Object[][] {
                new Object[] {
               H002S5_A10IDPROVEEDOR, H002S5_A23NOMBRECOMPLETOEMPLEADO, H002S5_A1IDEMPLEADO, H002S5_A51DESCRIPCIONCOMPRA, H002S5_A50FECHACOMPRA, H002S5_A11IDCOMPRA, H002S5_A61TOTALCOMPRAPRODUCTO, H002S5_n61TOTALCOMPRAPRODUCTO
               }
               , new Object[] {
               H002S9_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ProveedoresCompra_inventarioWC";
      ...
      private long[] H002S5_A10IDPROVEEDOR ;
      private string[] H002S5_A23NOMBRECOMPLETOEMPLEADO ;
      private long[] H002S5_A1IDEMPLEADO ;
      private string[] H002S5_A51DESCRIPCIONCOMPRA ;
      private DateTime[] H002S5_A50FECHACOMPRA ;
      private long[] H002S5_A11IDCOMPRA ;
      private decimal[] H002S5_A61TOTALCOMPRAPRODUCTO ;
      private bool[] H002S5_n61TOTALCOMPRAPRODUCTO ;
      private long[] H002S9_AGRID_nRecordCount ;
