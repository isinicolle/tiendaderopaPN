...
namespace GeneXus.Programs {
   public class estado_productoinventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public estado_productoinventariowc( )
      {
      ...
      public estado_productoinventariowc( IGxContext context )
      {
      ...
      {
         this.AV6IDESTADOPRODUCTO = aP0_IDESTADOPRODUCTO;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IDESTADOPRODUCTO = (long)(NumberUtil.Val( GetPar( "IDESTADOPRODUCTO"), "."));
                  AssignAttri(sPrefix, false, "AV6IDESTADOPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDESTADOPRODUCTO), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6IDESTADOPRODUCTO});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6IDESTADOPRODUCTO, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "Estado_productoInventarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Estado_producto Inventario WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620512765", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("estado_productoinventariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDESTADOPRODUCTO,12,0))}, new string[] {"IDESTADOPRODUCTO"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6IDESTADOPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6IDESTADOPRODUCTO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vIDESTADOPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDESTADOPRODUCTO), 12, 0, ".", "")));
      ...
      {
         return "Estado_productoInventarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Estado_producto Inventario WC" ;
      }
      ...
      protected void WB1B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "estado_productoinventariowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Estado_productoInventarioWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtIDESTADOPRODUCTO_Internalname, "IDESTADOPRODUCTO", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtIDESTADOPRODUCTO_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A5IDESTADOPRODUCTO), 12, 0, ".", "")), ((edtIDESTADOPRODUCTO_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A5IDESTADOPRODUCTO), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A5IDESTADOPRODUCTO), "ZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtIDESTADOPRODUCTO_Jsonclick, 0, "Attribute", "", "", "", "", edtIDESTADOPRODUCTO_Visible, edtIDESTADOPRODUCTO_Enabled, 0, "number", "1", 12, "chr", 1, "row", 12, 0, 0, 0, 1, -1, 0, true, "Codigo", "right", false, "", "HLP_Estado_productoInventarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1B2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Estado_producto Inventario WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1B2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001B2 */
            pr_default.execute(0, new Object[] {AV6IDESTADOPRODUCTO, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A5IDESTADOPRODUCTO = H001B2_A5IDESTADOPRODUCTO[0];
               AssignAttri(sPrefix, false, "A5IDESTADOPRODUCTO", StringUtil.LTrimStr( (decimal)(A5IDESTADOPRODUCTO), 12, 0));
               A44DESCRIPCIONMARCAPRODUCTO = H001B2_A44DESCRIPCIONMARCAPRODUCTO[0];
               A8IDMARCAPRODUCTO = H001B2_A8IDMARCAPRODUCTO[0];
               A39DESCRIPCIONCATEGORIAPRODUCTO = H001B2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
               A6IDCATEGORIAPRODUCTO = H001B2_A6IDCATEGORIAPRODUCTO[0];
               A43PRECIOVENTAPRODUCTO = H001B2_A43PRECIOVENTAPRODUCTO[0];
               A42PRECIOCOMPRAPRODUCTO = H001B2_A42PRECIOCOMPRAPRODUCTO[0];
               A41CANTIDADPRODUCTO = H001B2_A41CANTIDADPRODUCTO[0];
               A40DESCRIPCIONPRODUCTO = H001B2_A40DESCRIPCIONPRODUCTO[0];
               A7IDPRODUCTO = H001B2_A7IDPRODUCTO[0];
               A44DESCRIPCIONMARCAPRODUCTO = H001B2_A44DESCRIPCIONMARCAPRODUCTO[0];
               A39DESCRIPCIONCATEGORIAPRODUCTO = H001B2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
               E131B2 ();
      ...
      {
         /* Using cursor H001B3 */
         pr_default.execute(1, new Object[] {AV6IDESTADOPRODUCTO});
      ...
      protected void STRUP1B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IDESTADOPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDESTADOPRODUCTO"), ".", ","));
      ...
      protected void E121B2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtIDESTADOPRODUCTO_Visible = 0;
         AssignProp(sPrefix, false, edtIDESTADOPRODUCTO_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIDESTADOPRODUCTO_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "IDESTADOPRODUCTO";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IDESTADOPRODUCTO), 12, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6IDESTADOPRODUCTO = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6IDESTADOPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDESTADOPRODUCTO), 12, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6IDESTADOPRODUCTO = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "estado_productoinventariowc", GetJustCreated( ));
         ...
         {
            AV6IDESTADOPRODUCTO = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6IDESTADOPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDESTADOPRODUCTO), 12, 0));
         }
         wcpOAV6IDESTADOPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDESTADOPRODUCTO"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6IDESTADOPRODUCTO != wcpOAV6IDESTADOPRODUCTO ) ) )
         {
            setjustcreated();
         }
         wcpOAV6IDESTADOPRODUCTO = AV6IDESTADOPRODUCTO;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6IDESTADOPRODUCTO = cgiGet( sPrefix+"AV6IDESTADOPRODUCTO_CTRL");
         if ( StringUtil.Len( sCtrlAV6IDESTADOPRODUCTO) > 0 )
         {
            AV6IDESTADOPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6IDESTADOPRODUCTO), ".", ","));
            AssignAttri(sPrefix, false, "AV6IDESTADOPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDESTADOPRODUCTO), 12, 0));
         }
         else
         {
            AV6IDESTADOPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6IDESTADOPRODUCTO_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDESTADOPRODUCTO_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDESTADOPRODUCTO), 12, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6IDESTADOPRODUCTO)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDESTADOPRODUCTO_CTRL", StringUtil.RTrim( sCtrlAV6IDESTADOPRODUCTO));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202111262051285", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("estado_productoinventariowc.js", "?202111262051286", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDESTADOPRODUCTO',fld:'vIDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131B2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A6IDCATEGORIAPRODUCTO',fld:'IDCATEGORIAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'A8IDMARCAPRODUCTO',fld:'IDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtDESCRIPCIONPRODUCTO_Link',ctrl:'DESCRIPCIONPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONCATEGORIAPRODUCTO_Link',ctrl:'DESCRIPCIONCATEGORIAPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONMARCAPRODUCTO_Link',ctrl:'DESCRIPCIONMARCAPRODUCTO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111B2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDESTADOPRODUCTO',fld:'vIDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDESTADOPRODUCTO',fld:'vIDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDESTADOPRODUCTO',fld:'vIDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDESTADOPRODUCTO',fld:'vIDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001B2_A5IDESTADOPRODUCTO = new long[1] ;
         H001B2_A44DESCRIPCIONMARCAPRODUCTO = new string[] {""} ;
         H001B2_A8IDMARCAPRODUCTO = new long[1] ;
         H001B2_A39DESCRIPCIONCATEGORIAPRODUCTO = new string[] {""} ;
         H001B2_A6IDCATEGORIAPRODUCTO = new long[1] ;
         H001B2_A43PRECIOVENTAPRODUCTO = new decimal[1] ;
         H001B2_A42PRECIOCOMPRAPRODUCTO = new decimal[1] ;
         H001B2_A41CANTIDADPRODUCTO = new long[1] ;
         H001B2_A40DESCRIPCIONPRODUCTO = new string[] {""} ;
         H001B2_A7IDPRODUCTO = new long[1] ;
         ...
         sCtrlAV6IDESTADOPRODUCTO = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.estado_productoinventariowc__default(),
            new Object[][] {
                new Object[] {
               H001B2_A5IDESTADOPRODUCTO, H001B2_A44DESCRIPCIONMARCAPRODUCTO, H001B2_A8IDMARCAPRODUCTO, H001B2_A39DESCRIPCIONCATEGORIAPRODUCTO, H001B2_A6IDCATEGORIAPRODUCTO, H001B2_A43PRECIOVENTAPRODUCTO, H001B2_A42PRECIOCOMPRAPRODUCTO, H001B2_A41CANTIDADPRODUCTO, H001B2_A40DESCRIPCIONPRODUCTO, H001B2_A7IDPRODUCTO
               }
               , new Object[] {
      ...
      private int edtIDESTADOPRODUCTO_Visible ;
      private int subGrid_Islastpage ;
      private int GXPagingFrom2 ;
      private int GXPagingTo2 ;
      private int idxLst ;
      private int subGrid_Backcolor ;
      private long AV6IDESTADOPRODUCTO ;
      private long wcpOAV6IDESTADOPRODUCTO ;
      ...
      private string sCtrlAV6IDESTADOPRODUCTO ;
      ...
      private long[] H001B2_A5IDESTADOPRODUCTO ;
      private string[] H001B2_A44DESCRIPCIONMARCAPRODUCTO ;
      private long[] H001B2_A8IDMARCAPRODUCTO ;
      private string[] H001B2_A39DESCRIPCIONCATEGORIAPRODUCTO ;
      private long[] H001B2_A6IDCATEGORIAPRODUCTO ;
      private decimal[] H001B2_A43PRECIOVENTAPRODUCTO ;
      private decimal[] H001B2_A42PRECIOCOMPRAPRODUCTO ;
      private long[] H001B2_A41CANTIDADPRODUCTO ;
      private string[] H001B2_A40DESCRIPCIONPRODUCTO ;
      private long[] H001B2_A7IDPRODUCTO ;
   ...
   public class estado_productoinventariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6IDESTADOPRODUCTO",GXType.Decimal,12,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001B2", "SELECT T1.[IDESTADOPRODUCTO], T2.[DESCRIPCIONMARCAPRODUCTO], T1.[IDMARCAPRODUCTO], T3.[DESCRIPCIONCATEGORIAPRODUCTO], T1.[IDCATEGORIAPRODUCTO], T1.[PRECIOVENTAPRODUCTO], T1.[PRECIOCOMPRAPRODUCTO], T1.[CANTIDADPRODUCTO], T1.[DESCRIPCIONPRODUCTO], T1.[IDPRODUCTO] FROM (([Inventario] T1 INNER JOIN [Marca_producto] T2 ON T2.[IDMARCAPRODUCTO] = T1.[IDMARCAPRODUCTO]) INNER JOIN [Categoria_producto] T3 ON T3.[IDCATEGORIAPRODUCTO] = T1.[IDCATEGORIAPRODUCTO]) WHERE T1.[IDESTADOPRODUCTO] = @AV6IDESTADOPRODUCTO ORDER BY T1.[IDESTADOPRODUCTO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001B3", "SELECT COUNT(*) FROM (([Inventario] T1 INNER JOIN [Marca_producto] T3 ON T3.[IDMARCAPRODUCTO] = T1.[IDMARCAPRODUCTO]) INNER JOIN [Categoria_producto] T2 ON T2.[IDCATEGORIAPRODUCTO] = T1.[IDCATEGORIAPRODUCTO]) WHERE T1.[IDESTADOPRODUCTO] = @AV6IDESTADOPRODUCTO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001B3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
