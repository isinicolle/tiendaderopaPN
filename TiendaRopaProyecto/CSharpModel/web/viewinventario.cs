...
namespace GeneXus.Programs {
   public class viewinventario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public viewinventario( IGxContext context )
      {
      ...
      public void execute( long aP0_IDPRODUCTO ,
                           string aP1_TabCode )
      {
         this.AV12IDPRODUCTO = aP0_IDPRODUCTO;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IDPRODUCTO = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12IDPRODUCTO", StringUtil.LTrimStr( (decimal)(AV12IDPRODUCTO), 12, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513232", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewinventario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDPRODUCTO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDPRODUCTO","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewInventario");
         forbiddenHiddens.Add("DESCRIPCIONPRODUCTO", StringUtil.RTrim( context.localUtil.Format( A40DESCRIPCIONPRODUCTO, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewinventario:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vIDPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IDPRODUCTO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewinventario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDPRODUCTO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDPRODUCTO","TabCode"})  ;
      }
      ...
      protected void WB0S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Inventario Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewInventario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Inventarios", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewInventario.htm");
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDESCRIPCIONPRODUCTO_Internalname, A40DESCRIPCIONPRODUCTO, "", "", 0, 1, edtDESCRIPCIONPRODUCTO_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "Nombre", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_ViewInventario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewInventario.htm");
            /* Div Control */
      ...
      protected void START0S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Inventario", 0) ;
         }
         context.wjLoc = "";
                     ...
                     else if ( StringUtil.StrCmp(sEvtType, "W") == 0 )
                     {
                        ...
                        else if ( nCmpId == 46 )
                        {
                           ...
                           if ( ( StringUtil.Len( OldDetalle_compra_productowc) == 0 ) || ( StringUtil.StrCmp(OldDetalle_compra_productowc, WebComp_Detalle_compra_productowc_Component) != 0 ) )
                           {
                              ...
                              WebComp_Detalle_compra_productowc.ComponentInit();
                              WebComp_Detalle_compra_productowc.Name = "OldDetalle_compra_productowc";
      ...
      protected void RF0S2( )
      {
         ...
         {
            /* Using cursor H000S2 */
            pr_default.execute(0, new Object[] {AV12IDPRODUCTO});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A7IDPRODUCTO = H000S2_A7IDPRODUCTO[0];
               A40DESCRIPCIONPRODUCTO = H000S2_A40DESCRIPCIONPRODUCTO[0];
      ...
      protected void STRUP0S0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IDPRODUCTO = (long)(context.localUtil.CToN( cgiGet( "vIDPRODUCTO"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewinventario:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110S2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000S3 */
         pr_default.execute(1, new Object[] {AV12IDPRODUCTO});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A7IDPRODUCTO = H000S3_A7IDPRODUCTO[0];
            A40DESCRIPCIONPRODUCTO = H000S3_A40DESCRIPCIONPRODUCTO[0];
            AssignAttri("", false, "A40DESCRIPCIONPRODUCTO", A40DESCRIPCIONPRODUCTO);
            AV16GXLvl6 = 1;
            Form.Caption = A40DESCRIPCIONPRODUCTO;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwinventario.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "InventarioGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "inventariogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "InventarioGeneral";
               WebComp_Generalwc_Component = "InventarioGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(long)AV12IDPRODUCTO});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Detalle_compra_producto") == 0 ) )
         {
            ...
            if ( true )
            {
               bDynCreated_Detalle_compra_productowc = true;
            }
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Detalle_compra_productowc_Component), StringUtil.Lower( "InventarioDetalle_compra_productoWC")) != 0 )
            {
               WebComp_Detalle_compra_productowc = getWebComponent(GetType(), "GeneXus.Programs", "inventariodetalle_compra_productowc", new Object[] {context} );
               WebComp_Detalle_compra_productowc.ComponentInit();
               WebComp_Detalle_compra_productowc.Name = "InventarioDetalle_compra_productoWC";
               WebComp_Detalle_compra_productowc_Component = "InventarioDetalle_compra_productoWC";
            }
            if ( StringUtil.Len( WebComp_Detalle_compra_productowc_Component) != 0 )
            {
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IDPRODUCTO = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12IDPRODUCTO", StringUtil.LTrimStr( (decimal)(AV12IDPRODUCTO), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513251", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewinventario.js", "?2021112620513251", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12IDPRODUCTO',fld:'vIDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A40DESCRIPCIONPRODUCTO',fld:'DESCRIPCIONPRODUCTO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000S2_A7IDPRODUCTO = new long[1] ;
         H000S2_A40DESCRIPCIONPRODUCTO = new string[] {""} ;
         hsh = "";
         H000S3_A7IDPRODUCTO = new long[1] ;
         H000S3_A40DESCRIPCIONPRODUCTO = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewinventario__default(),
            new Object[][] {
                new Object[] {
               H000S2_A7IDPRODUCTO, H000S2_A40DESCRIPCIONPRODUCTO
               }
               , new Object[] {
               H000S3_A7IDPRODUCTO, H000S3_A40DESCRIPCIONPRODUCTO
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12IDPRODUCTO ;
      private long wcpOAV12IDPRODUCTO ;
      ...
      private long[] H000S2_A7IDPRODUCTO ;
      private string[] H000S2_A40DESCRIPCIONPRODUCTO ;
      private long[] H000S3_A7IDPRODUCTO ;
      private string[] H000S3_A40DESCRIPCIONPRODUCTO ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewinventario__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12IDPRODUCTO",GXType.Decimal,12,0)
          };
          Object[] prmH000S3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000S2", "SELECT [IDPRODUCTO], [DESCRIPCIONPRODUCTO] FROM [Inventario] WHERE [IDPRODUCTO] = @AV12IDPRODUCTO ORDER BY [IDPRODUCTO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000S3", "SELECT [IDPRODUCTO], [DESCRIPCIONPRODUCTO] FROM [Inventario] WHERE [IDPRODUCTO] = @AV12IDPRODUCTO ORDER BY [IDPRODUCTO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000S3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
