...
namespace GeneXus.Programs {
   public class gx0031 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513324", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0031.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pIDCOMPRA,12,0)),UrlEncode(StringUtil.LTrimStr(AV8pIDPRODUCTO,12,0))}, new string[] {"pIDCOMPRA","pIDPRODUCTO"}) +"\">") ;
      ...
      {
         return formatLink("gx0031.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pIDCOMPRA,12,0)),UrlEncode(StringUtil.LTrimStr(AV8pIDPRODUCTO,12,0))}, new string[] {"pIDCOMPRA","pIDPRODUCTO"})  ;
      }
      ...
      {
         return "Selection List Compra_producto" ;
      }
      ...
      protected void WB1S0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblidproductofilter_Internalname, "IDPRODUCTO", "", "", lblLblidproductofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111s1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0031.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121s1_client"+"'", TempTags, "", 2, "HLP_Gx0031.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void START1S2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Compra_producto", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF1S2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A11IDCOMPRA = H001S2_A11IDCOMPRA[0];
               A7IDPRODUCTO = H001S2_A7IDPRODUCTO[0];
               /* Execute user event: Load */
               E141S2 ();
      ...
      protected void E131S2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Compra_producto", "", "", "", "", "", "", "", "");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513345", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0031.js", "?2021112620513346", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Compra_producto";
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","{handler:'E121S1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLIDPRODUCTOFILTER.CLICK","{handler:'E111S1',iparms:[{av:'divIdproductofiltercontainer_Class',ctrl:'IDPRODUCTOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E151S2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001S2_A11IDCOMPRA = new long[1] ;
         H001S2_A7IDPRODUCTO = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0031__default(),
            new Object[][] {
                new Object[] {
               H001S2_A11IDCOMPRA, H001S2_A7IDPRODUCTO
               }
               , new Object[] {
      ...
      private long[] H001S2_A11IDCOMPRA ;
      private long[] H001S2_A7IDPRODUCTO ;
   ...
   public class gx0031__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H001S2", "SELECT [IDCOMPRA], [IDPRODUCTO] FROM [Compra_inventarioCompra_produc] WHERE [IDCOMPRA] = @AV7pIDCOMPRA and [IDPRODUCTO] >= @AV6cIDPRODUCTO ORDER BY [IDCOMPRA], [IDPRODUCTO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001S2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H001S3", "SELECT COUNT(*) FROM [Compra_inventarioCompra_produc] WHERE [IDCOMPRA] = @AV7pIDCOMPRA and [IDPRODUCTO] >= @AV6cIDPRODUCTO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001S3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
