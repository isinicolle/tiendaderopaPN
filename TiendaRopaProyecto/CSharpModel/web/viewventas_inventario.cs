...
namespace GeneXus.Programs {
   public class viewventas_inventario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewventas_inventario( )
      {
      ...
      public viewventas_inventario( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IDVENTA = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12IDVENTA", StringUtil.LTrimStr( (decimal)(AV12IDVENTA), 12, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDVENTA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDVENTA), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513310", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewventas_inventario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDVENTA,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDVENTA","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewVentas_inventario");
         forbiddenHiddens.Add("FECHAVENTA", context.localUtil.Format(A54FECHAVENTA, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewventas_inventario:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vIDVENTA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IDVENTA), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDVENTA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDVENTA), "ZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewventas_inventario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDVENTA,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDVENTA","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewVentas_inventario" ;
      }

      public override string GetPgmdesc( )
      {
         return "View Ventas_inventario" ;
      }
      ...
      protected void WB0X0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Ventas_inventario Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewVentas_inventario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Ventas_inventarios", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewVentas_inventario.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtFECHAVENTA_Internalname, context.localUtil.Format(A54FECHAVENTA, "99/99/99"), context.localUtil.Format( A54FECHAVENTA, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtFECHAVENTA_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtFECHAVENTA_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ViewVentas_inventario.htm");
            GxWebStd.gx_bitmap( context, edtFECHAVENTA_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtFECHAVENTA_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewVentas_inventario.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewVentas_inventario.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDetalle_venta_producto_title_Internalname, "Detalle_venta_producto", "", "", lblDetalle_venta_producto_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewVentas_inventario.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0X2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Ventas_inventario", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewVentas_inventario";
         context.Gx_err = 0;
      }
      ...
      protected void RF0X2( )
      {
         ...
         {
            /* Using cursor H000X2 */
            pr_default.execute(0, new Object[] {AV12IDVENTA});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A12IDVENTA = H000X2_A12IDVENTA[0];
               A54FECHAVENTA = H000X2_A54FECHAVENTA[0];
      ...
      protected void STRUP0X0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IDVENTA = (long)(context.localUtil.CToN( cgiGet( "vIDVENTA"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewventas_inventario:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110X2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000X3 */
         pr_default.execute(1, new Object[] {AV12IDVENTA});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A12IDVENTA = H000X3_A12IDVENTA[0];
            A54FECHAVENTA = H000X3_A54FECHAVENTA[0];
            AssignAttri("", false, "A54FECHAVENTA", context.localUtil.Format(A54FECHAVENTA, "99/99/99"));
            AV16GXLvl6 = 1;
            Form.Caption = context.localUtil.DToC( A54FECHAVENTA, 1, "/");
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwventas_inventario.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Ventas_inventarioGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "ventas_inventariogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Ventas_inventarioGeneral";
               WebComp_Generalwc_Component = "Ventas_inventarioGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(long)AV12IDVENTA});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Detalle_venta_producto") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Detalle_venta_productowc_Component), StringUtil.Lower( "Ventas_inventarioDetalle_venta_productoWC")) != 0 )
            {
               WebComp_Detalle_venta_productowc = getWebComponent(GetType(), "GeneXus.Programs", "ventas_inventariodetalle_venta_productowc", new Object[] {context} );
               WebComp_Detalle_venta_productowc.ComponentInit();
               WebComp_Detalle_venta_productowc.Name = "Ventas_inventarioDetalle_venta_productoWC";
               WebComp_Detalle_venta_productowc_Component = "Ventas_inventarioDetalle_venta_productoWC";
            }
            if ( StringUtil.Len( WebComp_Detalle_venta_productowc_Component) != 0 )
            {
               WebComp_Detalle_venta_productowc.setjustcreated();
               WebComp_Detalle_venta_productowc.componentprepare(new Object[] {(string)"W0038",(string)"",(long)AV12IDVENTA});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IDVENTA = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12IDVENTA", StringUtil.LTrimStr( (decimal)(AV12IDVENTA), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDVENTA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDVENTA), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513330", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewventas_inventario.js", "?2021112620513330", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Ventas_inventario";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12IDVENTA',fld:'vIDVENTA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A54FECHAVENTA',fld:'FECHAVENTA',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000X2_A12IDVENTA = new long[1] ;
         H000X2_A54FECHAVENTA = new DateTime[] {DateTime.MinValue} ;
         hsh = "";
         H000X3_A12IDVENTA = new long[1] ;
         H000X3_A54FECHAVENTA = new DateTime[] {DateTime.MinValue} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewventas_inventario__default(),
            new Object[][] {
                new Object[] {
               H000X2_A12IDVENTA, H000X2_A54FECHAVENTA
               }
               , new Object[] {
               H000X3_A12IDVENTA, H000X3_A54FECHAVENTA
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12IDVENTA ;
      private long wcpOAV12IDVENTA ;
      ...
      private long[] H000X2_A12IDVENTA ;
      private DateTime[] H000X2_A54FECHAVENTA ;
      private long[] H000X3_A12IDVENTA ;
      private DateTime[] H000X3_A54FECHAVENTA ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewventas_inventario__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12IDVENTA",GXType.Decimal,12,0)
          };
          Object[] prmH000X3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000X2", "SELECT [IDVENTA], [FECHAVENTA] FROM [Ventas_inventario] WHERE [IDVENTA] = @AV12IDVENTA ORDER BY [IDVENTA] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000X3", "SELECT [IDVENTA], [FECHAVENTA] FROM [Ventas_inventario] WHERE [IDVENTA] = @AV12IDVENTA ORDER BY [IDVENTA] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000X3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
