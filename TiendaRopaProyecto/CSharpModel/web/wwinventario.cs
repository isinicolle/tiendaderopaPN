...
namespace GeneXus.Programs {
   public class wwinventario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwinventario( )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV11DESCRIPCIONPRODUCTO = GetPar( "DESCRIPCIONPRODUCTO");
               AV12Update = GetPar( "Update");
               AV13Delete = GetPar( "Delete");
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11DESCRIPCIONPRODUCTO, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513088", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwinventario.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vDESCRIPCIONPRODUCTO", AV11DESCRIPCIONPRODUCTO);
         /* Send saved values. */
      ...
      {
         return formatLink("wwinventario.aspx")  ;
      }
      ...
      protected void WB0G0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Inventarios", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWInventario.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWInventario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavDescripcionproducto_Internalname, "DESCRIPCIONPRODUCTO", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Multiple line edit */
            ...
            ClassString = "FilterSearchAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDescripcionproducto_Internalname, AV11DESCRIPCIONPRODUCTO, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", 0, 1, edtavDescripcionproducto_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "DESCRIPCIONPRODUCTO", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWInventario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "DESCRIPCIONCATEGORIAPRODUCTO") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A6IDCATEGORIAPRODUCTO), 12, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A39DESCRIPCIONCATEGORIAPRODUCTO);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtDESCRIPCIONCATEGORIAPRODUCTO_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0G2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Inventarios", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Descripcionproducto Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vDESCRIPCIONPRODUCTO"), AV11DESCRIPCIONPRODUCTO) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0G2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavDescripcionproducto_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11DESCRIPCIONPRODUCTO ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      protected void RF0G2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11DESCRIPCIONPRODUCTO ,
                                                 A40DESCRIPCIONPRODUCTO } ,
                                                 new int[]{
                                                 }
            });
            lV11DESCRIPCIONPRODUCTO = StringUtil.Concat( StringUtil.RTrim( AV11DESCRIPCIONPRODUCTO), "%", "");
            /* Using cursor H000G2 */
            pr_default.execute(0, new Object[] {lV11DESCRIPCIONPRODUCTO, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A44DESCRIPCIONMARCAPRODUCTO = H000G2_A44DESCRIPCIONMARCAPRODUCTO[0];
               A8IDMARCAPRODUCTO = H000G2_A8IDMARCAPRODUCTO[0];
               A39DESCRIPCIONCATEGORIAPRODUCTO = H000G2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
               A6IDCATEGORIAPRODUCTO = H000G2_A6IDCATEGORIAPRODUCTO[0];
               A38DESCRIPCIONESTADOPRODUCTO = H000G2_A38DESCRIPCIONESTADOPRODUCTO[0];
               A5IDESTADOPRODUCTO = H000G2_A5IDESTADOPRODUCTO[0];
               A43PRECIOVENTAPRODUCTO = H000G2_A43PRECIOVENTAPRODUCTO[0];
               A42PRECIOCOMPRAPRODUCTO = H000G2_A42PRECIOCOMPRAPRODUCTO[0];
               A41CANTIDADPRODUCTO = H000G2_A41CANTIDADPRODUCTO[0];
               A40DESCRIPCIONPRODUCTO = H000G2_A40DESCRIPCIONPRODUCTO[0];
               A7IDPRODUCTO = H000G2_A7IDPRODUCTO[0];
               A44DESCRIPCIONMARCAPRODUCTO = H000G2_A44DESCRIPCIONMARCAPRODUCTO[0];
               A39DESCRIPCIONCATEGORIAPRODUCTO = H000G2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
               A38DESCRIPCIONESTADOPRODUCTO = H000G2_A38DESCRIPCIONESTADOPRODUCTO[0];
               E140G2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDPRODUCTO"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A7IDPRODUCTO), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11DESCRIPCIONPRODUCTO = StringUtil.Concat( StringUtil.RTrim( AV11DESCRIPCIONPRODUCTO), "%", "");
         /* Using cursor H000G3 */
         pr_default.execute(1, new Object[] {lV11DESCRIPCIONPRODUCTO});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11DESCRIPCIONPRODUCTO = GridState.FilterValues("Descripcionproducto");
            AssignAttri("", false, "AV11DESCRIPCIONPRODUCTO", AV11DESCRIPCIONPRODUCTO);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("DESCRIPCIONPRODUCTO", AV11DESCRIPCIONPRODUCTO);
      }
      ...
      protected void STRUP0G0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11DESCRIPCIONPRODUCTO = cgiGet( edtavDescripcionproducto_Internalname);
            AssignAttri("", false, "AV11DESCRIPCIONPRODUCTO", AV11DESCRIPCIONPRODUCTO);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Inventario";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513125", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwinventario.js", "?2021112620513125", false, true);
         }
      ...
      {
         edtIDPRODUCTO_Internalname = "IDPRODUCTO_"+sGXsfl_25_idx;
         edtDESCRIPCIONPRODUCTO_Internalname = "DESCRIPCIONPRODUCTO_"+sGXsfl_25_idx;
         edtCANTIDADPRODUCTO_Internalname = "CANTIDADPRODUCTO_"+sGXsfl_25_idx;
         edtPRECIOCOMPRAPRODUCTO_Internalname = "PRECIOCOMPRAPRODUCTO_"+sGXsfl_25_idx;
         edtPRECIOVENTAPRODUCTO_Internalname = "PRECIOVENTAPRODUCTO_"+sGXsfl_25_idx;
         edtIDESTADOPRODUCTO_Internalname = "IDESTADOPRODUCTO_"+sGXsfl_25_idx;
         edtDESCRIPCIONESTADOPRODUCTO_Internalname = "DESCRIPCIONESTADOPRODUCTO_"+sGXsfl_25_idx;
         edtIDCATEGORIAPRODUCTO_Internalname = "IDCATEGORIAPRODUCTO_"+sGXsfl_25_idx;
         edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname = "DESCRIPCIONCATEGORIAPRODUCTO_"+sGXsfl_25_idx;
         edtIDMARCAPRODUCTO_Internalname = "IDMARCAPRODUCTO_"+sGXsfl_25_idx;
         edtDESCRIPCIONMARCAPRODUCTO_Internalname = "DESCRIPCIONMARCAPRODUCTO_"+sGXsfl_25_idx;
      ...
      {
         edtIDPRODUCTO_Internalname = "IDPRODUCTO_"+sGXsfl_25_fel_idx;
         edtDESCRIPCIONPRODUCTO_Internalname = "DESCRIPCIONPRODUCTO_"+sGXsfl_25_fel_idx;
         edtCANTIDADPRODUCTO_Internalname = "CANTIDADPRODUCTO_"+sGXsfl_25_fel_idx;
         edtPRECIOCOMPRAPRODUCTO_Internalname = "PRECIOCOMPRAPRODUCTO_"+sGXsfl_25_fel_idx;
         edtPRECIOVENTAPRODUCTO_Internalname = "PRECIOVENTAPRODUCTO_"+sGXsfl_25_fel_idx;
         edtIDESTADOPRODUCTO_Internalname = "IDESTADOPRODUCTO_"+sGXsfl_25_fel_idx;
         edtDESCRIPCIONESTADOPRODUCTO_Internalname = "DESCRIPCIONESTADOPRODUCTO_"+sGXsfl_25_fel_idx;
         edtIDCATEGORIAPRODUCTO_Internalname = "IDCATEGORIAPRODUCTO_"+sGXsfl_25_fel_idx;
         edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname = "DESCRIPCIONCATEGORIAPRODUCTO_"+sGXsfl_25_fel_idx;
         edtIDMARCAPRODUCTO_Internalname = "IDMARCAPRODUCTO_"+sGXsfl_25_fel_idx;
         edtDESCRIPCIONMARCAPRODUCTO_Internalname = "DESCRIPCIONMARCAPRODUCTO_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtPRECIOCOMPRAPRODUCTO_Internalname,StringUtil.LTrim( StringUtil.NToC( A42PRECIOCOMPRAPRODUCTO, 12, 2, ".", "")),context.localUtil.Format( A42PRECIOCOMPRAPRODUCTO, "ZZZZZZZZ9.99"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtPRECIOCOMPRAPRODUCTO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Money",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtIDCATEGORIAPRODUCTO_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A6IDCATEGORIAPRODUCTO), 12, 0, ".", "")),context.localUtil.Format( (decimal)(A6IDCATEGORIAPRODUCTO), "ZZZZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtIDCATEGORIAPRODUCTO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)0,(bool)true,(string)"Codigo",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname,(string)A39DESCRIPCIONCATEGORIAPRODUCTO,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtDESCRIPCIONCATEGORIAPRODUCTO_Link,(string)"",(string)"",(string)"",(string)edtDESCRIPCIONCATEGORIAPRODUCTO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)255,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
      ...
      protected void init_default_properties( )
      {
         ...
         edtavDescripcionproducto_Internalname = "vDESCRIPCIONPRODUCTO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtDESCRIPCIONCATEGORIAPRODUCTO_Jsonclick = "";
         ...
         edtavDescripcionproducto_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONPRODUCTO',fld:'vDESCRIPCIONPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140G2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A5IDESTADOPRODUCTO',fld:'IDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'A6IDCATEGORIAPRODUCTO',fld:'IDCATEGORIAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'A8IDMARCAPRODUCTO',fld:'IDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtDESCRIPCIONPRODUCTO_Link',ctrl:'DESCRIPCIONPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONESTADOPRODUCTO_Link',ctrl:'DESCRIPCIONESTADOPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONCATEGORIAPRODUCTO_Link',ctrl:'DESCRIPCIONCATEGORIAPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONMARCAPRODUCTO_Link',ctrl:'DESCRIPCIONMARCAPRODUCTO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110G2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONPRODUCTO',fld:'vDESCRIPCIONPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONPRODUCTO',fld:'vDESCRIPCIONPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONPRODUCTO',fld:'vDESCRIPCIONPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONPRODUCTO',fld:'vDESCRIPCIONPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV17Pgmname = "";
         scmdbuf = "";
         lV11DESCRIPCIONPRODUCTO = "";
         H000G2_A44DESCRIPCIONMARCAPRODUCTO = new string[] {""} ;
         H000G2_A8IDMARCAPRODUCTO = new long[1] ;
         H000G2_A39DESCRIPCIONCATEGORIAPRODUCTO = new string[] {""} ;
         H000G2_A6IDCATEGORIAPRODUCTO = new long[1] ;
         H000G2_A38DESCRIPCIONESTADOPRODUCTO = new string[] {""} ;
         H000G2_A5IDESTADOPRODUCTO = new long[1] ;
         H000G2_A43PRECIOVENTAPRODUCTO = new decimal[1] ;
         H000G2_A42PRECIOCOMPRAPRODUCTO = new decimal[1] ;
         H000G2_A41CANTIDADPRODUCTO = new long[1] ;
         H000G2_A40DESCRIPCIONPRODUCTO = new string[] {""} ;
         H000G2_A7IDPRODUCTO = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwinventario__default(),
            new Object[][] {
                new Object[] {
               H000G2_A44DESCRIPCIONMARCAPRODUCTO, H000G2_A8IDMARCAPRODUCTO, H000G2_A39DESCRIPCIONCATEGORIAPRODUCTO, H000G2_A6IDCATEGORIAPRODUCTO, H000G2_A38DESCRIPCIONESTADOPRODUCTO, H000G2_A5IDESTADOPRODUCTO, H000G2_A43PRECIOVENTAPRODUCTO, H000G2_A42PRECIOCOMPRAPRODUCTO, H000G2_A41CANTIDADPRODUCTO, H000G2_A40DESCRIPCIONPRODUCTO,
               H000G2_A7IDPRODUCTO
               }
               , new Object[] {
      ...
      private int edtavDescripcionproducto_Enabled ;
      ...
      private string edtavDescripcionproducto_Internalname ;
      ...
      private string edtDESCRIPCIONCATEGORIAPRODUCTO_Jsonclick ;
      ...
      private string AV11DESCRIPCIONPRODUCTO ;
      ...
      private string lV11DESCRIPCIONPRODUCTO ;
      ...
      private string[] H000G2_A44DESCRIPCIONMARCAPRODUCTO ;
      private long[] H000G2_A8IDMARCAPRODUCTO ;
      private string[] H000G2_A39DESCRIPCIONCATEGORIAPRODUCTO ;
      private long[] H000G2_A6IDCATEGORIAPRODUCTO ;
      private string[] H000G2_A38DESCRIPCIONESTADOPRODUCTO ;
      private long[] H000G2_A5IDESTADOPRODUCTO ;
      private decimal[] H000G2_A43PRECIOVENTAPRODUCTO ;
      private decimal[] H000G2_A42PRECIOCOMPRAPRODUCTO ;
      private long[] H000G2_A41CANTIDADPRODUCTO ;
      private string[] H000G2_A40DESCRIPCIONPRODUCTO ;
      private long[] H000G2_A7IDPRODUCTO ;
   ...
   public class wwinventario__default : DataStoreHelperBase, IDataStoreHelper
   {
                                             ...
                                             string A40DESCRIPCIONPRODUCTO )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T2.[DESCRIPCIONMARCAPRODUCTO], T1.[IDMARCAPRODUCTO], T3.[DESCRIPCIONCATEGORIAPRODUCTO], T1.[IDCATEGORIAPRODUCTO], T4.[DESCRIPCIONESTADOPRODUCTO], T1.[IDESTADOPRODUCTO], T1.[PRECIOVENTAPRODUCTO], T1.[PRECIOCOMPRAPRODUCTO], T1.[CANTIDADPRODUCTO], T1.[DESCRIPCIONPRODUCTO], T1.[IDPRODUCTO]";
         sFromString = " FROM ((([Inventario] T1 INNER JOIN [Marca_producto] T2 ON T2.[IDMARCAPRODUCTO] = T1.[IDMARCAPRODUCTO]) INNER JOIN [Categoria_producto] T3 ON T3.[IDCATEGORIAPRODUCTO] = T1.[IDCATEGORIAPRODUCTO]) INNER JOIN [Estado_producto] T4 ON T4.[IDESTADOPRODUCTO] = T1.[IDESTADOPRODUCTO])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11DESCRIPCIONPRODUCTO)) )
         {
            AddWhere(sWhereString, "(T1.[DESCRIPCIONPRODUCTO] like @lV11DESCRIPCIONPRODUCTO)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[DESCRIPCIONPRODUCTO]";
                                             ...
                                             string A40DESCRIPCIONPRODUCTO )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM ((([Inventario] T1 INNER JOIN [Marca_producto] T4 ON T4.[IDMARCAPRODUCTO] = T1.[IDMARCAPRODUCTO]) INNER JOIN [Categoria_producto] T3 ON T3.[IDCATEGORIAPRODUCTO] = T1.[IDCATEGORIAPRODUCTO]) INNER JOIN [Estado_producto] T2 ON T2.[IDESTADOPRODUCTO] = T1.[IDESTADOPRODUCTO])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11DESCRIPCIONPRODUCTO)) )
         {
            AddWhere(sWhereString, "(T1.[DESCRIPCIONPRODUCTO] like @lV11DESCRIPCIONPRODUCTO)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11DESCRIPCIONPRODUCTO",GXType.NVarChar,255,0) ,
