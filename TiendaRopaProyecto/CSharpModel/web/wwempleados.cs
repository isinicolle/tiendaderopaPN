...
namespace GeneXus.Programs {
   public class wwempleados : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwempleados( )
      {
      ...
      public wwempleados( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV11NOMBRECOMPLETOEMPLEADO = GetPar( "NOMBRECOMPLETOEMPLEADO");
               AV12Update = GetPar( "Update");
               AV13Delete = GetPar( "Delete");
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11NOMBRECOMPLETOEMPLEADO, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113012305941", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwempleados.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vNOMBRECOMPLETOEMPLEADO", AV11NOMBRECOMPLETOEMPLEADO);
         /* Send saved values. */
      ...
      {
         return formatLink("wwempleados.aspx")  ;
      }
      ...
      protected void WB0A0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Empleadoss", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWEmpleados.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWEmpleados.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavNombrecompletoempleado_Internalname, "NOMBRECOMPLETOEMPLEADO", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Multiple line edit */
            ...
            ClassString = "FilterSearchAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavNombrecompletoempleado_Internalname, AV11NOMBRECOMPLETOEMPLEADO, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", 0, 1, edtavNombrecompletoempleado_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "NOMBRECOMPLETOEMPLEADO", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWEmpleados.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+"Attribute"+"\" "+" style=\""+""+""+"\" "+">") ;
               context.SendWebValue( "DESCRIPCIONESTADOEMPLEADO") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A3IDESTADOEMPLEADO), 12, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
               GridColumn.AddObjectProperty("Value", A22DESCRIPCIONESTADOEMPLEADO);
               GridColumn.AddObjectProperty("Link", StringUtil.RTrim( edtDESCRIPCIONESTADOEMPLEADO_Link));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( ));
      ...
      protected void START0A2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Empleadoss", 0) ;
         }
         context.wjLoc = "";
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              AssignProp("", false, edtFOTOEMPLEADO_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A52FOTOEMPLEADO)) ? A40000FOTOEMPLEADO_GXI : context.convertURL( context.PathToRelativeUrl( A52FOTOEMPLEADO))), !bGXsfl_25_Refreshing);
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Nombrecompletoempleado Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vNOMBRECOMPLETOEMPLEADO"), AV11NOMBRECOMPLETOEMPLEADO) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0A2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavNombrecompletoempleado_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11NOMBRECOMPLETOEMPLEADO ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      protected void RF0A2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11NOMBRECOMPLETOEMPLEADO ,
                                                 A23NOMBRECOMPLETOEMPLEADO } ,
                                                 new int[]{
                                                 }
            });
            lV11NOMBRECOMPLETOEMPLEADO = StringUtil.Concat( StringUtil.RTrim( AV11NOMBRECOMPLETOEMPLEADO), "%", "");
            /* Using cursor H000A2 */
            pr_default.execute(0, new Object[] {lV11NOMBRECOMPLETOEMPLEADO, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A40000FOTOEMPLEADO_GXI = H000A2_A40000FOTOEMPLEADO_GXI[0];
               AssignProp("", false, edtFOTOEMPLEADO_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A52FOTOEMPLEADO)) ? A40000FOTOEMPLEADO_GXI : context.convertURL( context.PathToRelativeUrl( A52FOTOEMPLEADO))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtFOTOEMPLEADO_Internalname, "SrcSet", context.GetImageSrcSet( A52FOTOEMPLEADO), true);
               A22DESCRIPCIONESTADOEMPLEADO = H000A2_A22DESCRIPCIONESTADOEMPLEADO[0];
               A3IDESTADOEMPLEADO = H000A2_A3IDESTADOEMPLEADO[0];
               A21DESCRIPCIONTIPOEMPLEADO = H000A2_A21DESCRIPCIONTIPOEMPLEADO[0];
               A2IDTIPOEMPLEADO = H000A2_A2IDTIPOEMPLEADO[0];
               A28DIRECCIONEMPLEADO = H000A2_A28DIRECCIONEMPLEADO[0];
               A27CORREOEMPLEADO = H000A2_A27CORREOEMPLEADO[0];
               A29FECHACONTRATACIONEMPLEADO = H000A2_A29FECHACONTRATACIONEMPLEADO[0];
               A26TELEFONOEMPLEADO = H000A2_A26TELEFONOEMPLEADO[0];
               A25CONTRASENAEMPLEADO = H000A2_A25CONTRASENAEMPLEADO[0];
               A24USUARIOEMPLEADO = H000A2_A24USUARIOEMPLEADO[0];
               A23NOMBRECOMPLETOEMPLEADO = H000A2_A23NOMBRECOMPLETOEMPLEADO[0];
               A1IDEMPLEADO = H000A2_A1IDEMPLEADO[0];
               A52FOTOEMPLEADO = H000A2_A52FOTOEMPLEADO[0];
               AssignProp("", false, edtFOTOEMPLEADO_Internalname, "Bitmap", (String.IsNullOrEmpty(StringUtil.RTrim( A52FOTOEMPLEADO)) ? A40000FOTOEMPLEADO_GXI : context.convertURL( context.PathToRelativeUrl( A52FOTOEMPLEADO))), !bGXsfl_25_Refreshing);
               AssignProp("", false, edtFOTOEMPLEADO_Internalname, "SrcSet", context.GetImageSrcSet( A52FOTOEMPLEADO), true);
               A22DESCRIPCIONESTADOEMPLEADO = H000A2_A22DESCRIPCIONESTADOEMPLEADO[0];
               A21DESCRIPCIONTIPOEMPLEADO = H000A2_A21DESCRIPCIONTIPOEMPLEADO[0];
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDEMPLEADO"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A1IDEMPLEADO), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11NOMBRECOMPLETOEMPLEADO = StringUtil.Concat( StringUtil.RTrim( AV11NOMBRECOMPLETOEMPLEADO), "%", "");
         /* Using cursor H000A3 */
         pr_default.execute(1, new Object[] {lV11NOMBRECOMPLETOEMPLEADO});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11NOMBRECOMPLETOEMPLEADO = GridState.FilterValues("Nombrecompletoempleado");
            AssignAttri("", false, "AV11NOMBRECOMPLETOEMPLEADO", AV11NOMBRECOMPLETOEMPLEADO);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("NOMBRECOMPLETOEMPLEADO", AV11NOMBRECOMPLETOEMPLEADO);
      }
      ...
      protected void STRUP0A0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11NOMBRECOMPLETOEMPLEADO = cgiGet( edtavNombrecompletoempleado_Internalname);
            AssignAttri("", false, "AV11NOMBRECOMPLETOEMPLEADO", AV11NOMBRECOMPLETOEMPLEADO);
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Empleados";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113012305988", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwempleados.js", "?2021113012305988", false, true);
         }
      ...
      protected void SubsflControlProps_252( )
      {
         ...
         edtUSUARIOEMPLEADO_Internalname = "USUARIOEMPLEADO_"+sGXsfl_25_idx;
         edtCONTRASENAEMPLEADO_Internalname = "CONTRASENAEMPLEADO_"+sGXsfl_25_idx;
         edtTELEFONOEMPLEADO_Internalname = "TELEFONOEMPLEADO_"+sGXsfl_25_idx;
         edtFECHACONTRATACIONEMPLEADO_Internalname = "FECHACONTRATACIONEMPLEADO_"+sGXsfl_25_idx;
         edtCORREOEMPLEADO_Internalname = "CORREOEMPLEADO_"+sGXsfl_25_idx;
         edtDIRECCIONEMPLEADO_Internalname = "DIRECCIONEMPLEADO_"+sGXsfl_25_idx;
         edtIDTIPOEMPLEADO_Internalname = "IDTIPOEMPLEADO_"+sGXsfl_25_idx;
         edtDESCRIPCIONTIPOEMPLEADO_Internalname = "DESCRIPCIONTIPOEMPLEADO_"+sGXsfl_25_idx;
         edtIDESTADOEMPLEADO_Internalname = "IDESTADOEMPLEADO_"+sGXsfl_25_idx;
         edtDESCRIPCIONESTADOEMPLEADO_Internalname = "DESCRIPCIONESTADOEMPLEADO_"+sGXsfl_25_idx;
         edtFOTOEMPLEADO_Internalname = "FOTOEMPLEADO_"+sGXsfl_25_idx;
      ...
      protected void SubsflControlProps_fel_252( )
      {
         ...
         edtUSUARIOEMPLEADO_Internalname = "USUARIOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtCONTRASENAEMPLEADO_Internalname = "CONTRASENAEMPLEADO_"+sGXsfl_25_fel_idx;
         edtTELEFONOEMPLEADO_Internalname = "TELEFONOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtFECHACONTRATACIONEMPLEADO_Internalname = "FECHACONTRATACIONEMPLEADO_"+sGXsfl_25_fel_idx;
         edtCORREOEMPLEADO_Internalname = "CORREOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtDIRECCIONEMPLEADO_Internalname = "DIRECCIONEMPLEADO_"+sGXsfl_25_fel_idx;
         edtIDTIPOEMPLEADO_Internalname = "IDTIPOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtDESCRIPCIONTIPOEMPLEADO_Internalname = "DESCRIPCIONTIPOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtIDESTADOEMPLEADO_Internalname = "IDESTADOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtDESCRIPCIONESTADOEMPLEADO_Internalname = "DESCRIPCIONESTADOEMPLEADO_"+sGXsfl_25_fel_idx;
         edtFOTOEMPLEADO_Internalname = "FOTOEMPLEADO_"+sGXsfl_25_fel_idx;
      ...
      protected void sendrow_252( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_25_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtUSUARIOEMPLEADO_Internalname,(string)A24USUARIOEMPLEADO,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtUSUARIOEMPLEADO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)255,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtCONTRASENAEMPLEADO_Internalname,(string)A25CONTRASENAEMPLEADO,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtCONTRASENAEMPLEADO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)255,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDESCRIPCIONTIPOEMPLEADO_Internalname,(string)A21DESCRIPCIONTIPOEMPLEADO,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtDESCRIPCIONTIPOEMPLEADO_Link,(string)"",(string)"",(string)"",(string)edtDESCRIPCIONTIPOEMPLEADO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)255,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"right"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDESCRIPCIONESTADOEMPLEADO_Internalname,(string)A22DESCRIPCIONESTADOEMPLEADO,(string)"",(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)edtDESCRIPCIONESTADOEMPLEADO_Link,(string)"",(string)"",(string)"",(string)edtDESCRIPCIONESTADOEMPLEADO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)255,(short)0,(short)0,(short)25,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
      ...
      protected void init_default_properties( )
      {
         ...
         edtavNombrecompletoempleado_Internalname = "vNOMBRECOMPLETOEMPLEADO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtDESCRIPCIONESTADOEMPLEADO_Jsonclick = "";
         ...
         edtavNombrecompletoempleado_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBRECOMPLETOEMPLEADO',fld:'vNOMBRECOMPLETOEMPLEADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140A2',iparms:[{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A2IDTIPOEMPLEADO',fld:'IDTIPOEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'A3IDESTADOEMPLEADO',fld:'IDESTADOEMPLEADO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtNOMBRECOMPLETOEMPLEADO_Link',ctrl:'NOMBRECOMPLETOEMPLEADO',prop:'Link'},{av:'edtDESCRIPCIONTIPOEMPLEADO_Link',ctrl:'DESCRIPCIONTIPOEMPLEADO',prop:'Link'},{av:'edtDESCRIPCIONESTADOEMPLEADO_Link',ctrl:'DESCRIPCIONESTADOEMPLEADO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110A2',iparms:[{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBRECOMPLETOEMPLEADO',fld:'vNOMBRECOMPLETOEMPLEADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBRECOMPLETOEMPLEADO',fld:'vNOMBRECOMPLETOEMPLEADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBRECOMPLETOEMPLEADO',fld:'vNOMBRECOMPLETOEMPLEADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11NOMBRECOMPLETOEMPLEADO',fld:'vNOMBRECOMPLETOEMPLEADO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV17Pgmname = "";
         scmdbuf = "";
         lV11NOMBRECOMPLETOEMPLEADO = "";
         H000A2_A40000FOTOEMPLEADO_GXI = new string[] {""} ;
         H000A2_A22DESCRIPCIONESTADOEMPLEADO = new string[] {""} ;
         H000A2_A3IDESTADOEMPLEADO = new long[1] ;
         H000A2_A21DESCRIPCIONTIPOEMPLEADO = new string[] {""} ;
         H000A2_A2IDTIPOEMPLEADO = new long[1] ;
         H000A2_A28DIRECCIONEMPLEADO = new string[] {""} ;
         H000A2_A27CORREOEMPLEADO = new string[] {""} ;
         H000A2_A29FECHACONTRATACIONEMPLEADO = new DateTime[] {DateTime.MinValue} ;
         H000A2_A26TELEFONOEMPLEADO = new string[] {""} ;
         H000A2_A25CONTRASENAEMPLEADO = new string[] {""} ;
         H000A2_A24USUARIOEMPLEADO = new string[] {""} ;
         H000A2_A23NOMBRECOMPLETOEMPLEADO = new string[] {""} ;
         H000A2_A1IDEMPLEADO = new long[1] ;
         H000A2_A52FOTOEMPLEADO = new string[] {""} ;
         ...
         gxphoneLink = "";
         sImgUrl = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwempleados__default(),
            new Object[][] {
                new Object[] {
               H000A2_A40000FOTOEMPLEADO_GXI, H000A2_A22DESCRIPCIONESTADOEMPLEADO, H000A2_A3IDESTADOEMPLEADO, H000A2_A21DESCRIPCIONTIPOEMPLEADO, H000A2_A2IDTIPOEMPLEADO, H000A2_A28DIRECCIONEMPLEADO, H000A2_A27CORREOEMPLEADO, H000A2_A29FECHACONTRATACIONEMPLEADO, H000A2_A26TELEFONOEMPLEADO, H000A2_A25CONTRASENAEMPLEADO,
               H000A2_A24USUARIOEMPLEADO, H000A2_A23NOMBRECOMPLETOEMPLEADO, H000A2_A1IDEMPLEADO, H000A2_A52FOTOEMPLEADO
               }
               , new Object[] {
      ...
      private int edtavNombrecompletoempleado_Enabled ;
      ...
      private string edtavNombrecompletoempleado_Internalname ;
      ...
      private string edtDESCRIPCIONESTADOEMPLEADO_Jsonclick ;
      ...
      private string AV11NOMBRECOMPLETOEMPLEADO ;
      ...
      private string lV11NOMBRECOMPLETOEMPLEADO ;
      ...
      private string[] H000A2_A40000FOTOEMPLEADO_GXI ;
      private string[] H000A2_A22DESCRIPCIONESTADOEMPLEADO ;
      private long[] H000A2_A3IDESTADOEMPLEADO ;
      private string[] H000A2_A21DESCRIPCIONTIPOEMPLEADO ;
      private long[] H000A2_A2IDTIPOEMPLEADO ;
      private string[] H000A2_A28DIRECCIONEMPLEADO ;
      private string[] H000A2_A27CORREOEMPLEADO ;
      private DateTime[] H000A2_A29FECHACONTRATACIONEMPLEADO ;
      private string[] H000A2_A26TELEFONOEMPLEADO ;
      private string[] H000A2_A25CONTRASENAEMPLEADO ;
      private string[] H000A2_A24USUARIOEMPLEADO ;
      private string[] H000A2_A23NOMBRECOMPLETOEMPLEADO ;
      private long[] H000A2_A1IDEMPLEADO ;
      private string[] H000A2_A52FOTOEMPLEADO ;
   ...
   public class wwempleados__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000A2( IGxContext context ,
                                             string AV11NOMBRECOMPLETOEMPLEADO ,
                                             string A23NOMBRECOMPLETOEMPLEADO )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " T1.[FOTOEMPLEADO_GXI], T2.[DESCRIPCIONESTADOEMPLEADO], T1.[IDESTADOEMPLEADO], T3.[DESCRIPCIONTIPOEMPLEADO], T1.[IDTIPOEMPLEADO], T1.[DIRECCIONEMPLEADO], T1.[CORREOEMPLEADO], T1.[FECHACONTRATACIONEMPLEADO], T1.[TELEFONOEMPLEADO], T1.[CONTRASENAEMPLEADO], T1.[USUARIOEMPLEADO], T1.[NOMBRECOMPLETOEMPLEADO], T1.[IDEMPLEADO], T1.[FOTOEMPLEADO]";
         sFromString = " FROM (([Empleados] T1 INNER JOIN [Estado_empleado] T2 ON T2.[IDESTADOEMPLEADO] = T1.[IDESTADOEMPLEADO]) INNER JOIN [Tipo_empleado] T3 ON T3.[IDTIPOEMPLEADO] = T1.[IDTIPOEMPLEADO])";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11NOMBRECOMPLETOEMPLEADO)) )
         {
            AddWhere(sWhereString, "(T1.[NOMBRECOMPLETOEMPLEADO] like @lV11NOMBRECOMPLETOEMPLEADO)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY T1.[NOMBRECOMPLETOEMPLEADO]";
                                             ...
                                             string A23NOMBRECOMPLETOEMPLEADO )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM (([Empleados] T1 INNER JOIN [Estado_empleado] T3 ON T3.[IDESTADOEMPLEADO] = T1.[IDESTADOEMPLEADO]) INNER JOIN [Tipo_empleado] T2 ON T2.[IDTIPOEMPLEADO] = T1.[IDTIPOEMPLEADO])";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11NOMBRECOMPLETOEMPLEADO)) )
         {
            AddWhere(sWhereString, "(T1.[NOMBRECOMPLETOEMPLEADO] like @lV11NOMBRECOMPLETOEMPLEADO)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11NOMBRECOMPLETOEMPLEADO",GXType.NVarChar,255,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H000A2", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000A2,1, GxCacheFrequency.OFF ,true,false )
                            ...
                            Object[] buf )
    {
       switch ( cursor )
       {
             case 0 :
                ...
                ((string[]) buf[13])[0] = rslt.getMultimediaFile(14, rslt.getVarchar(1));
                return;
             case 1 :
