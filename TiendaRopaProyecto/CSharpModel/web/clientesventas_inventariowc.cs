...
namespace GeneXus.Programs {
   public class clientesventas_inventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public clientesventas_inventariowc( )
      {
      ...
      public clientesventas_inventariowc( IGxContext context )
      {
      ...
      {
         this.AV6IDCLIENTE = aP0_IDCLIENTE;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IDCLIENTE = (long)(NumberUtil.Val( GetPar( "IDCLIENTE"), "."));
                  AssignAttri(sPrefix, false, "AV6IDCLIENTE", StringUtil.LTrimStr( (decimal)(AV6IDCLIENTE), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6IDCLIENTE});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6IDCLIENTE, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "ClientesVentas_inventarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Clientes Ventas_inventario WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113013582815", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("clientesventas_inventariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDCLIENTE,12,0))}, new string[] {"IDCLIENTE"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6IDCLIENTE", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6IDCLIENTE), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vIDCLIENTE", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDCLIENTE), 12, 0, ".", "")));
      ...
      {
         return "ClientesVentas_inventarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Clientes Ventas_inventario WC" ;
      }
      ...
      protected void WB2Z0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "clientesventas_inventariowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_ClientesVentas_inventarioWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtIDCLIENTE_Internalname, "IDCLIENTE", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtIDCLIENTE_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A4IDCLIENTE), 12, 0, ".", "")), ((edtIDCLIENTE_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A4IDCLIENTE), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A4IDCLIENTE), "ZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtIDCLIENTE_Jsonclick, 0, "Attribute", "", "", "", "", edtIDCLIENTE_Visible, edtIDCLIENTE_Enabled, 0, "number", "1", 12, "chr", 1, "row", 12, 0, 0, 0, 1, -1, 0, true, "Codigo", "right", false, "", "HLP_ClientesVentas_inventarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START2Z2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Clientes Ventas_inventario WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF2Z2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002Z14 */
            pr_default.execute(0, new Object[] {AV6IDCLIENTE, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A4IDCLIENTE = H002Z14_A4IDCLIENTE[0];
               AssignAttri(sPrefix, false, "A4IDCLIENTE", StringUtil.LTrimStr( (decimal)(A4IDCLIENTE), 12, 0));
               A58DESCUENTOVENTA = H002Z14_A58DESCUENTOVENTA[0];
               A23NOMBRECOMPLETOEMPLEADO = H002Z14_A23NOMBRECOMPLETOEMPLEADO[0];
               A1IDEMPLEADO = H002Z14_A1IDEMPLEADO[0];
               A55DESCRIPCIONVENTA = H002Z14_A55DESCRIPCIONVENTA[0];
               A54FECHAVENTA = H002Z14_A54FECHAVENTA[0];
               A12IDVENTA = H002Z14_A12IDVENTA[0];
               A59TOTALVENTA = H002Z14_A59TOTALVENTA[0];
               n59TOTALVENTA = H002Z14_n59TOTALVENTA[0];
               A57IMPUESTOVENTA = H002Z14_A57IMPUESTOVENTA[0];
               n57IMPUESTOVENTA = H002Z14_n57IMPUESTOVENTA[0];
               A23NOMBRECOMPLETOEMPLEADO = H002Z14_A23NOMBRECOMPLETOEMPLEADO[0];
               A59TOTALVENTA = H002Z14_A59TOTALVENTA[0];
               n59TOTALVENTA = H002Z14_n59TOTALVENTA[0];
               A57IMPUESTOVENTA = H002Z14_A57IMPUESTOVENTA[0];
      ...
      {
         /* Using cursor H002Z27 */
         pr_default.execute(1, new Object[] {AV6IDCLIENTE});
         GRID_nRecordCount = H002Z27_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP2Z0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IDCLIENTE = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDCLIENTE"), ".", ","));
      ...
      protected void E122Z2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtIDCLIENTE_Visible = 0;
         AssignProp(sPrefix, false, edtIDCLIENTE_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIDCLIENTE_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "IDCLIENTE";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IDCLIENTE), 12, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6IDCLIENTE = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6IDCLIENTE", StringUtil.LTrimStr( (decimal)(AV6IDCLIENTE), 12, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6IDCLIENTE = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "clientesventas_inventariowc", GetJustCreated( ));
         ...
         {
            AV6IDCLIENTE = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6IDCLIENTE", StringUtil.LTrimStr( (decimal)(AV6IDCLIENTE), 12, 0));
         }
         wcpOAV6IDCLIENTE = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDCLIENTE"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6IDCLIENTE != wcpOAV6IDCLIENTE ) ) )
         {
            setjustcreated();
         }
         wcpOAV6IDCLIENTE = AV6IDCLIENTE;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6IDCLIENTE = cgiGet( sPrefix+"AV6IDCLIENTE_CTRL");
         if ( StringUtil.Len( sCtrlAV6IDCLIENTE) > 0 )
         {
            AV6IDCLIENTE = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6IDCLIENTE), ".", ","));
            AssignAttri(sPrefix, false, "AV6IDCLIENTE", StringUtil.LTrimStr( (decimal)(AV6IDCLIENTE), 12, 0));
         }
         else
         {
            AV6IDCLIENTE = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6IDCLIENTE_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDCLIENTE_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDCLIENTE), 12, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6IDCLIENTE)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDCLIENTE_CTRL", StringUtil.RTrim( sCtrlAV6IDCLIENTE));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113013582856", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("clientesventas_inventariowc.js", "?2021113013582856", false, true);
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDCLIENTE',fld:'vIDCLIENTE',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E132Z2',iparms:[{av:'A12IDVENTA',fld:'IDVENTA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtFECHAVENTA_Link',ctrl:'FECHAVENTA',prop:'Link'},{av:'edtNOMBRECOMPLETOEMPLEADO_Link',ctrl:'NOMBRECOMPLETOEMPLEADO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E112Z2',iparms:[{av:'A12IDVENTA',fld:'IDVENTA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDCLIENTE',fld:'vIDCLIENTE',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDCLIENTE',fld:'vIDCLIENTE',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDCLIENTE',fld:'vIDCLIENTE',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDCLIENTE',fld:'vIDCLIENTE',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002Z14_A4IDCLIENTE = new long[1] ;
         H002Z14_A58DESCUENTOVENTA = new decimal[1] ;
         H002Z14_A23NOMBRECOMPLETOEMPLEADO = new string[] {""} ;
         H002Z14_A1IDEMPLEADO = new long[1] ;
         H002Z14_A55DESCRIPCIONVENTA = new string[] {""} ;
         H002Z14_A54FECHAVENTA = new DateTime[] {DateTime.MinValue} ;
         H002Z14_A12IDVENTA = new long[1] ;
         H002Z14_A59TOTALVENTA = new decimal[1] ;
         H002Z14_n59TOTALVENTA = new bool[] {false} ;
         H002Z14_A57IMPUESTOVENTA = new decimal[1] ;
         H002Z14_n57IMPUESTOVENTA = new bool[] {false} ;
         H002Z27_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6IDCLIENTE = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.clientesventas_inventariowc__default(),
            new Object[][] {
                new Object[] {
               H002Z14_A4IDCLIENTE, H002Z14_A58DESCUENTOVENTA, H002Z14_A23NOMBRECOMPLETOEMPLEADO, H002Z14_A1IDEMPLEADO, H002Z14_A55DESCRIPCIONVENTA, H002Z14_A54FECHAVENTA, H002Z14_A12IDVENTA, H002Z14_A59TOTALVENTA, H002Z14_n59TOTALVENTA, H002Z14_A57IMPUESTOVENTA,
               H002Z14_n57IMPUESTOVENTA
               }
               , new Object[] {
               H002Z27_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "ClientesVentas_inventarioWC";
      ...
      private int edtIDCLIENTE_Visible ;
      ...
      private string sCtrlAV6IDCLIENTE ;
      ...
      private long[] H002Z14_A4IDCLIENTE ;
      private decimal[] H002Z14_A58DESCUENTOVENTA ;
      private string[] H002Z14_A23NOMBRECOMPLETOEMPLEADO ;
      private long[] H002Z14_A1IDEMPLEADO ;
      private string[] H002Z14_A55DESCRIPCIONVENTA ;
      private DateTime[] H002Z14_A54FECHAVENTA ;
      private long[] H002Z14_A12IDVENTA ;
      private decimal[] H002Z14_A59TOTALVENTA ;
      private bool[] H002Z14_n59TOTALVENTA ;
      private decimal[] H002Z14_A57IMPUESTOVENTA ;
      private bool[] H002Z14_n57IMPUESTOVENTA ;
      private long[] H002Z27_AGRID_nRecordCount ;
   ...
   public class clientesventas_inventariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
