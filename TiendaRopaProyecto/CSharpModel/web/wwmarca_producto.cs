...
namespace GeneXus.Programs {
   public class wwmarca_producto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public wwmarca_producto( )
      {
      ...
      public wwmarca_producto( IGxContext context )
      {
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
            {
               ...
               AV11DESCRIPCIONMARCAPRODUCTO = GetPar( "DESCRIPCIONMARCAPRODUCTO");
               AV12Update = GetPar( "Update");
               AV13Delete = GetPar( "Delete");
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               ...
               gxgrGrid_refresh( subGrid_Rows, AV11DESCRIPCIONMARCAPRODUCTO, AV12Update, AV13Delete) ;
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202111262051314", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( nGXWrapped != 1 )
         {
            context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("wwmarca_producto.aspx") +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "GXH_vDESCRIPCIONMARCAPRODUCTO", AV11DESCRIPCIONMARCAPRODUCTO);
         /* Send saved values. */
      ...
      {
         return formatLink("wwmarca_producto.aspx")  ;
      }

      public override string GetPgmname( )
      {
         return "WWMarca_producto" ;
      }

      public override string GetPgmdesc( )
      {
         return "Marca_productoes" ;
      }
      ...
      protected void WB0J0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblTitletext_Internalname, "Marca_productoes", "", "", lblTitletext_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_WWMarca_producto.htm");
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(25), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_WWMarca_producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            GxWebStd.gx_label_element( context, edtavDescripcionmarcaproducto_Internalname, "DESCRIPCIONMARCAPRODUCTO", "col-sm-3 FilterSearchAttributeLabel", 0, true, "");
            /* Multiple line edit */
            ...
            ClassString = "FilterSearchAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtavDescripcionmarcaproducto_Internalname, AV11DESCRIPCIONMARCAPRODUCTO, "", TempTags+" onchange=\""+""+";gx.evt.onchange(this, event)\" "+" onblur=\""+""+";gx.evt.onblur(this,16);\"", 0, 1, edtavDescripcionmarcaproducto_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "DESCRIPCIONMARCAPRODUCTO", -1, true, "", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_WWMarca_producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START0J2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Marca_productoes", 0) ;
         }
         context.wjLoc = "";
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 7), "REFRESH") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 ...
                                 else if ( StringUtil.StrCmp(sEvt, "ENTER") == 0 )
                                 {
                                    ...
                                    {
                                       Rfr0gs = false;
                                       /* Set Refresh If Descripcionmarcaproducto Changed */
                                       if ( StringUtil.StrCmp(cgiGet( "GXH_vDESCRIPCIONMARCAPRODUCTO"), AV11DESCRIPCIONMARCAPRODUCTO) != 0 )
                                       {
                                          Rfr0gs = true;
                                       }
                                       if ( ! Rfr0gs )
      ...
      protected void PA0J2( )
      {
         if ( nDonePA == 0 )
         {
            ...
            if ( ! context.isAjaxRequest( ) )
            {
               GX_FocusControl = edtavDescripcionmarcaproducto_Internalname;
      ...
      protected void gxgrGrid_refresh( int subGrid_Rows ,
                                       string AV11DESCRIPCIONMARCAPRODUCTO ,
                                       string AV12Update ,
                                       string AV13Delete )
      {
         initialize_formulas( ) ;
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDMARCAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(A8IDMARCAPRODUCTO), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, "IDMARCAPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(A8IDMARCAPRODUCTO), 12, 0, ".", "")));
      }
      ...
      protected void RF0J2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            pr_default.dynParam(0, new Object[]{ new Object[]{
                                                 AV11DESCRIPCIONMARCAPRODUCTO ,
                                                 A44DESCRIPCIONMARCAPRODUCTO } ,
                                                 new int[]{
                                                 }
            });
            lV11DESCRIPCIONMARCAPRODUCTO = StringUtil.Concat( StringUtil.RTrim( AV11DESCRIPCIONMARCAPRODUCTO), "%", "");
            /* Using cursor H000J2 */
            pr_default.execute(0, new Object[] {lV11DESCRIPCIONMARCAPRODUCTO, GXPagingFrom2, GXPagingTo2, GXPagingTo2});
            nGXsfl_25_idx = 1;
            sGXsfl_25_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_25_idx), 4, 0), 4, "0");
            SubsflControlProps_252( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A44DESCRIPCIONMARCAPRODUCTO = H000J2_A44DESCRIPCIONMARCAPRODUCTO[0];
               A8IDMARCAPRODUCTO = H000J2_A8IDMARCAPRODUCTO[0];
               E140J2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDMARCAPRODUCTO"+"_"+sGXsfl_25_idx, GetSecureSignedToken( sGXsfl_25_idx, context.localUtil.Format( (decimal)(A8IDMARCAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      }
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         lV11DESCRIPCIONMARCAPRODUCTO = StringUtil.Concat( StringUtil.RTrim( AV11DESCRIPCIONMARCAPRODUCTO), "%", "");
         /* Using cursor H000J3 */
         pr_default.execute(1, new Object[] {lV11DESCRIPCIONMARCAPRODUCTO});
      ...
      protected void subgrid_varsfromstate( )
      {
         ...
         {
            AV11DESCRIPCIONMARCAPRODUCTO = GridState.FilterValues("Descripcionmarcaproducto");
            AssignAttri("", false, "AV11DESCRIPCIONMARCAPRODUCTO", AV11DESCRIPCIONMARCAPRODUCTO);
         }
      ...
      protected void subgrid_varstostate( )
      {
         ...
         GridState.AddFilterValue("DESCRIPCIONMARCAPRODUCTO", AV11DESCRIPCIONMARCAPRODUCTO);
      }
      ...
      protected void STRUP0J0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            ...
            AV11DESCRIPCIONMARCAPRODUCTO = cgiGet( edtavDescripcionmarcaproducto_Internalname);
            AssignAttri("", false, "AV11DESCRIPCIONMARCAPRODUCTO", AV11DESCRIPCIONMARCAPRODUCTO);
      ...
      private void E140J2( )
      {
         /* Grid_Load Routine */
         returnInSub = false;
         edtavUpdate_Link = formatLink("marca_producto.aspx", new object[] {UrlEncode(StringUtil.RTrim("UPD")),UrlEncode(StringUtil.LTrimStr(A8IDMARCAPRODUCTO,12,0))}, new string[] {"Mode","IDMARCAPRODUCTO"}) ;
         edtavDelete_Link = formatLink("marca_producto.aspx", new object[] {UrlEncode(StringUtil.RTrim("DLT")),UrlEncode(StringUtil.LTrimStr(A8IDMARCAPRODUCTO,12,0))}, new string[] {"Mode","IDMARCAPRODUCTO"}) ;
      ...
      protected void E110J2( )
      {
         /* 'DoInsert' Routine */
         returnInSub = false;
         CallWebObject(formatLink("marca_producto.aspx", new object[] {UrlEncode(StringUtil.RTrim("INS")),UrlEncode(StringUtil.LTrimStr(0,1,0))}, new string[] {"Mode","IDMARCAPRODUCTO"}) );
         context.wjLocDisableFrm = 1;
      }
      ...
      protected void S112( )
      {
         ...
         AV9TrnContext.gxTpr_Transactionname = "Marca_producto";
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513126", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            ...
            context.AddJavascriptSource("wwmarca_producto.js", "?2021112620513127", false, true);
         }
      ...
      protected void init_default_properties( )
      {
         ...
         edtavDescripcionmarcaproducto_Internalname = "vDESCRIPCIONMARCAPRODUCTO";
      ...
      public override void initialize_properties( )
      {
         ...
         edtavDescripcionmarcaproducto_Enabled = 1;
         Form.Headerrawhtml = "";
         Form.Background = "";
         Form.Textcolor = 0;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONMARCAPRODUCTO',fld:'vDESCRIPCIONMARCAPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E140J2',iparms:[{av:'A8IDMARCAPRODUCTO',fld:'IDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtDESCRIPCIONMARCAPRODUCTO_Link',ctrl:'DESCRIPCIONMARCAPRODUCTO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E110J2',iparms:[{av:'A8IDMARCAPRODUCTO',fld:'IDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONMARCAPRODUCTO',fld:'vDESCRIPCIONMARCAPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONMARCAPRODUCTO',fld:'vDESCRIPCIONMARCAPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONMARCAPRODUCTO',fld:'vDESCRIPCIONMARCAPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV11DESCRIPCIONMARCAPRODUCTO',fld:'vDESCRIPCIONMARCAPRODUCTO',pic:''},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV17Pgmname = "";
         scmdbuf = "";
         lV11DESCRIPCIONMARCAPRODUCTO = "";
         H000J2_A44DESCRIPCIONMARCAPRODUCTO = new string[] {""} ;
         H000J2_A8IDMARCAPRODUCTO = new long[1] ;
         ...
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.wwmarca_producto__default(),
            new Object[][] {
                new Object[] {
               H000J2_A44DESCRIPCIONMARCAPRODUCTO, H000J2_A8IDMARCAPRODUCTO
               }
               , new Object[] {
      ...
      private int edtavDescripcionmarcaproducto_Enabled ;
      ...
      private string edtavDescripcionmarcaproducto_Internalname ;
      ...
      private string AV11DESCRIPCIONMARCAPRODUCTO ;
      private string A44DESCRIPCIONMARCAPRODUCTO ;
      private string lV11DESCRIPCIONMARCAPRODUCTO ;
      ...
      private string[] H000J2_A44DESCRIPCIONMARCAPRODUCTO ;
      private long[] H000J2_A8IDMARCAPRODUCTO ;
   ...
   public class wwmarca_producto__default : DataStoreHelperBase, IDataStoreHelper
   {
      protected Object[] conditional_H000J2( IGxContext context ,
                                             string AV11DESCRIPCIONMARCAPRODUCTO ,
                                             string A44DESCRIPCIONMARCAPRODUCTO )
      {
         ...
         string sFromString;
         string sOrderString;
         sSelectString = " [DESCRIPCIONMARCAPRODUCTO], [IDMARCAPRODUCTO]";
         sFromString = " FROM [Marca_producto]";
         sOrderString = "";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11DESCRIPCIONMARCAPRODUCTO)) )
         {
            AddWhere(sWhereString, "([DESCRIPCIONMARCAPRODUCTO] like @lV11DESCRIPCIONMARCAPRODUCTO)");
         }
         else
         {
            GXv_int1[0] = 1;
         }
         sOrderString += " ORDER BY [DESCRIPCIONMARCAPRODUCTO]";
                                             ...
                                             string A44DESCRIPCIONMARCAPRODUCTO )
      {
         ...
         scmdbuf = "SELECT COUNT(*) FROM [Marca_producto]";
         if ( ! String.IsNullOrEmpty(StringUtil.RTrim( AV11DESCRIPCIONMARCAPRODUCTO)) )
         {
            AddWhere(sWhereString, "([DESCRIPCIONMARCAPRODUCTO] like @lV11DESCRIPCIONMARCAPRODUCTO)");
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@lV11DESCRIPCIONMARCAPRODUCTO",GXType.NVarChar,255,0) ,
