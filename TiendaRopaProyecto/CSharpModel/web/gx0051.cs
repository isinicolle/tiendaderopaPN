...
namespace GeneXus.Programs {
   public class gx0051 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public void execute( long aP0_pIDVENTA ,
                           out long aP1_pIDPRODUCTO )
      {
         this.AV7pIDVENTA = aP0_pIDVENTA;
         this.AV8pIDPRODUCTO = 0 ;
         executePrivate();
         aP1_pIDPRODUCTO=this.AV8pIDPRODUCTO;
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            gxfirstwebparm = GetFirstPar( "pIDVENTA");
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7pIDVENTA = (long)(NumberUtil.Val( GetPar( "pIDVENTA"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cIDPRODUCTO, AV7pIDVENTA) ;
            ...
            {
               AV7pIDVENTA = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV7pIDVENTA", StringUtil.LTrimStr( (decimal)(AV7pIDVENTA), 12, 0));
               if ( StringUtil.StrCmp(gxfirstwebparm, "viewer") != 0 )
               {
                  AV8pIDPRODUCTO = (long)(NumberUtil.Val( GetPar( "pIDPRODUCTO"), "."));
                  AssignAttri("", false, "AV8pIDPRODUCTO", StringUtil.LTrimStr( (decimal)(AV8pIDPRODUCTO), 12, 0));
               }
            }
            if ( toggleJsOutput )
            {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513336", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0051.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pIDVENTA,12,0)),UrlEncode(StringUtil.LTrimStr(AV8pIDPRODUCTO,12,0))}, new string[] {"pIDVENTA","pIDPRODUCTO"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPIDVENTA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pIDVENTA), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "vPIDPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV8pIDPRODUCTO), 12, 0, ".", "")));
      ...
      {
         return formatLink("gx0051.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pIDVENTA,12,0)),UrlEncode(StringUtil.LTrimStr(AV8pIDPRODUCTO,12,0))}, new string[] {"pIDVENTA","pIDPRODUCTO"})  ;
      }
      ...
      {
         return "Selection List Detalle_venta_producto" ;
      }
      ...
      protected void WB1T0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblidproductofilter_Internalname, "IDPRODUCTO", "", "", lblLblidproductofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e111t1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0051.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e121t1_client"+"'", TempTags, "", 2, "HLP_Gx0051.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            else
            {
               ...
               Grid1Container.AddColumnProperties(Grid1Column);
               Grid1Column = GXWebColumn.GetNew(isAjaxCallMode( ));
               Grid1Column.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A12IDVENTA), 12, 0, ".", "")));
               Grid1Container.AddColumnProperties(Grid1Column);
      ...
      protected void START1T2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "Selection List Detalle_venta_producto", 0) ;
         }
         context.wjLoc = "";
      ...
      protected void RF1T2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001T2 */
            pr_default.execute(0, new Object[] {AV7pIDVENTA, AV6cIDPRODUCTO, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A12IDVENTA = H001T2_A12IDVENTA[0];
               A7IDPRODUCTO = H001T2_A7IDPRODUCTO[0];
               /* Execute user event: Load */
               E141T2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, "gxhash_IDPRODUCTO"+"_"+sGXsfl_24_idx, GetSecureSignedToken( sGXsfl_24_idx, context.localUtil.Format( (decimal)(A7IDPRODUCTO), "ZZZZZZZZZZZ9"), context));
      }
      ...
      {
         /* Using cursor H001T3 */
         pr_default.execute(1, new Object[] {AV7pIDVENTA, AV6cIDPRODUCTO});
      ...
      protected void E131T2( )
      {
         /* Start Routine */
         returnInSub = false;
         Form.Caption = StringUtil.Format( "Selection List %1", "Detalle_venta_producto", "", "", "", "", "", "", "", "");
      ...
      protected void E151T2( )
      {
         /* Enter Routine */
         returnInSub = false;
         AV8pIDPRODUCTO = A7IDPRODUCTO;
         AssignAttri("", false, "AV8pIDPRODUCTO", StringUtil.LTrimStr( (decimal)(AV8pIDPRODUCTO), 12, 0));
         context.setWebReturnParms(new Object[] {(long)AV8pIDPRODUCTO});
         context.setWebReturnParmsMetadata(new Object[] {"AV8pIDPRODUCTO"});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pIDVENTA = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV7pIDVENTA", StringUtil.LTrimStr( (decimal)(AV7pIDVENTA), 12, 0));
         AV8pIDPRODUCTO = Convert.ToInt64(getParm(obj,1));
         AssignAttri("", false, "AV8pIDPRODUCTO", StringUtil.LTrimStr( (decimal)(AV8pIDPRODUCTO), 12, 0));
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513356", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0051.js", "?2021112620513356", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtIDPRODUCTO_Internalname = "IDPRODUCTO_"+sGXsfl_24_idx;
         edtIDVENTA_Internalname = "IDVENTA_"+sGXsfl_24_idx;
      }

      protected void SubsflControlProps_fel_242( )
      {
         edtavLinkselection_Internalname = "vLINKSELECTION_"+sGXsfl_24_fel_idx;
         edtIDPRODUCTO_Internalname = "IDPRODUCTO_"+sGXsfl_24_fel_idx;
         edtIDVENTA_Internalname = "IDVENTA_"+sGXsfl_24_fel_idx;
      }
      ...
      protected void sendrow_242( )
      {
         ...
         if ( ( 10 * 1 == 0 ) || ( nGXsfl_24_idx <= subGrid1_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            Grid1Row.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtIDVENTA_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A12IDVENTA), 12, 0, ".", "")),context.localUtil.Format( (decimal)(A12IDVENTA), "ZZZZZZZZZZZ9"),(string)"",(string)"'"+""+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtIDVENTA_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"",(string)"",(short)0,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)24,(short)1,(short)-1,(short)0,(bool)true,(string)"Codigo",(string)"right",(bool)false,(string)""});
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "Selection List Detalle_venta_producto";
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDVENTA',fld:'vPIDVENTA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E121T1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLIDPRODUCTOFILTER.CLICK","{handler:'E111T1',iparms:[{av:'divIdproductofiltercontainer_Class',ctrl:'IDPRODUCTOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E151T2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pIDPRODUCTO',fld:'vPIDPRODUCTO',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDVENTA',fld:'vPIDVENTA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDVENTA',fld:'vPIDVENTA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDVENTA',fld:'vPIDVENTA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDVENTA',fld:'vPIDVENTA',pic:'ZZZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H001T2_A12IDVENTA = new long[1] ;
         H001T2_A7IDPRODUCTO = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0051__default(),
            new Object[][] {
                new Object[] {
               H001T2_A12IDVENTA, H001T2_A7IDPRODUCTO
               }
               , new Object[] {
      ...
      private long AV7pIDVENTA ;
      private long AV8pIDPRODUCTO ;
      private long wcpOAV7pIDVENTA ;
      ...
      private long[] H001T2_A12IDVENTA ;
      private long[] H001T2_A7IDPRODUCTO ;
      private long[] H001T3_AGRID1_nRecordCount ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private long aP1_pIDPRODUCTO ;
   ...
   public class gx0051__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV7pIDVENTA",GXType.Decimal,12,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001T2", "SELECT [IDVENTA], [IDPRODUCTO] FROM [Ventas_inventarioDetalle_venta] WHERE [IDVENTA] = @AV7pIDVENTA and [IDPRODUCTO] >= @AV6cIDPRODUCTO ORDER BY [IDVENTA], [IDPRODUCTO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001T2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H001T3", "SELECT COUNT(*) FROM [Ventas_inventarioDetalle_venta] WHERE [IDVENTA] = @AV7pIDVENTA and [IDPRODUCTO] >= @AV6cIDPRODUCTO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001T3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
