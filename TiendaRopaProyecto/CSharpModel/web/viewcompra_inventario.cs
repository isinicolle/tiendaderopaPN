...
namespace GeneXus.Programs {
   public class viewcompra_inventario : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewcompra_inventario( )
      {
      ...
      public viewcompra_inventario( IGxContext context )
      {
      ...
      public void execute( long aP0_IDCOMPRA ,
                           string aP1_TabCode )
      {
         this.AV12IDCOMPRA = aP0_IDCOMPRA;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IDCOMPRA = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12IDCOMPRA", StringUtil.LTrimStr( (decimal)(AV12IDCOMPRA), 12, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDCOMPRA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDCOMPRA), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021112620513285", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcompra_inventario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDCOMPRA,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDCOMPRA","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewCompra_inventario");
         forbiddenHiddens.Add("FECHACOMPRA", context.localUtil.Format(A50FECHACOMPRA, "99/99/99"));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewcompra_inventario:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vIDCOMPRA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IDCOMPRA), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDCOMPRA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDCOMPRA), "ZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewcompra_inventario.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDCOMPRA,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDCOMPRA","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewCompra_inventario" ;
      }
      ...
      protected void WB0W0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Compra_inventario Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewCompra_inventario.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Compra_inventarios", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCompra_inventario.htm");
            ...
            GxWebStd.gx_single_line_edit( context, edtFECHACOMPRA_Internalname, context.localUtil.Format(A50FECHACOMPRA, "99/99/99"), context.localUtil.Format( A50FECHACOMPRA, "99/99/99"), "", "'"+""+"'"+",false,"+"'"+""+"'", "", "", "", "", edtFECHACOMPRA_Jsonclick, 0, "ReadonlyAttribute", "", "", "", "", 1, edtFECHACOMPRA_Enabled, 0, "text", "", 8, "chr", 1, "row", 8, 0, 0, 0, 1, -1, 0, true, "", "right", false, "", "HLP_ViewCompra_inventario.htm");
            GxWebStd.gx_bitmap( context, edtFECHACOMPRA_Internalname+"_dp_trigger", context.GetImagePath( "61b9b5d3-dff6-4d59-9b00-da61bc2cbe93", "", context.GetTheme( )), "", "", "", "", ((1==0)||(edtFECHACOMPRA_Enabled==0) ? 0 : 1), 0, "Date selector", "Date selector", 0, 1, 0, "", 0, "", 0, 0, 0, "", "", "cursor: pointer;", "", "", "", "", "", "", "", "", 1, false, false, "", "HLP_ViewCompra_inventario.htm");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCompra_inventario.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblDetalle_compra_producto_title_Internalname, "Detalle_compra_producto", "", "", lblDetalle_compra_producto_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCompra_inventario.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0W2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Compra_inventario", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewCompra_inventario";
         context.Gx_err = 0;
      }
      ...
      protected void STRUP0W0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IDCOMPRA = (long)(context.localUtil.CToN( cgiGet( "vIDCOMPRA"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewcompra_inventario:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110W2( )
      {
         ...
         while ( (pr_default.getStatus(1) != 101) )
         {
            ...
            lblViewall_Link = formatLink("wwcompra_inventario.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Compra_inventarioGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "compra_inventariogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Compra_inventarioGeneral";
               WebComp_Generalwc_Component = "Compra_inventarioGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(long)AV12IDCOMPRA});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Detalle_compra_producto") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Detalle_compra_productowc_Component), StringUtil.Lower( "Compra_inventarioDetalle_compra_productoWC")) != 0 )
            {
               WebComp_Detalle_compra_productowc = getWebComponent(GetType(), "GeneXus.Programs", "compra_inventariodetalle_compra_productowc", new Object[] {context} );
               WebComp_Detalle_compra_productowc.ComponentInit();
               WebComp_Detalle_compra_productowc.Name = "Compra_inventarioDetalle_compra_productoWC";
               WebComp_Detalle_compra_productowc_Component = "Compra_inventarioDetalle_compra_productoWC";
            }
            if ( StringUtil.Len( WebComp_Detalle_compra_productowc_Component) != 0 )
            {
               WebComp_Detalle_compra_productowc.setjustcreated();
               WebComp_Detalle_compra_productowc.componentprepare(new Object[] {(string)"W0038",(string)"",(long)AV12IDCOMPRA});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IDCOMPRA = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12IDCOMPRA", StringUtil.LTrimStr( (decimal)(AV12IDCOMPRA), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDCOMPRA", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDCOMPRA), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202111262051332", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcompra_inventario.js", "?202111262051332", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Compra_inventario";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12IDCOMPRA',fld:'vIDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A50FECHACOMPRA',fld:'FECHACOMPRA',pic:''}]");
      ...
      private int idxLst ;
      private long AV12IDCOMPRA ;
      private long wcpOAV12IDCOMPRA ;
   ...
   public class viewcompra_inventario__default : DataStoreHelperBase, IDataStoreHelper
   {
