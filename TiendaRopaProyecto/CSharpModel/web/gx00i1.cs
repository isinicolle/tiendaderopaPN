...
namespace GeneXus.Programs {
   public class gx00i1 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      {
         this.AV7pIDCOMPRA = aP0_pIDCOMPRA;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid1") == 0 )
            {
               ...
               AV7pIDCOMPRA = (long)(NumberUtil.Val( GetPar( "pIDCOMPRA"), "."));
               setAjaxCallMode();
               if ( ! IsValidAjaxCall( true) )
               {
                  GxWebError = 1;
               ...
               gxgrGrid1_refresh( subGrid1_Rows, AV6cIDPRODUCTO, AV7pIDCOMPRA) ;
            ...
            {
               AV7pIDCOMPRA = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV7pIDCOMPRA", StringUtil.LTrimStr( (decimal)(AV7pIDCOMPRA), 12, 0));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202111301231417", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx00i1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pIDCOMPRA,12,0)),UrlEncode(StringUtil.LTrimStr(AV8pIDPRODUCTO,12,0))}, new string[] {"pIDCOMPRA","pIDPRODUCTO"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vPIDCOMPRA", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7pIDCOMPRA), 12, 0, ".", "")));
      ...
      {
         return formatLink("gx00i1.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV7pIDCOMPRA,12,0)),UrlEncode(StringUtil.LTrimStr(AV8pIDPRODUCTO,12,0))}, new string[] {"pIDCOMPRA","pIDPRODUCTO"})  ;
      }
      ...
      protected void WB2C0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblidproductofilter_Internalname, "IDPRODUCTO", "", "", lblLblidproductofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e112c1_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx00I1.htm");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(24), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e122c1_client"+"'", TempTags, "", 2, "HLP_Gx00I1.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void RF2C2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002C2 */
            pr_default.execute(0, new Object[] {AV7pIDCOMPRA, AV6cIDPRODUCTO, GXPagingFrom2, GXPagingTo2});
            nGXsfl_24_idx = 1;
            sGXsfl_24_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_24_idx), 4, 0), 4, "0");
            SubsflControlProps_242( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( GRID1_nCurrentRecord < subGrid1_fnc_Recordsperpage( ) ) ) )
            {
               A11IDCOMPRA = H002C2_A11IDCOMPRA[0];
               A7IDPRODUCTO = H002C2_A7IDPRODUCTO[0];
               /* Execute user event: Load */
               E142C2 ();
      ...
      {
         /* Using cursor H002C3 */
         pr_default.execute(1, new Object[] {AV7pIDCOMPRA, AV6cIDPRODUCTO});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7pIDCOMPRA = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV7pIDCOMPRA", StringUtil.LTrimStr( (decimal)(AV7pIDCOMPRA), 12, 0));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?202111301231433", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx00i1.js", "?202111301231433", false, true);
      ...
      protected void SubsflControlProps_242( )
      {
         ...
         edtIDCOMPRA_Internalname = "IDCOMPRA_"+sGXsfl_24_idx;
      }
      ...
      protected void SubsflControlProps_fel_242( )
      {
         ...
         edtIDCOMPRA_Internalname = "IDCOMPRA_"+sGXsfl_24_fel_idx;
      }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDCOMPRA',fld:'vPIDCOMPRA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("'TOGGLE'","{handler:'E122C1',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLIDPRODUCTOFILTER.CLICK","{handler:'E112C1',iparms:[{av:'divIdproductofiltercontainer_Class',ctrl:'IDPRODUCTOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E152C2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("ENTER",",oparms:[{av:'AV8pIDPRODUCTO',fld:'vPIDPRODUCTO',pic:'ZZZZZZZZZZZ9'}]}");
         setEventMetadata("GRID1_FIRSTPAGE","{handler:'subgrid1_firstpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDCOMPRA',fld:'vPIDCOMPRA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID1_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_PREVPAGE","{handler:'subgrid1_previouspage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDCOMPRA',fld:'vPIDCOMPRA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID1_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID1_NEXTPAGE","{handler:'subgrid1_nextpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDCOMPRA',fld:'vPIDCOMPRA',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID1_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID1_LASTPAGE","{handler:'subgrid1_lastpage',iparms:[{av:'GRID1_nFirstRecordOnPage'},{av:'GRID1_nEOF'},{av:'subGrid1_Rows',ctrl:'GRID1',prop:'Rows'},{av:'AV6cIDPRODUCTO',fld:'vCIDPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV7pIDCOMPRA',fld:'vPIDCOMPRA',pic:'ZZZZZZZZZZZ9'}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H002C2_A11IDCOMPRA = new long[1] ;
         H002C2_A7IDPRODUCTO = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx00i1__default(),
            new Object[][] {
                new Object[] {
               H002C2_A11IDCOMPRA, H002C2_A7IDPRODUCTO
               }
               , new Object[] {
      ...
      private long AV7pIDCOMPRA ;
      private long AV8pIDPRODUCTO ;
      private long wcpOAV7pIDCOMPRA ;
      ...
      private long[] H002C2_A11IDCOMPRA ;
      private long[] H002C2_A7IDPRODUCTO ;
   ...
   public class gx00i1__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV7pIDCOMPRA",GXType.Decimal,12,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H002C2", "SELECT [IDCOMPRA], [IDPRODUCTO] FROM [Compra_inventarioDetalle_compr] WHERE [IDCOMPRA] = @AV7pIDCOMPRA and [IDPRODUCTO] >= @AV6cIDPRODUCTO ORDER BY [IDCOMPRA], [IDPRODUCTO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002C2,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H002C3", "SELECT COUNT(*) FROM [Compra_inventarioDetalle_compr] WHERE [IDCOMPRA] = @AV7pIDCOMPRA and [IDPRODUCTO] >= @AV6cIDPRODUCTO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002C3,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
