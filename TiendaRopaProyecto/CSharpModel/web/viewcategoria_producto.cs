...
namespace GeneXus.Programs {
   public class viewcategoria_producto : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      public viewcategoria_producto( )
      {
      ...
      public viewcategoria_producto( IGxContext context )
      {
      ...
      public void execute( long aP0_IDCATEGORIAPRODUCTO ,
                           string aP1_TabCode )
      {
         this.AV12IDCATEGORIAPRODUCTO = aP0_IDCATEGORIAPRODUCTO;
      ...
      protected void INITWEB( )
      {
         ...
         if ( nGotPars == 0 )
         {
            ...
            {
               AV12IDCATEGORIAPRODUCTO = (long)(NumberUtil.Val( gxfirstwebparm, "."));
               AssignAttri("", false, "AV12IDCATEGORIAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV12IDCATEGORIAPRODUCTO), 12, 0));
               GxWebStd.gx_hidden_field( context, "gxhash_vIDCATEGORIAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDCATEGORIAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?202111262051322", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("viewcategoria_producto.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDCATEGORIAPRODUCTO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDCATEGORIAPRODUCTO","TabCode"}) +"\">") ;
      ...
      protected void send_integrity_footer_hashes( )
      {
         ...
         forbiddenHiddens.Add("hshsalt", "hsh"+"ViewCategoria_producto");
         forbiddenHiddens.Add("DESCRIPCIONCATEGORIAPRODUCTO", StringUtil.RTrim( context.localUtil.Format( A39DESCRIPCIONCATEGORIAPRODUCTO, "")));
         GxWebStd.gx_hidden_field( context, "hsh", GetEncryptedHash( forbiddenHiddens.ToString(), GXKey));
         GXUtil.WriteLogInfo("viewcategoria_producto:[ SendSecurityCheck value for]"+forbiddenHiddens.ToJSonString());
      }
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, "vIDCATEGORIAPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV12IDCATEGORIAPRODUCTO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDCATEGORIAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDCATEGORIAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      {
         return formatLink("viewcategoria_producto.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV12IDCATEGORIAPRODUCTO,12,0)),UrlEncode(StringUtil.RTrim(AV6TabCode))}, new string[] {"IDCATEGORIAPRODUCTO","TabCode"})  ;
      }

      public override string GetPgmname( )
      {
         return "ViewCategoria_producto" ;
      }
      ...
      protected void WB0R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewtitle_Internalname, "Categoria_producto Information", "", "", lblViewtitle_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "SubTitle", 0, "", 1, 1, 0, 0, "HLP_ViewCategoria_producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12 col-sm-4 ViewActionsBackCell", "Right", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblViewall_Internalname, "Categoria_productoes", lblViewall_Link, "", lblViewall_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "BtnTextBlockBack", 0, "", lblViewall_Visible, 1, 0, 0, "HLP_ViewCategoria_producto.htm");
            ...
            ClassString = "ReadonlyAttribute";
            StyleString = "";
            GxWebStd.gx_html_textarea( context, edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname, A39DESCRIPCIONCATEGORIAPRODUCTO, "", "", 0, 1, edtDESCRIPCIONCATEGORIAPRODUCTO_Enabled, 0, 80, "chr", 4, "row", StyleString, ClassString, "", "", "255", -1, 0, "", "", -1, true, "Nombre", "'"+""+"'"+",false,"+"'"+""+"'", 0, "HLP_ViewCategoria_producto.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblGeneral_title_Internalname, "General", "", "", lblGeneral_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCategoria_producto.htm");
            /* Div Control */
            ...
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblInventario_title_Internalname, "Inventario", "", "", lblInventario_title_Jsonclick, "'"+""+"'"+",false,"+"'"+""+"'", "", "TextBlock", 0, "", 1, 1, 0, 0, "HLP_ViewCategoria_producto.htm");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "Section", "left", "top", "", "display:none;", "div");
      ...
      protected void START0R2( )
      {
         ...
         if ( ! context.isSpaRequest( ) )
         {
            ...
            Form.Meta.addItem("description", "View Categoria_producto", 0) ;
         }
         context.wjLoc = "";
      ...
      {
         /* GeneXus formulas. */
         AV15Pgmname = "ViewCategoria_producto";
         context.Gx_err = 0;
      }
      ...
      protected void RF0R2( )
      {
         ...
         {
            /* Using cursor H000R2 */
            pr_default.execute(0, new Object[] {AV12IDCATEGORIAPRODUCTO});
            while ( (pr_default.getStatus(0) != 101) )
            {
               A6IDCATEGORIAPRODUCTO = H000R2_A6IDCATEGORIAPRODUCTO[0];
               A39DESCRIPCIONCATEGORIAPRODUCTO = H000R2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
      ...
      protected void STRUP0R0( )
      {
         ...
         if ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 )
         {
            /* Read saved SDTs. */
            /* Read saved values. */
            AV12IDCATEGORIAPRODUCTO = (long)(context.localUtil.CToN( cgiGet( "vIDCATEGORIAPRODUCTO"), ".", ","));
            ...
            {
               GXUtil.WriteLogError("viewcategoria_producto:[ SecurityCheckFailed (403 Forbidden) value for]"+forbiddenHiddens.ToJSonString());
               GxWebError = 1;
      ...
      protected void E110R2( )
      {
         ...
         AV16GXLvl6 = 0;
         /* Using cursor H000R3 */
         pr_default.execute(1, new Object[] {AV12IDCATEGORIAPRODUCTO});
         while ( (pr_default.getStatus(1) != 101) )
         {
            A6IDCATEGORIAPRODUCTO = H000R3_A6IDCATEGORIAPRODUCTO[0];
            A39DESCRIPCIONCATEGORIAPRODUCTO = H000R3_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
            AssignAttri("", false, "A39DESCRIPCIONCATEGORIAPRODUCTO", A39DESCRIPCIONCATEGORIAPRODUCTO);
            AV16GXLvl6 = 1;
            Form.Caption = A39DESCRIPCIONCATEGORIAPRODUCTO;
            AssignProp("", false, "FORM", "Caption", Form.Caption, true);
            lblViewall_Link = formatLink("wwcategoria_producto.aspx") ;
      ...
      protected void S112( )
      {
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "") == 0 ) || ( StringUtil.StrCmp(AV7SelectedTabCode, "General") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Generalwc_Component), StringUtil.Lower( "Categoria_productoGeneral")) != 0 )
            {
               WebComp_Generalwc = getWebComponent(GetType(), "GeneXus.Programs", "categoria_productogeneral", new Object[] {context} );
               WebComp_Generalwc.ComponentInit();
               WebComp_Generalwc.Name = "Categoria_productoGeneral";
               WebComp_Generalwc_Component = "Categoria_productoGeneral";
            }
            if ( StringUtil.Len( WebComp_Generalwc_Component) != 0 )
            {
               WebComp_Generalwc.setjustcreated();
               WebComp_Generalwc.componentprepare(new Object[] {(string)"W0030",(string)"",(long)AV12IDCATEGORIAPRODUCTO});
         ...
         if ( AV11LoadAllTabs || ( StringUtil.StrCmp(AV7SelectedTabCode, "Inventario") == 0 ) )
         {
            ...
            if ( StringUtil.StrCmp(StringUtil.Lower( WebComp_Inventariowc_Component), StringUtil.Lower( "Categoria_productoInventarioWC")) != 0 )
            {
               WebComp_Inventariowc = getWebComponent(GetType(), "GeneXus.Programs", "categoria_productoinventariowc", new Object[] {context} );
               WebComp_Inventariowc.ComponentInit();
               WebComp_Inventariowc.Name = "Categoria_productoInventarioWC";
               WebComp_Inventariowc_Component = "Categoria_productoInventarioWC";
            }
            if ( StringUtil.Len( WebComp_Inventariowc_Component) != 0 )
            {
               WebComp_Inventariowc.setjustcreated();
               WebComp_Inventariowc.componentprepare(new Object[] {(string)"W0038",(string)"",(long)AV12IDCATEGORIAPRODUCTO});
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV12IDCATEGORIAPRODUCTO = Convert.ToInt64(getParm(obj,0));
         AssignAttri("", false, "AV12IDCATEGORIAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV12IDCATEGORIAPRODUCTO), 12, 0));
         GxWebStd.gx_hidden_field( context, "gxhash_vIDCATEGORIAPRODUCTO", GetSecureSignedToken( "", context.localUtil.Format( (decimal)(AV12IDCATEGORIAPRODUCTO), "ZZZZZZZZZZZ9"), context));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021112620513219", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("viewcategoria_producto.js", "?2021112620513219", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManager.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/json2005.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/rsh/rsh.js", "", false, true);
         context.AddJavascriptSource("Shared/HistoryManager/HistoryManagerCreate.js", "", false, true);
      ...
      public override void initialize_properties( )
      {
         ...
         Form.Caption = "View Categoria_producto";
         if ( context.isSpaRequest( ) )
         {
            enableJsOutput();
         }
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'AV12IDCATEGORIAPRODUCTO',fld:'vIDCATEGORIAPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'AV6TabCode',fld:'vTABCODE',pic:'',hsh:true},{av:'A39DESCRIPCIONCATEGORIAPRODUCTO',fld:'DESCRIPCIONCATEGORIAPRODUCTO',pic:''}]");
      ...
      public override void initialize( )
      {
         ...
         AV15Pgmname = "";
         scmdbuf = "";
         H000R2_A6IDCATEGORIAPRODUCTO = new long[1] ;
         H000R2_A39DESCRIPCIONCATEGORIAPRODUCTO = new string[] {""} ;
         hsh = "";
         H000R3_A6IDCATEGORIAPRODUCTO = new long[1] ;
         H000R3_A39DESCRIPCIONCATEGORIAPRODUCTO = new string[] {""} ;
         BackMsgLst = new msglist();
         LclMsgLst = new msglist();
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.viewcategoria_producto__default(),
            new Object[][] {
                new Object[] {
               H000R2_A6IDCATEGORIAPRODUCTO, H000R2_A39DESCRIPCIONCATEGORIAPRODUCTO
               }
               , new Object[] {
               H000R3_A6IDCATEGORIAPRODUCTO, H000R3_A39DESCRIPCIONCATEGORIAPRODUCTO
               }
            }
         );
      ...
      private int idxLst ;
      private long AV12IDCATEGORIAPRODUCTO ;
      private long wcpOAV12IDCATEGORIAPRODUCTO ;
      ...
      private long[] H000R2_A6IDCATEGORIAPRODUCTO ;
      private string[] H000R2_A39DESCRIPCIONCATEGORIAPRODUCTO ;
      private long[] H000R3_A6IDCATEGORIAPRODUCTO ;
      private string[] H000R3_A39DESCRIPCIONCATEGORIAPRODUCTO ;
      private msglist BackMsgLst ;
      private msglist LclMsgLst ;
      private GXWebForm Form ;
   }

   public class viewcategoria_producto__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV12IDCATEGORIAPRODUCTO",GXType.Decimal,12,0)
          };
          Object[] prmH000R3;
          ...
          def= new CursorDef[] {
              new CursorDef("H000R2", "SELECT [IDCATEGORIAPRODUCTO], [DESCRIPCIONCATEGORIAPRODUCTO] FROM [Categoria_producto] WHERE [IDCATEGORIAPRODUCTO] = @AV12IDCATEGORIAPRODUCTO ORDER BY [IDCATEGORIAPRODUCTO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R2,1, GxCacheFrequency.OFF ,true,true )
             ,new CursorDef("H000R3", "SELECT [IDCATEGORIAPRODUCTO], [DESCRIPCIONCATEGORIAPRODUCTO] FROM [Categoria_producto] WHERE [IDCATEGORIAPRODUCTO] = @AV12IDCATEGORIAPRODUCTO ORDER BY [IDCATEGORIAPRODUCTO] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000R3,1, GxCacheFrequency.OFF ,false,true )
          };
       }
    }
