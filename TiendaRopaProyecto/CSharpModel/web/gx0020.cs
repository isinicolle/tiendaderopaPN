...
namespace GeneXus.Programs {
   public class gx0020 : GXDataArea, System.Web.SessionState.IRequiresSessionState
   {
      ...
      public override void RenderHtmlOpenForm( )
      {
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113010481940", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         context.skipLines(1);
         context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("gx0020.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10pIDCOMPRA,12,0))}, new string[] {"pIDCOMPRA"}) +"\">") ;
      ...
      {
         return formatLink("gx0020.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV10pIDCOMPRA,12,0))}, new string[] {"pIDCOMPRA"})  ;
      }
      ...
      protected void WB240( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblidcomprafilter_Internalname, "IDCOMPRA", "", "", lblLblidcomprafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e11241_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblfechacomprafilter_Internalname, "FECHACOMPRA", "", "", lblLblfechacomprafilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e12241_client"+"'", "", "WWAdvancedLabel WWDateFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblidproveedorfilter_Internalname, "IDPROVEEDOR", "", "", lblLblidproveedorfilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e13241_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "col-xs-12", "left", "top", "", "", "div");
            /* Text block */
            GxWebStd.gx_label_ctrl( context, lblLblidempleadofilter_Internalname, "IDEMPLEADO", "", "", lblLblidempleadofilter_Jsonclick, "'"+""+"'"+",false,"+"'"+"e14241_client"+"'", "", "WWAdvancedLabel WWFilterLabel", 7, "", 1, 1, 0, 1, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
            ...
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtntoggle_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(54), 2, 0)+","+"null"+");", "|||", bttBtntoggle_Jsonclick, 7, "|||", "", StyleString, ClassString, 1, 1, "standard", "'"+""+"'"+",false,"+"'"+"e15241_client"+"'", TempTags, "", 2, "HLP_Gx0020.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            /* Div Control */
            GxWebStd.gx_div_start( context, "", 1, 0, "px", 0, "px", "row", "left", "top", "", "", "div");
      ...
      protected void RF242( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1IDEMPLEADO = H00242_A1IDEMPLEADO[0];
               A10IDPROVEEDOR = H00242_A10IDPROVEEDOR[0];
               A50FECHACOMPRA = H00242_A50FECHACOMPRA[0];
               A11IDCOMPRA = H00242_A11IDCOMPRA[0];
               /* Execute user event: Load */
               E17242 ();
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113010481969", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         ...
         context.AddJavascriptSource("gx0020.js", "?2021113010481969", false, true);
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("'TOGGLE'","{handler:'E15241',iparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]");
         setEventMetadata("'TOGGLE'",",oparms:[{av:'divAdvancedcontainer_Class',ctrl:'ADVANCEDCONTAINER',prop:'Class'},{ctrl:'BTNTOGGLE',prop:'Class'}]}");
         setEventMetadata("LBLIDCOMPRAFILTER.CLICK","{handler:'E11241',iparms:[{av:'divIdcomprafiltercontainer_Class',ctrl:'IDCOMPRAFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLFECHACOMPRAFILTER.CLICK","{handler:'E12241',iparms:[{av:'divFechacomprafiltercontainer_Class',ctrl:'FECHACOMPRAFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLIDPROVEEDORFILTER.CLICK","{handler:'E13241',iparms:[{av:'divIdproveedorfiltercontainer_Class',ctrl:'IDPROVEEDORFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("LBLIDEMPLEADOFILTER.CLICK","{handler:'E14241',iparms:[{av:'divIdempleadofiltercontainer_Class',ctrl:'IDEMPLEADOFILTERCONTAINER',prop:'Class'}]");
         ...
         setEventMetadata("ENTER","{handler:'E18242',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         scmdbuf = "";
         H00242_A1IDEMPLEADO = new long[1] ;
         H00242_A10IDPROVEEDOR = new long[1] ;
         H00242_A50FECHACOMPRA = new DateTime[] {DateTime.MinValue} ;
         H00242_A11IDCOMPRA = new long[1] ;
         ...
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.gx0020__default(),
            new Object[][] {
                new Object[] {
               H00242_A1IDEMPLEADO, H00242_A10IDPROVEEDOR, H00242_A50FECHACOMPRA, H00242_A11IDCOMPRA
               }
               , new Object[] {
      ...
      private long[] H00242_A1IDEMPLEADO ;
      private long[] H00242_A10IDPROVEEDOR ;
      private DateTime[] H00242_A50FECHACOMPRA ;
      private long[] H00242_A11IDCOMPRA ;
   ...
   public class gx0020__default : DataStoreHelperBase, IDataStoreHelper
   {
                                                     ...
                                                     Object [] dynConstraints )
      {
         ...
         {
               case 0 :
                     return conditional_H00242(context, (DateTime)dynConstraints[0] , (long)dynConstraints[1] , (long)dynConstraints[2] , (DateTime)dynConstraints[3] , (long)dynConstraints[4] , (long)dynConstraints[5] , (long)dynConstraints[6] );
               case 1 :
                     return conditional_H00243(context, (DateTime)dynConstraints[0] , (long)dynConstraints[1] , (long)dynConstraints[2] , (DateTime)dynConstraints[3] , (long)dynConstraints[4] , (long)dynConstraints[5] , (long)dynConstraints[6] );
         }
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("H00242", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00242,11, GxCacheFrequency.OFF ,false,false )
             ,new CursorDef("H00243", "scmdbuf",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH00243,1, GxCacheFrequency.OFF ,false,false )
          };
       }
    }
