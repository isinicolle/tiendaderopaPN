...
namespace GeneXus.Programs {
   public class empleadosventas_inventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empleadosventas_inventariowc( )
      {
      ...
      public empleadosventas_inventariowc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "EmpleadosVentas_inventarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empleados Ventas_inventario WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113013582596", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empleadosventas_inventariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDEMPLEADO,12,0))}, new string[] {"IDEMPLEADO"}) +"\">") ;
      ...
      {
         return "EmpleadosVentas_inventarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Empleados Ventas_inventario WC" ;
      }
      ...
      protected void WB320( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empleadosventas_inventariowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpleadosVentas_inventarioWC.htm");
      ...
      protected void START322( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empleados Ventas_inventario WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF322( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A1IDEMPLEADO = H003214_A1IDEMPLEADO[0];
               AssignAttri(sPrefix, false, "A1IDEMPLEADO", StringUtil.LTrimStr( (decimal)(A1IDEMPLEADO), 12, 0));
               A58DESCUENTOVENTA = H003214_A58DESCUENTOVENTA[0];
               A30NOMBRECOMPLETOCLIENTE = H003214_A30NOMBRECOMPLETOCLIENTE[0];
               A4IDCLIENTE = H003214_A4IDCLIENTE[0];
               A55DESCRIPCIONVENTA = H003214_A55DESCRIPCIONVENTA[0];
               A54FECHAVENTA = H003214_A54FECHAVENTA[0];
               A12IDVENTA = H003214_A12IDVENTA[0];
               A59TOTALVENTA = H003214_A59TOTALVENTA[0];
               n59TOTALVENTA = H003214_n59TOTALVENTA[0];
               A57IMPUESTOVENTA = H003214_A57IMPUESTOVENTA[0];
               n57IMPUESTOVENTA = H003214_n57IMPUESTOVENTA[0];
               A30NOMBRECOMPLETOCLIENTE = H003214_A30NOMBRECOMPLETOCLIENTE[0];
               A59TOTALVENTA = H003214_A59TOTALVENTA[0];
               n59TOTALVENTA = H003214_n59TOTALVENTA[0];
               A57IMPUESTOVENTA = H003214_A57IMPUESTOVENTA[0];
      ...
      {
         /* Using cursor H003227 */
         pr_default.execute(1, new Object[] {AV6IDEMPLEADO});
         GRID_nRecordCount = H003227_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empleadosventas_inventariowc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113013582649", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empleadosventas_inventariowc.js", "?2021113013582649", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E13322',iparms:[{av:'A12IDVENTA',fld:'IDVENTA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A4IDCLIENTE',fld:'IDCLIENTE',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtFECHAVENTA_Link',ctrl:'FECHAVENTA',prop:'Link'},{av:'edtNOMBRECOMPLETOCLIENTE_Link',ctrl:'NOMBRECOMPLETOCLIENTE',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E11322',iparms:[{av:'A12IDVENTA',fld:'IDVENTA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H003214_A1IDEMPLEADO = new long[1] ;
         H003214_A58DESCUENTOVENTA = new decimal[1] ;
         H003214_A30NOMBRECOMPLETOCLIENTE = new string[] {""} ;
         H003214_A4IDCLIENTE = new long[1] ;
         H003214_A55DESCRIPCIONVENTA = new string[] {""} ;
         H003214_A54FECHAVENTA = new DateTime[] {DateTime.MinValue} ;
         H003214_A12IDVENTA = new long[1] ;
         H003214_A59TOTALVENTA = new decimal[1] ;
         H003214_n59TOTALVENTA = new bool[] {false} ;
         H003214_A57IMPUESTOVENTA = new decimal[1] ;
         H003214_n57IMPUESTOVENTA = new bool[] {false} ;
         H003227_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6IDEMPLEADO = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empleadosventas_inventariowc__default(),
            new Object[][] {
                new Object[] {
               H003214_A1IDEMPLEADO, H003214_A58DESCUENTOVENTA, H003214_A30NOMBRECOMPLETOCLIENTE, H003214_A4IDCLIENTE, H003214_A55DESCRIPCIONVENTA, H003214_A54FECHAVENTA, H003214_A12IDVENTA, H003214_A59TOTALVENTA, H003214_n59TOTALVENTA, H003214_A57IMPUESTOVENTA,
               H003214_n57IMPUESTOVENTA
               }
               , new Object[] {
               H003227_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "EmpleadosVentas_inventarioWC";
      ...
      private long[] H003214_A1IDEMPLEADO ;
      private decimal[] H003214_A58DESCUENTOVENTA ;
      private string[] H003214_A30NOMBRECOMPLETOCLIENTE ;
      private long[] H003214_A4IDCLIENTE ;
      private string[] H003214_A55DESCRIPCIONVENTA ;
      private DateTime[] H003214_A54FECHAVENTA ;
      private long[] H003214_A12IDVENTA ;
      private decimal[] H003214_A59TOTALVENTA ;
      private bool[] H003214_n59TOTALVENTA ;
      private decimal[] H003214_A57IMPUESTOVENTA ;
      private bool[] H003214_n57IMPUESTOVENTA ;
      private long[] H003227_AGRID_nRecordCount ;
   ...
   public class empleadosventas_inventariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       ...
       {
          Object[] prmH003214;
          prmH003214 = new Object[] {
          new ParDef("@AV6IDEMPLEADO",GXType.Decimal,12,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          string cmdBufferH003214;
          cmdBufferH003214=" SELECT T1.[IDEMPLEADO], T1.[DESCUENTOVENTA], T2.[NOMBRECOMPLETOCLIENTE], T1.[IDCLIENTE], T1.[DESCRIPCIONVENTA], T1.[FECHAVENTA], T1.[IDVENTA], COALESCE( T3.[TOTALVENTA], 0) AS TOTALVENTA, COALESCE( T4.[IMPUESTOVENTA], 0) AS IMPUESTOVENTA FROM ((([Ventas_inventario] T1 INNER JOIN [Clientes] T2 ON T2.[IDCLIENTE] = T1.[IDCLIENTE]) INNER JOIN (SELECT COALESCE( T7.[GXC3], 0) + COALESCE( T6.[IMPUESTOVENTA], 0) - T5.[DESCUENTOVENTA] AS TOTALVENTA, T5.[IDVENTA] FROM (([Ventas_inventario] T5 LEFT JOIN (SELECT COALESCE( T9.[GXC3], 0) * CAST(0.15 AS decimal( 22, 10)) AS IMPUESTOVENTA, T8.[IDVENTA] FROM ([Ventas_inventario] T8 LEFT JOIN (SELECT SUM(COALESCE( T11.[SUBTOTALVENTAPRODUCTO], 0)) AS GXC3, T10.[IDVENTA] FROM ([Ventas_inventarioDetalle_venta] T10 LEFT JOIN (SELECT COALESCE( T13.[GXC5], 0) AS SUBTOTALVENTAPRODUCTO, T12.[IDVENTA], T12.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T12 LEFT JOIN (SELECT SUM(T15.[CANTIDADPRODUCTO] * CAST(T15.[PRECIOVENTAPRODUCTO] AS decimal( 22, 10))) AS GXC5, T14.[IDVENTA], T14.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T14 INNER JOIN [Inventario] T15 ON T15.[IDPRODUCTO] = T14.[IDPRODUCTO]) GROUP BY T14.[IDVENTA], T14.[IDDETALLEVENTAPRODUCTO] ) T13 ON T13.[IDVENTA] = T12.[IDVENTA] AND T13.[IDDETALLEVENTAPRODUCTO] = T12.[IDDETALLEVENTAPRODUCTO]) ) T11 ON T11.[IDVENTA] = T10.[IDVENTA] AND T11.[IDDETALLEVENTAPRODUCTO] = T10.[IDDETALLEVENTAPRODUCTO]) GROUP BY T10.[IDVENTA] ) T9 ON T9.[IDVENTA] = T8.[IDVENTA]) ) T6 ON T6.[IDVENTA] = T5.[IDVENTA]) LEFT JOIN (SELECT SUM(COALESCE( T9.[SUBTOTALVENTAPRODUCTO], 0)) AS GXC3, T8.[IDVENTA] FROM ([Ventas_inventarioDetalle_venta] T8 LEFT JOIN (SELECT COALESCE( T11.[GXC5], 0) AS SUBTOTALVENTAPRODUCTO, T10.[IDVENTA], T10.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] "
          + " T10 LEFT JOIN (SELECT SUM(T13.[CANTIDADPRODUCTO] * CAST(T13.[PRECIOVENTAPRODUCTO] AS decimal( 22, 10))) AS GXC5, T12.[IDVENTA], T12.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T12 INNER JOIN [Inventario] T13 ON T13.[IDPRODUCTO] = T12.[IDPRODUCTO]) GROUP BY T12.[IDVENTA], T12.[IDDETALLEVENTAPRODUCTO] ) T11 ON T11.[IDVENTA] = T10.[IDVENTA] AND T11.[IDDETALLEVENTAPRODUCTO] = T10.[IDDETALLEVENTAPRODUCTO]) ) T9 ON T9.[IDVENTA] = T8.[IDVENTA] AND T9.[IDDETALLEVENTAPRODUCTO] = T8.[IDDETALLEVENTAPRODUCTO]) GROUP BY T8.[IDVENTA] ) T7 ON T7.[IDVENTA] = T5.[IDVENTA]) ) T3 ON T3.[IDVENTA] = T1.[IDVENTA]) LEFT JOIN (SELECT COALESCE( T6.[GXC3], 0) * CAST(0.15 AS decimal( 22, 10)) AS IMPUESTOVENTA, T5.[IDVENTA] FROM ([Ventas_inventario] T5 LEFT JOIN (SELECT SUM(COALESCE( T8.[SUBTOTALVENTAPRODUCTO], 0)) AS GXC3, T7.[IDVENTA] FROM ([Ventas_inventarioDetalle_venta] T7 LEFT JOIN (SELECT COALESCE( T10.[GXC5], 0) AS SUBTOTALVENTAPRODUCTO, T9.[IDVENTA], T9.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T9 LEFT JOIN (SELECT SUM(T12.[CANTIDADPRODUCTO] * CAST(T12.[PRECIOVENTAPRODUCTO] AS decimal( 22, 10))) AS GXC5, T11.[IDVENTA], T11.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T11 INNER JOIN [Inventario] T12 ON T12.[IDPRODUCTO] = T11.[IDPRODUCTO]) GROUP BY T11.[IDVENTA], T11.[IDDETALLEVENTAPRODUCTO] ) T10 ON T10.[IDVENTA] = T9.[IDVENTA] AND T10.[IDDETALLEVENTAPRODUCTO] = T9.[IDDETALLEVENTAPRODUCTO]) ) T8 ON T8.[IDVENTA] = T7.[IDVENTA] AND T8.[IDDETALLEVENTAPRODUCTO] = T7.[IDDETALLEVENTAPRODUCTO]) GROUP BY T7.[IDVENTA] ) T6 ON T6.[IDVENTA] = T5.[IDVENTA]) ) T4 ON T4.[IDVENTA] = T1.[IDVENTA]) WHERE T1.[IDEMPLEADO] = @AV6IDEMPLEADO ORDER BY T1.[IDEMPLEADO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2"
          + " ELSE 1e9 END) AS INTEGER) ROWS ONLY" ;
          Object[] prmH003227;
          prmH003227 = new Object[] {
          new ParDef("@AV6IDEMPLEADO",GXType.Decimal,12,0)
          };
          string cmdBufferH003227;
          cmdBufferH003227=" SELECT COUNT(*) FROM ((([Ventas_inventario] T1 INNER JOIN [Clientes] T2 ON T2.[IDCLIENTE] = T1.[IDCLIENTE]) INNER JOIN (SELECT COALESCE( T7.[GXC3], 0) + COALESCE( T6.[IMPUESTOVENTA], 0) - T5.[DESCUENTOVENTA] AS TOTALVENTA, T5.[IDVENTA] FROM (([Ventas_inventario] T5 LEFT JOIN (SELECT COALESCE( T9.[GXC3], 0) * CAST(0.15 AS decimal( 22, 10)) AS IMPUESTOVENTA, T8.[IDVENTA] FROM ([Ventas_inventario] T8 LEFT JOIN (SELECT SUM(COALESCE( T11.[SUBTOTALVENTAPRODUCTO], 0)) AS GXC3, T10.[IDVENTA] FROM ([Ventas_inventarioDetalle_venta] T10 LEFT JOIN (SELECT COALESCE( T13.[GXC5], 0) AS SUBTOTALVENTAPRODUCTO, T12.[IDVENTA], T12.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T12 LEFT JOIN (SELECT SUM(T15.[CANTIDADPRODUCTO] * CAST(T15.[PRECIOVENTAPRODUCTO] AS decimal( 22, 10))) AS GXC5, T14.[IDVENTA], T14.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T14 INNER JOIN [Inventario] T15 ON T15.[IDPRODUCTO] = T14.[IDPRODUCTO]) GROUP BY T14.[IDVENTA], T14.[IDDETALLEVENTAPRODUCTO] ) T13 ON T13.[IDVENTA] = T12.[IDVENTA] AND T13.[IDDETALLEVENTAPRODUCTO] = T12.[IDDETALLEVENTAPRODUCTO]) ) T11 ON T11.[IDVENTA] = T10.[IDVENTA] AND T11.[IDDETALLEVENTAPRODUCTO] = T10.[IDDETALLEVENTAPRODUCTO]) GROUP BY T10.[IDVENTA] ) T9 ON T9.[IDVENTA] = T8.[IDVENTA]) ) T6 ON T6.[IDVENTA] = T5.[IDVENTA]) LEFT JOIN (SELECT SUM(COALESCE( T9.[SUBTOTALVENTAPRODUCTO], 0)) AS GXC3, T8.[IDVENTA] FROM ([Ventas_inventarioDetalle_venta] T8 LEFT JOIN (SELECT COALESCE( T11.[GXC5], 0) AS SUBTOTALVENTAPRODUCTO, T10.[IDVENTA], T10.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T10 LEFT JOIN (SELECT SUM(T13.[CANTIDADPRODUCTO] * CAST(T13.[PRECIOVENTAPRODUCTO] AS decimal( 22, 10))) AS GXC5, T12.[IDVENTA], T12.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T12 INNER JOIN "
          + " [Inventario] T13 ON T13.[IDPRODUCTO] = T12.[IDPRODUCTO]) GROUP BY T12.[IDVENTA], T12.[IDDETALLEVENTAPRODUCTO] ) T11 ON T11.[IDVENTA] = T10.[IDVENTA] AND T11.[IDDETALLEVENTAPRODUCTO] = T10.[IDDETALLEVENTAPRODUCTO]) ) T9 ON T9.[IDVENTA] = T8.[IDVENTA] AND T9.[IDDETALLEVENTAPRODUCTO] = T8.[IDDETALLEVENTAPRODUCTO]) GROUP BY T8.[IDVENTA] ) T7 ON T7.[IDVENTA] = T5.[IDVENTA]) ) T3 ON T3.[IDVENTA] = T1.[IDVENTA]) LEFT JOIN (SELECT COALESCE( T6.[GXC3], 0) * CAST(0.15 AS decimal( 22, 10)) AS IMPUESTOVENTA, T5.[IDVENTA] FROM ([Ventas_inventario] T5 LEFT JOIN (SELECT SUM(COALESCE( T8.[SUBTOTALVENTAPRODUCTO], 0)) AS GXC3, T7.[IDVENTA] FROM ([Ventas_inventarioDetalle_venta] T7 LEFT JOIN (SELECT COALESCE( T10.[GXC5], 0) AS SUBTOTALVENTAPRODUCTO, T9.[IDVENTA], T9.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T9 LEFT JOIN (SELECT SUM(T12.[CANTIDADPRODUCTO] * CAST(T12.[PRECIOVENTAPRODUCTO] AS decimal( 22, 10))) AS GXC5, T11.[IDVENTA], T11.[IDDETALLEVENTAPRODUCTO] FROM ([Ventas_inventarioDetalle_venta] T11 INNER JOIN [Inventario] T12 ON T12.[IDPRODUCTO] = T11.[IDPRODUCTO]) GROUP BY T11.[IDVENTA], T11.[IDDETALLEVENTAPRODUCTO] ) T10 ON T10.[IDVENTA] = T9.[IDVENTA] AND T10.[IDDETALLEVENTAPRODUCTO] = T9.[IDDETALLEVENTAPRODUCTO]) ) T8 ON T8.[IDVENTA] = T7.[IDVENTA] AND T8.[IDDETALLEVENTAPRODUCTO] = T7.[IDDETALLEVENTAPRODUCTO]) GROUP BY T7.[IDVENTA] ) T6 ON T6.[IDVENTA] = T5.[IDVENTA]) ) T4 ON T4.[IDVENTA] = T1.[IDVENTA]) WHERE T1.[IDEMPLEADO] = @AV6IDEMPLEADO" ;
          def= new CursorDef[] {
              new CursorDef("H003214", cmdBufferH003214,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003214,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H003227", cmdBufferH003227,false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH003227,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
