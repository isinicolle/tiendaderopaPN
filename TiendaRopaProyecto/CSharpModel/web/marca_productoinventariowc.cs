...
namespace GeneXus.Programs {
   public class marca_productoinventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public marca_productoinventariowc( )
      {
      ...
      public marca_productoinventariowc( IGxContext context )
      {
      ...
      public void execute( long aP0_IDMARCAPRODUCTO )
      {
         this.AV6IDMARCAPRODUCTO = aP0_IDMARCAPRODUCTO;
         executePrivate();
      }
      ...
      protected void INITWEB( )
      {
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               gxfirstwebparm = GetFirstPar( "IDMARCAPRODUCTO");
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IDMARCAPRODUCTO = (long)(NumberUtil.Val( GetPar( "IDMARCAPRODUCTO"), "."));
                  AssignAttri(sPrefix, false, "AV6IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDMARCAPRODUCTO), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6IDMARCAPRODUCTO});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6IDMARCAPRODUCTO, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "Marca_productoInventarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Marca_producto Inventario WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113012305591", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("marca_productoinventariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDMARCAPRODUCTO,12,0))}, new string[] {"IDMARCAPRODUCTO"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6IDMARCAPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6IDMARCAPRODUCTO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vIDMARCAPRODUCTO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDMARCAPRODUCTO), 12, 0, ".", "")));
      ...
      {
         return "Marca_productoInventarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Marca_producto Inventario WC" ;
      }
      ...
      protected void WB1F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "marca_productoinventariowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_Marca_productoInventarioWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtIDMARCAPRODUCTO_Internalname, "IDMARCAPRODUCTO", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtIDMARCAPRODUCTO_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A8IDMARCAPRODUCTO), 12, 0, ".", "")), ((edtIDMARCAPRODUCTO_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A8IDMARCAPRODUCTO), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A8IDMARCAPRODUCTO), "ZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtIDMARCAPRODUCTO_Jsonclick, 0, "Attribute", "", "", "", "", edtIDMARCAPRODUCTO_Visible, edtIDMARCAPRODUCTO_Enabled, 0, "number", "1", 12, "chr", 1, "row", 12, 0, 0, 0, 1, -1, 0, true, "Codigo", "right", false, "", "HLP_Marca_productoInventarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START1F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Marca_producto Inventario WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF1F2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H001F2 */
            pr_default.execute(0, new Object[] {AV6IDMARCAPRODUCTO, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A8IDMARCAPRODUCTO = H001F2_A8IDMARCAPRODUCTO[0];
               AssignAttri(sPrefix, false, "A8IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(A8IDMARCAPRODUCTO), 12, 0));
               A39DESCRIPCIONCATEGORIAPRODUCTO = H001F2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
               A6IDCATEGORIAPRODUCTO = H001F2_A6IDCATEGORIAPRODUCTO[0];
               A38DESCRIPCIONESTADOPRODUCTO = H001F2_A38DESCRIPCIONESTADOPRODUCTO[0];
               A5IDESTADOPRODUCTO = H001F2_A5IDESTADOPRODUCTO[0];
               A43PRECIOVENTAPRODUCTO = H001F2_A43PRECIOVENTAPRODUCTO[0];
               A42PRECIOCOMPRAPRODUCTO = H001F2_A42PRECIOCOMPRAPRODUCTO[0];
               A41CANTIDADPRODUCTO = H001F2_A41CANTIDADPRODUCTO[0];
               A40DESCRIPCIONPRODUCTO = H001F2_A40DESCRIPCIONPRODUCTO[0];
               A7IDPRODUCTO = H001F2_A7IDPRODUCTO[0];
               A39DESCRIPCIONCATEGORIAPRODUCTO = H001F2_A39DESCRIPCIONCATEGORIAPRODUCTO[0];
               A38DESCRIPCIONESTADOPRODUCTO = H001F2_A38DESCRIPCIONESTADOPRODUCTO[0];
               E131F2 ();
      ...
      {
         /* Using cursor H001F3 */
         pr_default.execute(1, new Object[] {AV6IDMARCAPRODUCTO});
      ...
      protected void STRUP1F0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IDMARCAPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDMARCAPRODUCTO"), ".", ","));
      ...
      protected void E121F2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtIDMARCAPRODUCTO_Visible = 0;
         AssignProp(sPrefix, false, edtIDMARCAPRODUCTO_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIDMARCAPRODUCTO_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "IDMARCAPRODUCTO";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IDMARCAPRODUCTO), 12, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6IDMARCAPRODUCTO = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDMARCAPRODUCTO), 12, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6IDMARCAPRODUCTO = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "marca_productoinventariowc", GetJustCreated( ));
         ...
         {
            AV6IDMARCAPRODUCTO = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDMARCAPRODUCTO), 12, 0));
         }
         wcpOAV6IDMARCAPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDMARCAPRODUCTO"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6IDMARCAPRODUCTO != wcpOAV6IDMARCAPRODUCTO ) ) )
         {
            setjustcreated();
         }
         wcpOAV6IDMARCAPRODUCTO = AV6IDMARCAPRODUCTO;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6IDMARCAPRODUCTO = cgiGet( sPrefix+"AV6IDMARCAPRODUCTO_CTRL");
         if ( StringUtil.Len( sCtrlAV6IDMARCAPRODUCTO) > 0 )
         {
            AV6IDMARCAPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6IDMARCAPRODUCTO), ".", ","));
            AssignAttri(sPrefix, false, "AV6IDMARCAPRODUCTO", StringUtil.LTrimStr( (decimal)(AV6IDMARCAPRODUCTO), 12, 0));
         }
         else
         {
            AV6IDMARCAPRODUCTO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6IDMARCAPRODUCTO_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDMARCAPRODUCTO_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDMARCAPRODUCTO), 12, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6IDMARCAPRODUCTO)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDMARCAPRODUCTO_CTRL", StringUtil.RTrim( sCtrlAV6IDMARCAPRODUCTO));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113012305637", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("marca_productoinventariowc.js", "?2021113012305637", false, true);
         }
      ...
      protected void SubsflControlProps_202( )
      {
         ...
         edtIDCATEGORIAPRODUCTO_Internalname = sPrefix+"IDCATEGORIAPRODUCTO_"+sGXsfl_20_idx;
         edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname = sPrefix+"DESCRIPCIONCATEGORIAPRODUCTO_"+sGXsfl_20_idx;
      ...
      protected void SubsflControlProps_fel_202( )
      {
         ...
         edtIDCATEGORIAPRODUCTO_Internalname = sPrefix+"IDCATEGORIAPRODUCTO_"+sGXsfl_20_fel_idx;
         edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname = sPrefix+"DESCRIPCIONCATEGORIAPRODUCTO_"+sGXsfl_20_fel_idx;
      ...
      protected void sendrow_202( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_20_idx <= subGrid_fnc_Recordsperpage( ) * 1 ) )
         {
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtIDCATEGORIAPRODUCTO_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A6IDCATEGORIAPRODUCTO), 12, 0, ".", "")),context.localUtil.Format( (decimal)(A6IDCATEGORIAPRODUCTO), "ZZZZZZZZZZZ9"),(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)"",(string)"",(string)"",(string)"",(string)edtIDCATEGORIAPRODUCTO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"number",(string)"1",(short)0,(string)"px",(short)17,(string)"px",(short)12,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)0,(bool)true,(string)"Codigo",(string)"right",(bool)false,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
            ...
            /* Single line edit */
            ROClassString = "Attribute";
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(string)edtDESCRIPCIONCATEGORIAPRODUCTO_Internalname,(string)A39DESCRIPCIONCATEGORIAPRODUCTO,(string)"",(string)"",(string)"'"+sPrefix+"'"+",false,"+"'"+""+"'",(string)edtDESCRIPCIONCATEGORIAPRODUCTO_Link,(string)"",(string)"",(string)"",(string)edtDESCRIPCIONCATEGORIAPRODUCTO_Jsonclick,(short)0,(string)"Attribute",(string)"",(string)ROClassString,(string)"WWColumn WWOptionalColumn",(string)"",(short)-1,(short)0,(short)0,(string)"text",(string)"",(short)0,(string)"px",(short)17,(string)"px",(short)255,(short)0,(short)0,(short)20,(short)1,(short)-1,(short)-1,(bool)true,(string)"Nombre",(string)"left",(bool)true,(string)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+""+"\">") ;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDMARCAPRODUCTO',fld:'vIDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E131F2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A5IDESTADOPRODUCTO',fld:'IDESTADOPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'A6IDCATEGORIAPRODUCTO',fld:'IDCATEGORIAPRODUCTO',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtDESCRIPCIONPRODUCTO_Link',ctrl:'DESCRIPCIONPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONESTADOPRODUCTO_Link',ctrl:'DESCRIPCIONESTADOPRODUCTO',prop:'Link'},{av:'edtDESCRIPCIONCATEGORIAPRODUCTO_Link',ctrl:'DESCRIPCIONCATEGORIAPRODUCTO',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E111F2',iparms:[{av:'A7IDPRODUCTO',fld:'IDPRODUCTO',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDMARCAPRODUCTO',fld:'vIDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDMARCAPRODUCTO',fld:'vIDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDMARCAPRODUCTO',fld:'vIDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDMARCAPRODUCTO',fld:'vIDMARCAPRODUCTO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H001F2_A8IDMARCAPRODUCTO = new long[1] ;
         H001F2_A39DESCRIPCIONCATEGORIAPRODUCTO = new string[] {""} ;
         H001F2_A6IDCATEGORIAPRODUCTO = new long[1] ;
         H001F2_A38DESCRIPCIONESTADOPRODUCTO = new string[] {""} ;
         H001F2_A5IDESTADOPRODUCTO = new long[1] ;
         H001F2_A43PRECIOVENTAPRODUCTO = new decimal[1] ;
         H001F2_A42PRECIOCOMPRAPRODUCTO = new decimal[1] ;
         H001F2_A41CANTIDADPRODUCTO = new long[1] ;
         H001F2_A40DESCRIPCIONPRODUCTO = new string[] {""} ;
         H001F2_A7IDPRODUCTO = new long[1] ;
         ...
         sCtrlAV6IDMARCAPRODUCTO = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.marca_productoinventariowc__default(),
            new Object[][] {
                new Object[] {
               H001F2_A8IDMARCAPRODUCTO, H001F2_A39DESCRIPCIONCATEGORIAPRODUCTO, H001F2_A6IDCATEGORIAPRODUCTO, H001F2_A38DESCRIPCIONESTADOPRODUCTO, H001F2_A5IDESTADOPRODUCTO, H001F2_A43PRECIOVENTAPRODUCTO, H001F2_A42PRECIOCOMPRAPRODUCTO, H001F2_A41CANTIDADPRODUCTO, H001F2_A40DESCRIPCIONPRODUCTO, H001F2_A7IDPRODUCTO
               }
               , new Object[] {
      ...
      private int edtIDMARCAPRODUCTO_Visible ;
      private int subGrid_Islastpage ;
      private int GXPagingFrom2 ;
      private int GXPagingTo2 ;
      private int idxLst ;
      private int subGrid_Backcolor ;
      private long AV6IDMARCAPRODUCTO ;
      private long wcpOAV6IDMARCAPRODUCTO ;
      ...
      private string sCtrlAV6IDMARCAPRODUCTO ;
      ...
      private long[] H001F2_A8IDMARCAPRODUCTO ;
      private string[] H001F2_A39DESCRIPCIONCATEGORIAPRODUCTO ;
      private long[] H001F2_A6IDCATEGORIAPRODUCTO ;
      private string[] H001F2_A38DESCRIPCIONESTADOPRODUCTO ;
      private long[] H001F2_A5IDESTADOPRODUCTO ;
      private decimal[] H001F2_A43PRECIOVENTAPRODUCTO ;
      private decimal[] H001F2_A42PRECIOCOMPRAPRODUCTO ;
      private long[] H001F2_A41CANTIDADPRODUCTO ;
      private string[] H001F2_A40DESCRIPCIONPRODUCTO ;
      private long[] H001F2_A7IDPRODUCTO ;
   ...
   public class marca_productoinventariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6IDMARCAPRODUCTO",GXType.Decimal,12,0) ,
          ...
          def= new CursorDef[] {
              new CursorDef("H001F2", "SELECT T1.[IDMARCAPRODUCTO], T2.[DESCRIPCIONCATEGORIAPRODUCTO], T1.[IDCATEGORIAPRODUCTO], T3.[DESCRIPCIONESTADOPRODUCTO], T1.[IDESTADOPRODUCTO], T1.[PRECIOVENTAPRODUCTO], T1.[PRECIOCOMPRAPRODUCTO], T1.[CANTIDADPRODUCTO], T1.[DESCRIPCIONPRODUCTO], T1.[IDPRODUCTO] FROM (([Inventario] T1 INNER JOIN [Categoria_producto] T2 ON T2.[IDCATEGORIAPRODUCTO] = T1.[IDCATEGORIAPRODUCTO]) INNER JOIN [Estado_producto] T3 ON T3.[IDESTADOPRODUCTO] = T1.[IDESTADOPRODUCTO]) WHERE T1.[IDMARCAPRODUCTO] = @AV6IDMARCAPRODUCTO ORDER BY T1.[IDMARCAPRODUCTO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F2,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H001F3", "SELECT COUNT(*) FROM (([Inventario] T1 INNER JOIN [Categoria_producto] T3 ON T3.[IDCATEGORIAPRODUCTO] = T1.[IDCATEGORIAPRODUCTO]) INNER JOIN [Estado_producto] T2 ON T2.[IDESTADOPRODUCTO] = T1.[IDESTADOPRODUCTO]) WHERE T1.[IDMARCAPRODUCTO] = @AV6IDMARCAPRODUCTO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH001F3,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
