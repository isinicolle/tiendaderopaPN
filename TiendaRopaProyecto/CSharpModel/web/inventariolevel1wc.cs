...
namespace GeneXus.Programs {
   public class inventariolevel1wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public inventariolevel1wc( )
      {
      ...
      public inventariolevel1wc( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "InventarioLevel1WC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Inventario Level1 WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113012542562", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("inventariolevel1wc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDPRODUCTO,12,0))}, new string[] {"IDPRODUCTO"}) +"\">") ;
      ...
      {
         return "InventarioLevel1WC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Inventario Level1 WC" ;
      }
      ...
      protected void WB2R0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "inventariolevel1wc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_InventarioLevel1WC.htm");
      ...
      protected void START2R2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Inventario Level1 WC", 0) ;
            }
            context.wjLoc = "";
      ...
      protected void RF2R2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            {
               A7IDPRODUCTO = H002R5_A7IDPRODUCTO[0];
               AssignAttri(sPrefix, false, "A7IDPRODUCTO", StringUtil.LTrimStr( (decimal)(A7IDPRODUCTO), 12, 0));
               A23NOMBRECOMPLETOEMPLEADO = H002R5_A23NOMBRECOMPLETOEMPLEADO[0];
               A1IDEMPLEADO = H002R5_A1IDEMPLEADO[0];
               A46NOMBREPROVEEDOR = H002R5_A46NOMBREPROVEEDOR[0];
               A10IDPROVEEDOR = H002R5_A10IDPROVEEDOR[0];
               A51DESCRIPCIONCOMPRA = H002R5_A51DESCRIPCIONCOMPRA[0];
               A50FECHACOMPRA = H002R5_A50FECHACOMPRA[0];
               A11IDCOMPRA = H002R5_A11IDCOMPRA[0];
               A61TOTALCOMPRAPRODUCTO = H002R5_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H002R5_n61TOTALCOMPRAPRODUCTO[0];
               A1IDEMPLEADO = H002R5_A1IDEMPLEADO[0];
               A10IDPROVEEDOR = H002R5_A10IDPROVEEDOR[0];
               A51DESCRIPCIONCOMPRA = H002R5_A51DESCRIPCIONCOMPRA[0];
               A50FECHACOMPRA = H002R5_A50FECHACOMPRA[0];
      ...
      protected int subGrid_fnc_Recordcount( )
      {
         ...
         GRID_nRecordCount = H002R9_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "inventariolevel1wc", GetJustCreated( ));
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113012542611", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("inventariolevel1wc.js", "?2021113012542611", false, true);
         }
      ...
      public override void InitializeDynEvents( )
      {
         ...
         setEventMetadata("GRID.LOAD","{handler:'E132R2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A10IDPROVEEDOR',fld:'IDPROVEEDOR',pic:'ZZZZZZZZZZZ9'},{av:'A1IDEMPLEADO',fld:'IDEMPLEADO',pic:'ZZZZZZZZZZZ9'}]");
         ...
         setEventMetadata("'DOINSERT'","{handler:'E112R2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002R5_A64IDETALLEPRODUCTO = new long[1] ;
         H002R5_A7IDPRODUCTO = new long[1] ;
         H002R5_A23NOMBRECOMPLETOEMPLEADO = new string[] {""} ;
         H002R5_A1IDEMPLEADO = new long[1] ;
         H002R5_A46NOMBREPROVEEDOR = new string[] {""} ;
         H002R5_A10IDPROVEEDOR = new long[1] ;
         H002R5_A51DESCRIPCIONCOMPRA = new string[] {""} ;
         H002R5_A50FECHACOMPRA = new DateTime[] {DateTime.MinValue} ;
         H002R5_A11IDCOMPRA = new long[1] ;
         H002R5_A61TOTALCOMPRAPRODUCTO = new decimal[1] ;
         H002R5_n61TOTALCOMPRAPRODUCTO = new bool[] {false} ;
         H002R9_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6IDPRODUCTO = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.inventariolevel1wc__default(),
            new Object[][] {
                new Object[] {
               H002R5_A64IDETALLEPRODUCTO, H002R5_A7IDPRODUCTO, H002R5_A23NOMBRECOMPLETOEMPLEADO, H002R5_A1IDEMPLEADO, H002R5_A46NOMBREPROVEEDOR, H002R5_A10IDPROVEEDOR, H002R5_A51DESCRIPCIONCOMPRA, H002R5_A50FECHACOMPRA, H002R5_A11IDCOMPRA, H002R5_A61TOTALCOMPRAPRODUCTO,
               H002R5_n61TOTALCOMPRAPRODUCTO
               }
               , new Object[] {
               H002R9_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "InventarioLevel1WC";
      ...
      private long[] H002R5_A64IDETALLEPRODUCTO ;
      private long[] H002R5_A7IDPRODUCTO ;
      private string[] H002R5_A23NOMBRECOMPLETOEMPLEADO ;
      private long[] H002R5_A1IDEMPLEADO ;
      private string[] H002R5_A46NOMBREPROVEEDOR ;
      private long[] H002R5_A10IDPROVEEDOR ;
      private string[] H002R5_A51DESCRIPCIONCOMPRA ;
      private DateTime[] H002R5_A50FECHACOMPRA ;
      private long[] H002R5_A11IDCOMPRA ;
      private decimal[] H002R5_A61TOTALCOMPRAPRODUCTO ;
      private bool[] H002R5_n61TOTALCOMPRAPRODUCTO ;
      private long[] H002R9_AGRID_nRecordCount ;
   ...
   public class inventariolevel1wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH002R9;
          prmH002R9 = new Object[] {
          new ParDef("@AV6IDPRODUCTO",GXType.Decimal,12,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002R5", "SELECT T1.[IDETALLEPRODUCTO], T1.[IDPRODUCTO], T3.[NOMBRECOMPLETOEMPLEADO], T2.[IDEMPLEADO], T4.[NOMBREPROVEEDOR], T2.[IDPROVEEDOR], T2.[DESCRIPCIONCOMPRA], T2.[FECHACOMPRA], T1.[IDCOMPRA], COALESCE( T5.[TOTALCOMPRAPRODUCTO], 0) AS TOTALCOMPRAPRODUCTO FROM (((([Compra_inventarioLevel1] T1 INNER JOIN [Compra_inventario] T2 ON T2.[IDCOMPRA] = T1.[IDCOMPRA]) INNER JOIN [Empleados] T3 ON T3.[IDEMPLEADO] = T2.[IDEMPLEADO]) INNER JOIN [Proveedores] T4 ON T4.[IDPROVEEDOR] = T2.[IDPROVEEDOR]) LEFT JOIN (SELECT SUM(COALESCE( T7.[SUBTOTALCOMPRAPRODUCTO], 0)) AS TOTALCOMPRAPRODUCTO, T6.[IDCOMPRA] FROM ([Compra_inventarioLevel1] T6 LEFT JOIN (SELECT COALESCE( T9.[GXC2], 0) AS SUBTOTALCOMPRAPRODUCTO, T8.[IDCOMPRA], T8.[IDETALLEPRODUCTO] FROM ([Compra_inventarioLevel1] T8 LEFT JOIN (SELECT SUM(T11.[CANTIDADPRODUCTO] * CAST(T11.[PRECIOCOMPRAPRODUCTO] AS decimal( 22, 10))) AS GXC2, T10.[IDCOMPRA], T10.[IDETALLEPRODUCTO] FROM ([Compra_inventarioLevel1] T10 INNER JOIN [Inventario] T11 ON T11.[IDPRODUCTO] = T10.[IDPRODUCTO]) GROUP BY T10.[IDCOMPRA], T10.[IDETALLEPRODUCTO] ) T9 ON T9.[IDCOMPRA] = T8.[IDCOMPRA] AND T9.[IDETALLEPRODUCTO] = T8.[IDETALLEPRODUCTO]) ) T7 ON T7.[IDCOMPRA] = T6.[IDCOMPRA] AND T7.[IDETALLEPRODUCTO] = T6.[IDETALLEPRODUCTO]) GROUP BY T6.[IDCOMPRA] ) T5 ON T5.[IDCOMPRA] = T1.[IDCOMPRA]) WHERE T1.[IDPRODUCTO] = @AV6IDPRODUCTO ORDER BY T1.[IDPRODUCTO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002R5,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002R9", "SELECT COUNT(*) FROM (((([Compra_inventarioLevel1] T1 INNER JOIN [Compra_inventario] T2 ON T2.[IDCOMPRA] = T1.[IDCOMPRA]) INNER JOIN [Empleados] T4 ON T4.[IDEMPLEADO] = T2.[IDEMPLEADO]) INNER JOIN [Proveedores] T3 ON T3.[IDPROVEEDOR] = T2.[IDPROVEEDOR]) LEFT JOIN (SELECT SUM(COALESCE( T7.[SUBTOTALCOMPRAPRODUCTO], 0)) AS TOTALCOMPRAPRODUCTO, T6.[IDCOMPRA] FROM ([Compra_inventarioLevel1] T6 LEFT JOIN (SELECT COALESCE( T9.[GXC2], 0) AS SUBTOTALCOMPRAPRODUCTO, T8.[IDCOMPRA], T8.[IDETALLEPRODUCTO] FROM ([Compra_inventarioLevel1] T8 LEFT JOIN (SELECT SUM(T11.[CANTIDADPRODUCTO] * CAST(T11.[PRECIOCOMPRAPRODUCTO] AS decimal( 22, 10))) AS GXC2, T10.[IDCOMPRA], T10.[IDETALLEPRODUCTO] FROM ([Compra_inventarioLevel1] T10 INNER JOIN [Inventario] T11 ON T11.[IDPRODUCTO] = T10.[IDPRODUCTO]) GROUP BY T10.[IDCOMPRA], T10.[IDETALLEPRODUCTO] ) T9 ON T9.[IDCOMPRA] = T8.[IDCOMPRA] AND T9.[IDETALLEPRODUCTO] = T8.[IDETALLEPRODUCTO]) ) T7 ON T7.[IDCOMPRA] = T6.[IDCOMPRA] AND T7.[IDETALLEPRODUCTO] = T6.[IDETALLEPRODUCTO]) GROUP BY T6.[IDCOMPRA] ) T5 ON T5.[IDCOMPRA] = T1.[IDCOMPRA]) WHERE T1.[IDPRODUCTO] = @AV6IDPRODUCTO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002R9,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
