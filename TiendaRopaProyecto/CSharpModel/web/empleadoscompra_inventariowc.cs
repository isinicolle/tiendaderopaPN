...
namespace GeneXus.Programs {
   public class empleadoscompra_inventariowc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public empleadoscompra_inventariowc( )
      {
      ...
      public empleadoscompra_inventariowc( IGxContext context )
      {
      ...
      {
         this.AV6IDEMPLEADO = aP0_IDEMPLEADO;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (string)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV6IDEMPLEADO = (long)(NumberUtil.Val( GetPar( "IDEMPLEADO"), "."));
                  AssignAttri(sPrefix, false, "AV6IDEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDEMPLEADO), 12, 0));
                  setjustcreated();
                  componentprepare(new Object[] {(string)sCompPrefix,(string)sSFPrefix,(long)AV6IDEMPLEADO});
                  componentstart();
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "gxajaxGridRefresh_"+"Grid") == 0 )
               {
                  ...
                  gxgrGrid_refresh( subGrid_Rows, AV6IDEMPLEADO, AV12Update, AV13Delete, sPrefix) ;
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            {
               /* GeneXus formulas. */
               AV17Pgmname = "EmpleadosCompra_inventarioWC";
               context.Gx_err = 0;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.SendWebValue( "Empleados Compra_inventario WC") ;
         ...
         context.AddJavascriptSource("gxcfg.js", "?2021113013582496", false, true);
         if ( context.isSpaRequest( ) )
         {
            enableOutput();
         }
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" autocomplete=\"off\" name=\"MAINFORM\" method=\"post\" tabindex=-1  class=\"form-horizontal Form\" data-gx-class=\"form-horizontal Form\" novalidate action=\""+formatLink("empleadoscompra_inventariowc.aspx", new object[] {UrlEncode(StringUtil.LTrimStr(AV6IDEMPLEADO,12,0))}, new string[] {"IDEMPLEADO"}) +"\">") ;
      ...
      protected void SendCloseFormHiddens( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV6IDEMPLEADO", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV6IDEMPLEADO), 12, 0, ".", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"vIDEMPLEADO", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDEMPLEADO), 12, 0, ".", "")));
      ...
      {
         return "EmpleadosCompra_inventarioWC" ;
      }

      public override string GetPgmdesc( )
      {
         return "Empleados Compra_inventario WC" ;
      }
      ...
      protected void WB2Q0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "empleadoscompra_inventariowc.aspx");
            }
            /* Div Control */
            ...
            ClassString = "BtnAdd";
            StyleString = "";
            GxWebStd.gx_button_ctrl( context, bttBtninsert_Internalname, "gx.evt.setGridEvt("+StringUtil.Str( (decimal)(20), 2, 0)+","+"null"+");", "Insert", bttBtninsert_Jsonclick, 5, "Insert", "", StyleString, ClassString, 1, 1, "standard", "'"+sPrefix+"'"+",false,"+"'"+sPrefix+"E\\'DOINSERT\\'."+"'", TempTags, "", context.GetButtonType( ), "HLP_EmpleadosCompra_inventarioWC.htm");
         ...
         if ( wbEnd == 20 )
         {
            ...
            GxWebStd.gx_label_element( context, edtIDEMPLEADO_Internalname, "IDEMPLEADO", "col-sm-3 AttributeLabel", 0, true, "");
            /* Single line edit */
            GxWebStd.gx_single_line_edit( context, edtIDEMPLEADO_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A1IDEMPLEADO), 12, 0, ".", "")), ((edtIDEMPLEADO_Enabled!=0) ? StringUtil.LTrim( context.localUtil.Format( (decimal)(A1IDEMPLEADO), "ZZZZZZZZZZZ9")) : context.localUtil.Format( (decimal)(A1IDEMPLEADO), "ZZZZZZZZZZZ9")), "", "'"+sPrefix+"'"+",false,"+"'"+""+"'", "", "", "", "", edtIDEMPLEADO_Jsonclick, 0, "Attribute", "", "", "", "", edtIDEMPLEADO_Visible, edtIDEMPLEADO_Enabled, 0, "number", "1", 12, "chr", 1, "row", 12, 0, 0, 0, 1, -1, 0, true, "Codigo", "right", false, "", "HLP_EmpleadosCompra_inventarioWC.htm");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
            GxWebStd.gx_div_end( context, "left", "top", "div");
      ...
      protected void START2Q2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            if ( ! context.isSpaRequest( ) )
            {
               ...
               Form.Meta.addItem("description", "Empleados Compra_inventario WC", 0) ;
            }
            context.wjLoc = "";
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_IDCOMPRA", GetSecureSignedToken( sPrefix, context.localUtil.Format( (decimal)(A11IDCOMPRA), "ZZZZZZZZZZZ9"), context));
         GxWebStd.gx_hidden_field( context, sPrefix+"IDCOMPRA", StringUtil.LTrim( StringUtil.NToC( (decimal)(A11IDCOMPRA), 12, 0, ".", "")));
      }
      ...
      protected void RF2Q2( )
      {
         ...
         if ( ! context.WillRedirect( ) && ( context.nUserReturn != 1 ) )
         {
            ...
            /* Using cursor H002Q5 */
            pr_default.execute(0, new Object[] {AV6IDEMPLEADO, GXPagingFrom2, GXPagingTo2});
            nGXsfl_20_idx = 1;
            sGXsfl_20_idx = StringUtil.PadL( StringUtil.LTrimStr( (decimal)(nGXsfl_20_idx), 4, 0), 4, "0");
            SubsflControlProps_202( ) ;
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < subGrid_fnc_Recordsperpage( ) ) ) ) )
            {
               A1IDEMPLEADO = H002Q5_A1IDEMPLEADO[0];
               AssignAttri(sPrefix, false, "A1IDEMPLEADO", StringUtil.LTrimStr( (decimal)(A1IDEMPLEADO), 12, 0));
               A46NOMBREPROVEEDOR = H002Q5_A46NOMBREPROVEEDOR[0];
               A10IDPROVEEDOR = H002Q5_A10IDPROVEEDOR[0];
               A51DESCRIPCIONCOMPRA = H002Q5_A51DESCRIPCIONCOMPRA[0];
               A50FECHACOMPRA = H002Q5_A50FECHACOMPRA[0];
               A11IDCOMPRA = H002Q5_A11IDCOMPRA[0];
               A61TOTALCOMPRAPRODUCTO = H002Q5_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H002Q5_n61TOTALCOMPRAPRODUCTO[0];
               A46NOMBREPROVEEDOR = H002Q5_A46NOMBREPROVEEDOR[0];
               A61TOTALCOMPRAPRODUCTO = H002Q5_A61TOTALCOMPRAPRODUCTO[0];
               n61TOTALCOMPRAPRODUCTO = H002Q5_n61TOTALCOMPRAPRODUCTO[0];
               E132Q2 ();
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"gxhash_IDCOMPRA"+"_"+sGXsfl_20_idx, GetSecureSignedToken( sPrefix+sGXsfl_20_idx, context.localUtil.Format( (decimal)(A11IDCOMPRA), "ZZZZZZZZZZZ9"), context));
      }
      ...
      {
         /* Using cursor H002Q9 */
         pr_default.execute(1, new Object[] {AV6IDEMPLEADO});
         GRID_nRecordCount = H002Q9_AGRID_nRecordCount[0];
         pr_default.close(1);
      ...
      protected void STRUP2Q0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV6IDEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDEMPLEADO"), ".", ","));
      ...
      protected void E122Q2( )
      {
         ...
         AV13Delete = "Delete";
         AssignAttri(sPrefix, false, edtavDelete_Internalname, AV13Delete);
         edtIDEMPLEADO_Visible = 0;
         AssignProp(sPrefix, false, edtIDEMPLEADO_Internalname, "Visible", StringUtil.LTrimStr( (decimal)(edtIDEMPLEADO_Visible), 5, 0), true);
      ...
      protected void S112( )
      {
         ...
         AV10TrnContext.gxTpr_Transactionname = "Compra_inventario";
         AV11TrnContextAtt = new SdtTransactionContext_Attribute(context);
         AV11TrnContextAtt.gxTpr_Attributename = "IDEMPLEADO";
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV6IDEMPLEADO), 12, 0);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV6IDEMPLEADO = Convert.ToInt64(getParm(obj,0));
         AssignAttri(sPrefix, false, "AV6IDEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDEMPLEADO), 12, 0));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV6IDEMPLEADO = (string)((string)getParm(obj,0));
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "empleadoscompra_inventariowc", GetJustCreated( ));
         ...
         {
            AV6IDEMPLEADO = Convert.ToInt64(getParm(obj,2));
            AssignAttri(sPrefix, false, "AV6IDEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDEMPLEADO), 12, 0));
         }
         wcpOAV6IDEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV6IDEMPLEADO"), ".", ","));
         if ( ! GetJustCreated( ) && ( ( AV6IDEMPLEADO != wcpOAV6IDEMPLEADO ) ) )
         {
            setjustcreated();
         }
         wcpOAV6IDEMPLEADO = AV6IDEMPLEADO;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV6IDEMPLEADO = cgiGet( sPrefix+"AV6IDEMPLEADO_CTRL");
         if ( StringUtil.Len( sCtrlAV6IDEMPLEADO) > 0 )
         {
            AV6IDEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sCtrlAV6IDEMPLEADO), ".", ","));
            AssignAttri(sPrefix, false, "AV6IDEMPLEADO", StringUtil.LTrimStr( (decimal)(AV6IDEMPLEADO), 12, 0));
         }
         else
         {
            AV6IDEMPLEADO = (long)(context.localUtil.CToN( cgiGet( sPrefix+"AV6IDEMPLEADO_PARM"), ".", ","));
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDEMPLEADO_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV6IDEMPLEADO), 12, 0, ".", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV6IDEMPLEADO)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV6IDEMPLEADO_CTRL", StringUtil.RTrim( sCtrlAV6IDEMPLEADO));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( ((string)Form.Jscriptsrc.Item(idxLst))), "?2021113013582546", true, true);
            idxLst = (int)(idxLst+1);
         }
         if ( ! outputEnabled )
         {
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("empleadoscompra_inventariowc.js", "?2021113013582546", false, true);
         }
      ...
      {
         edtIDCOMPRA_Internalname = sPrefix+"IDCOMPRA_"+sGXsfl_20_idx;
         edtFECHACOMPRA_Internalname = sPrefix+"FECHACOMPRA_"+sGXsfl_20_idx;
         edtDESCRIPCIONCOMPRA_Internalname = sPrefix+"DESCRIPCIONCOMPRA_"+sGXsfl_20_idx;
         ...
         edtTOTALCOMPRAPRODUCTO_Internalname = sPrefix+"TOTALCOMPRAPRODUCTO_"+sGXsfl_20_idx;
      ...
      {
         edtIDCOMPRA_Internalname = sPrefix+"IDCOMPRA_"+sGXsfl_20_fel_idx;
         edtFECHACOMPRA_Internalname = sPrefix+"FECHACOMPRA_"+sGXsfl_20_fel_idx;
         edtDESCRIPCIONCOMPRA_Internalname = sPrefix+"DESCRIPCIONCOMPRA_"+sGXsfl_20_fel_idx;
         ...
         edtTOTALCOMPRAPRODUCTO_Internalname = sPrefix+"TOTALCOMPRAPRODUCTO_"+sGXsfl_20_fel_idx;
      ...
      {
         setEventMetadata("REFRESH","{handler:'Refresh',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDEMPLEADO',fld:'vIDEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("REFRESH",",oparms:[]}");
         setEventMetadata("GRID.LOAD","{handler:'E132Q2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true},{av:'A10IDPROVEEDOR',fld:'IDPROVEEDOR',pic:'ZZZZZZZZZZZ9'}]");
         setEventMetadata("GRID.LOAD",",oparms:[{av:'edtavUpdate_Link',ctrl:'vUPDATE',prop:'Link'},{av:'edtavDelete_Link',ctrl:'vDELETE',prop:'Link'},{av:'edtFECHACOMPRA_Link',ctrl:'FECHACOMPRA',prop:'Link'},{av:'edtNOMBREPROVEEDOR_Link',ctrl:'NOMBREPROVEEDOR',prop:'Link'}]}");
         setEventMetadata("'DOINSERT'","{handler:'E112Q2',iparms:[{av:'A11IDCOMPRA',fld:'IDCOMPRA',pic:'ZZZZZZZZZZZ9',hsh:true}]");
         setEventMetadata("'DOINSERT'",",oparms:[]}");
         setEventMetadata("GRID_FIRSTPAGE","{handler:'subgrid_firstpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDEMPLEADO',fld:'vIDEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_FIRSTPAGE",",oparms:[]}");
         setEventMetadata("GRID_PREVPAGE","{handler:'subgrid_previouspage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDEMPLEADO',fld:'vIDEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_PREVPAGE",",oparms:[]}");
         setEventMetadata("GRID_NEXTPAGE","{handler:'subgrid_nextpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDEMPLEADO',fld:'vIDEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
         setEventMetadata("GRID_NEXTPAGE",",oparms:[]}");
         setEventMetadata("GRID_LASTPAGE","{handler:'subgrid_lastpage',iparms:[{av:'GRID_nFirstRecordOnPage'},{av:'GRID_nEOF'},{av:'subGrid_Rows',ctrl:'GRID',prop:'Rows'},{av:'AV6IDEMPLEADO',fld:'vIDEMPLEADO',pic:'ZZZZZZZZZZZ9'},{av:'AV12Update',fld:'vUPDATE',pic:''},{av:'AV13Delete',fld:'vDELETE',pic:''},{av:'sPrefix'}]");
      ...
      public override void initialize( )
      {
         ...
         sEvtType = "";
         scmdbuf = "";
         H002Q5_A1IDEMPLEADO = new long[1] ;
         H002Q5_A46NOMBREPROVEEDOR = new string[] {""} ;
         H002Q5_A10IDPROVEEDOR = new long[1] ;
         H002Q5_A51DESCRIPCIONCOMPRA = new string[] {""} ;
         H002Q5_A50FECHACOMPRA = new DateTime[] {DateTime.MinValue} ;
         H002Q5_A11IDCOMPRA = new long[1] ;
         H002Q5_A61TOTALCOMPRAPRODUCTO = new decimal[1] ;
         H002Q5_n61TOTALCOMPRAPRODUCTO = new bool[] {false} ;
         H002Q9_AGRID_nRecordCount = new long[1] ;
         ...
         sCtrlAV6IDEMPLEADO = "";
         ROClassString = "";
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.empleadoscompra_inventariowc__default(),
            new Object[][] {
                new Object[] {
               H002Q5_A1IDEMPLEADO, H002Q5_A46NOMBREPROVEEDOR, H002Q5_A10IDPROVEEDOR, H002Q5_A51DESCRIPCIONCOMPRA, H002Q5_A50FECHACOMPRA, H002Q5_A11IDCOMPRA, H002Q5_A61TOTALCOMPRAPRODUCTO, H002Q5_n61TOTALCOMPRAPRODUCTO
               }
               , new Object[] {
               H002Q9_AGRID_nRecordCount
               }
            }
         );
         AV17Pgmname = "EmpleadosCompra_inventarioWC";
      ...
      private int edtIDEMPLEADO_Visible ;
      ...
      private long wcpOAV6IDEMPLEADO ;
      ...
      private string sCtrlAV6IDEMPLEADO ;
      ...
      private long[] H002Q5_A1IDEMPLEADO ;
      private string[] H002Q5_A46NOMBREPROVEEDOR ;
      private long[] H002Q5_A10IDPROVEEDOR ;
      private string[] H002Q5_A51DESCRIPCIONCOMPRA ;
      private DateTime[] H002Q5_A50FECHACOMPRA ;
      private long[] H002Q5_A11IDCOMPRA ;
      private decimal[] H002Q5_A61TOTALCOMPRAPRODUCTO ;
      private bool[] H002Q5_n61TOTALCOMPRAPRODUCTO ;
      private long[] H002Q9_AGRID_nRecordCount ;
   ...
   public class empleadoscompra_inventariowc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new ParDef("@AV6IDEMPLEADO",GXType.Decimal,12,0) ,
          new ParDef("@GXPagingFrom2",GXType.Int32,9,0) ,
          new ParDef("@GXPagingTo2",GXType.Int32,9,0)
          };
          Object[] prmH002Q9;
          prmH002Q9 = new Object[] {
          new ParDef("@AV6IDEMPLEADO",GXType.Decimal,12,0)
          };
          def= new CursorDef[] {
              new CursorDef("H002Q5", "SELECT T1.[IDEMPLEADO], T2.[NOMBREPROVEEDOR], T1.[IDPROVEEDOR], T1.[DESCRIPCIONCOMPRA], T1.[FECHACOMPRA], T1.[IDCOMPRA], COALESCE( T3.[TOTALCOMPRAPRODUCTO], 0) AS TOTALCOMPRAPRODUCTO FROM (([Compra_inventario] T1 INNER JOIN [Proveedores] T2 ON T2.[IDPROVEEDOR] = T1.[IDPROVEEDOR]) LEFT JOIN (SELECT SUM(COALESCE( T5.[SUBTOTALCOMPRAPRODUCTO], 0)) AS TOTALCOMPRAPRODUCTO, T4.[IDCOMPRA] FROM ([Compra_inventarioDetalle_compr] T4 LEFT JOIN (SELECT COALESCE( T7.[GXC2], 0) AS SUBTOTALCOMPRAPRODUCTO, T6.[IDCOMPRA], T6.[IDETALLECOMPRAPRODUCTO] FROM ([Compra_inventarioDetalle_compr] T6 LEFT JOIN (SELECT SUM(T9.[CANTIDADPRODUCTO] * CAST(T9.[PRECIOCOMPRAPRODUCTO] AS decimal( 22, 10))) AS GXC2, T8.[IDCOMPRA], T8.[IDETALLECOMPRAPRODUCTO] FROM ([Compra_inventarioDetalle_compr] T8 INNER JOIN [Inventario] T9 ON T9.[IDPRODUCTO] = T8.[IDPRODUCTO]) GROUP BY T8.[IDCOMPRA], T8.[IDETALLECOMPRAPRODUCTO] ) T7 ON T7.[IDCOMPRA] = T6.[IDCOMPRA] AND T7.[IDETALLECOMPRAPRODUCTO] = T6.[IDETALLECOMPRAPRODUCTO]) ) T5 ON T5.[IDCOMPRA] = T4.[IDCOMPRA] AND T5.[IDETALLECOMPRAPRODUCTO] = T4.[IDETALLECOMPRAPRODUCTO]) GROUP BY T4.[IDCOMPRA] ) T3 ON T3.[IDCOMPRA] = T1.[IDCOMPRA]) WHERE T1.[IDEMPLEADO] = @AV6IDEMPLEADO ORDER BY T1.[IDEMPLEADO]  OFFSET @GXPagingFrom2 ROWS FETCH NEXT CAST((SELECT CASE WHEN @GXPagingTo2 > 0 THEN @GXPagingTo2 ELSE 1e9 END) AS INTEGER) ROWS ONLY",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Q5,11, GxCacheFrequency.OFF ,true,false )
             ,new CursorDef("H002Q9", "SELECT COUNT(*) FROM (([Compra_inventario] T1 INNER JOIN [Proveedores] T2 ON T2.[IDPROVEEDOR] = T1.[IDPROVEEDOR]) LEFT JOIN (SELECT SUM(COALESCE( T5.[SUBTOTALCOMPRAPRODUCTO], 0)) AS TOTALCOMPRAPRODUCTO, T4.[IDCOMPRA] FROM ([Compra_inventarioDetalle_compr] T4 LEFT JOIN (SELECT COALESCE( T7.[GXC2], 0) AS SUBTOTALCOMPRAPRODUCTO, T6.[IDCOMPRA], T6.[IDETALLECOMPRAPRODUCTO] FROM ([Compra_inventarioDetalle_compr] T6 LEFT JOIN (SELECT SUM(T9.[CANTIDADPRODUCTO] * CAST(T9.[PRECIOCOMPRAPRODUCTO] AS decimal( 22, 10))) AS GXC2, T8.[IDCOMPRA], T8.[IDETALLECOMPRAPRODUCTO] FROM ([Compra_inventarioDetalle_compr] T8 INNER JOIN [Inventario] T9 ON T9.[IDPRODUCTO] = T8.[IDPRODUCTO]) GROUP BY T8.[IDCOMPRA], T8.[IDETALLECOMPRAPRODUCTO] ) T7 ON T7.[IDCOMPRA] = T6.[IDCOMPRA] AND T7.[IDETALLECOMPRAPRODUCTO] = T6.[IDETALLECOMPRAPRODUCTO]) ) T5 ON T5.[IDCOMPRA] = T4.[IDCOMPRA] AND T5.[IDETALLECOMPRAPRODUCTO] = T4.[IDETALLECOMPRAPRODUCTO]) GROUP BY T4.[IDCOMPRA] ) T3 ON T3.[IDCOMPRA] = T1.[IDCOMPRA]) WHERE T1.[IDEMPLEADO] = @AV6IDEMPLEADO ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH002Q9,1, GxCacheFrequency.OFF ,true,false )
          };
       }
    }
